...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function cl(){return new Ee({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ka(),fragmentShader:`
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function ul(){return new Ee({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ka(),fragmentShader:`
...
#define LOW_PRECISION`),t}function xg(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===rc?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===ac?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===mn&&(t="SHADOWMAP_TYPE_VSM"),t}function yg(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Oi:case Fi:t="ENVMAP_TYPE_CUBE";break;case mr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Mg(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Fi:t="ENVMAP_MODE_REFRACTION";break}return t}function Sg(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case oc:t="ENVMAP_BLENDING_MULTIPLY";break;case Sh:t="ENVMAP_BLENDING_MIX";break;case Eh:t="ENVMAP_BLENDING_ADD";break}return t}function Eg(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function bg(i,t,e,n){const s=i.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=xg(e),c=yg(e),u=Mg(e),h=Sg(e),d=Eg(e),p=hg(e),_=dg(r),v=s.createProgram();let m,f,T=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}),e=new Vt(new Gi(23,8,96,28),t);return e.rotation.x=-Math.PI/2,e.position.set(0,-.08,7.4),e.receiveShadow=!0,this.root.add(e),t}createDistrict(t,e){const[n,s]=R0[t.id]??[e*4,0],r=new He;r.position.set(n,0,s),r.userData.districtId=t.id;const a=new Ie({color:ql(t),roughness:.78,metalness:.08,emissive:397332,emissiveIntensity:.08}),o=new Vt(new Pe(5.2,.28,5.2),a);if(o.castShadow=!0,o.receiveShadow=!0,o.userData.districtId=t.id,r.add(o),this.pickables.push(o),t.archetype==="upland"){const m=this.createHillsideTerrain(e);m.userData.districtId=t.id,r.add(m)}const l=new Ie({color:6000291,roughness:.53,metalness:.18,emissive:1457224,emissiveIntensity:.08}),c=this.createBuildingCluster(t,l,e);if(c.userData.districtId=t.id,r.add(c),this.pickables.push(c),t.id==="core"){const m=this.createTaipeiLandmark(l);m.userData.districtId=t.id,r.add(m),this.pickables.push(m)}const u=this.createWindowCluster(t,e);u.mesh.userData.districtId=t.id,r.add(u.mesh);const h=this.createStreetGrid(t,e);h.lines.userData.districtId=t.id,r.add(h.lines);const d=this.createCanopyCluster(t,e);d.userData.districtId=t.id,r.add(d);const p=new Vt(new Ga(3,48),new gn({color:3653112,transparent:!0,opacity:.2,depthWrite:!1}));p.rotation.x=-Math.PI/2,p.position.y=.17,p.visible=!1,p.userData.districtId=t.id,r.add(p);const _=new Vt(new Li(3.2,36,18),new gn({color:16743229,transparent:!0,opacity:.08,depthWrite:!1,blending:Je}));_.scale.y=.28,_.position.y=1.4,_.visible=!1,_.userData.districtId=t.id,r.add(_);const v=new es(new ie().setAttribute("position",new Xt([-2.72,.24,-2.72,2.72,.24,-2.72,2.72,.24,-2.72,2.72,.24,2.72,2.72,.24,2.72,-2.72,.24,2.72,-2.72,.24,2.72,-2.72,.24,-2.72],3)),new Ci({color:9437138,transparent:!0,opacity:.92}));return v.visible=!1,r.add(v),{root:r,base:o,buildingMaterial:l,windowMaterial:u.material,streetMaterial:h.material,waterOverlay:p,heatDome:_,selectedOutline:v}}createHillsideTerrain(t){const e=new He,n=18,s=5.2,r=[],a=[];for(let h=0;h<=n;h+=1)for(let d=0;d<=n;d+=1){const p=-s/2+d/n*s,_=-s/2+h/n*s,v=Ra(p,_,t);r.push(p,v,_)}for(let h=0;h<n;h+=1)for(let d=0;d<n;d+=1){const p=h*(n+1)+d,_=p+1,v=p+n+1,m=v+1;a.push(p,v,_,_,v,m)}const o=new ie;o.setAttribute("position",new Xt(r,3)),o.setIndex(a),o.computeVertexNormals();const l=new Vt(o,new Ie({color:4164952,roughness:.9,metalness:.02,emissive:729876,emissiveIntensity:.06}));l.receiveShadow=!0,l.castShadow=!0,e.add(l);const c=[];for(let h=0;h<5;h+=1){const d=-2.05+h*.72,p=.4+h*.22;c.push(-2.15,p,d,2.15,p+.05,d+.12)}const u=new es(new ie().setAttribute("position",new Xt(c,3)),new Ci({color:12050592,transparent:!0,opacity:.46}));return u.renderOrder=3,e.add(u),e}createTaipeiLandmark(t){const e=new He,n=t.clone();n.color.setHex(7317664),n.emissive.setHex(2052429),n.emissiveIntensity=.16;for(let a=0;a<7;a+=1){const o=.92-a*.055,l=new Vt(new Pe(o,.7,o),n);l.position.set(-.7,2.1+a*.72,-.4),l.castShadow=!0,l.receiveShadow=!0,e.add(l)}const s=new Vt(new Pe(1.1,1.2,1.1),n);s.position.set(-.7,.82,-.4),s.castShadow=!0,s.receiveShadow=!0,e.add(s);const r=new Vt(new cs(.18,1.4,8),new Ie({color:13107187,emissive:7340008,emissiveIntensity:.28,roughness:.36,metalness:.34}));return r.position.set(-.7,7.8,-.4),r.castShadow=!0,e.add(r),e}createBuildingCluster(t,e,n){const s=Ca(t),r=new ia(new Pe(1,1,1),e,s);r.castShadow=!0,r.receiveShadow=!0;const a=new ue;for(let o=0;o<s;o+=1){const l=Yl(t,n,o);a.position.set(l.x,l.baseY+l.height/2,l.z),a.scale.set(l.scaleX,l.height,l.scaleZ),a.rotation.y=l.rotationY,a.updateMatrix(),r.setMatrixAt(o,a.matrix)}return r.instanceMatrix.needsUpdate=!0,r}createWindowCluster(t,e){const n=Ca(t),s=t.archetype==="downtown"?12:t.archetype==="industrial"?4:6,r=new gn({color:16770984,transparent:!0,opacity:.42,depthWrite:!1,blending:Je}),a=new ia(new Pe(.12,.085,.014),r,n*s*2);a.frustumCulled=!1;const o=new ue;let l=0;for(let c=0;c<n;c+=1){const u=Yl(t,e,c),h=Math.max(1,Math.min(s,Math.round(u.height*1.25)));for(let d=0;d<h;d+=1){const p=u.baseY+.2+u.height*(d+1)/(h+1),_=(Jt(e*211+c*17+d)-.5)*.22;o.position.set(u.x+_,p,u.z+u.scaleZ*.51),o.rotation.set(0,u.rotationY,0),o.scale.setScalar(t.archetype==="industrial"?1.25:1),o.updateMatrix(),a.setMatrixAt(l,o.matrix),l+=1,o.position.set(u.x+u.scaleX*.51,p,u.z+_),o.rotation.set(0,u.rotationY+Math.PI/2,0),o.scale.setScalar(t.archetype==="industrial"?1.25:1),o.updateMatrix(),a.setMatrixAt(l,o.matrix),l+=1}}return a.count=l,a.instanceMatrix.needsUpdate=!0,{mesh:a,material:r}}createStreetGrid(t,e){const n=[],s=t.archetype==="downtown"?5:t.archetype==="upland"?3:4,r=2.5,a=.205;for(let u=0;u<s;u+=1){const h=u/(s-1),d=-r+h*r*2+(Jt(e*81+u)-.5)*.16;n.push(-r,a,d,r,a,d),n.push(d,a,-r,d,a,r)}n.push(-r,a,-r,r,a,-r),n.push(r,a,-r,r,a,r),n.push(r,a,r,-r,a,r),n.push(-r,a,r,-r,a,-r);const o=new ie;o.setAttribute("position",new Xt(n,3));const l=new Ci({color:8775895,transparent:!0,opacity:.42,depthWrite:!1}),c=new es(o,l);return c.renderOrder=3,{lines:c,material:l}}createCanopyCluster(t,e){const n=Math.max(4,Math.round(t.canopyCover*46)),s=new Ie({color:5752709,roughness:.72,metalness:.03,emissive:732440,emissiveIntensity:.04}),r=new ia(new cs(.25,.72,7),s,n);r.castShadow=!0,r.receiveShadow=!0;const a=new ue;for(let o=0;o<n;o+=1){const l=Jt(e*99+o)*Math.PI*2,c=1.2+Jt(e*11+o)*1.5,u=Math.cos(l)*c,h=Math.sin(l)*c,d=t.archetype==="upland"?Ra(u,h,e)+.5:.62;a.position.set(u,d,h),a.scale.setScalar(.72+Jt(e*42+o)*.5),a.rotation.y=l,a.updateMatrix(),r.setMatrixAt(o,a.matrix)}return r.instanceMatrix.needsUpdate=!0,r}createAtmosphere(){const e=new Float32Array(2700);for(let r=0;r<900;r+=1)e[r*3]=(Math.random()-.5)*24,e[r*3+1]=.8+Math.random()*4.2,e[r*3+2]=(Math.random()-.5)*20;const n=new ie;n.setAttribute("position",new Le(e,3));const s=new as({color:13934939,size:.035,transparent:!0,opacity:.12,depthWrite:!1,blending:Je});return{points:new js(n,s),material:s}}createEventParticles(){const e=new Float32Array(2280);for(let a=0;a<760;a+=1)fa(e,a,this.currentCue);const n=new ie;n.setAttribute("position",new Le(e,3));const s=new as({color:9437138,size:.04,transparent:!0,opacity:.22,depthWrite:!1,blending:Je}),r=new js(n,s);return r.frustumCulled=!1,r.renderOrder=4,{points:r,material:s,positions:e}}animateEventParticles(t){const e=this.eventParticlePositions,n=e.length/3,s=this.currentCue;for(let a=0;a<n;a+=1){const o=a*3,l=Math.sin(t*.6+a*.37)*.006;s==="rain"?(e[o]+=l,e[o+1]-=.052+Jt(a*19)*.034,e[o+2]+=.01,e[o+1]<.08&&fa(e,a,s,6.8)):s==="heat"?(e[o]+=l*.8,e[o+1]+=.012+Jt(a*13)*.012,e[o+2]+=Math.sin(t*.9+a)*.003,e[o+1]>5.8&&fa(e,a,s,.32)):s==="air"?(e[o]+=.012+Jt(a*7)*.012,e[o+1]+=Math.sin(t+a)*.002,e[o+2]+=l,e[o]>12&&(e[o]=-12,e[o+1]=.9+Math.random()*3.6,e[o+2]=(Math.random()-.5)*18)):s==="energy"?(e[o]+=Math.sin(t*2.4+a)*.006,e[o+1]+=Math.sin(t*3.2+a*.25)*.004,e[o+2]+=Math.cos(t*2.1+a)*.006):(e[o]+=l*.55,e[o+1]+=Math.sin(t*.72+a)*.002)}const r=this.eventParticles.geometry.getAttribute("position");r.needsUpdate=!0,this.eventParticles.rotation.y=Math.sin(t*.09)*.045}createPolicyFx(){const t=new He;t.visible=!1;const e=260,n=new Float32Array(e*3);for(let u=0;u<e;u+=1)is(n,u,"governance");const s=new ie;s.setAttribute("position",new Le(n,3));const r=new as({color:9437138,size:.06,transparent:!0,opacity:0,depthWrite:!1,blending:Je}),a=new js(s,r);a.frustumCulled=!1,t.add(a);const o=new es(new ie().setAttribute("position",new Xt([-1.9,.25,-1.4,-1.9,2.4,-1.4,-1.9,2.4,-1.4,.9,2.4,-1.4,.9,2.4,-1.4,1.35,1.85,-1.4,-1.9,.95,-1.4,.9,2.4,-1.4,-1.9,1.62,-1.4,-.45,.25,-1.4,1.4,.25,1.35,1.4,1.55,1.35,.6,1.55,1.35,2,1.55,1.35,.6,1.55,1.35,1.4,.25,1.35,2,1.55,1.35,1.4,.25,1.35],3)),new Ci({color:16766815,transparent:!0,opacity:0}));o.renderOrder=5,t.add(o);const l=new Vt(new Gi(3,2.15),new gn({color:16766815,transparent:!0,opacity:0,depthWrite:!1,side:Qe}));l.rotation.x=-Math.PI/2,l.position.y=.08,l.renderOrder=4,t.add(l);const c=this.createPolicyWorkers();return t.add(c),{fx:{group:t,points:a,material:r,positions:n},scaffold:o,workers:c,workPad:l}}createPolicyWorkers(){const t=new He,e=new Ie({color:16766815,roughness:.62,metalness:.08,emissive:3809544,emissiveIntensity:.14}),n=new Ie({color:16773258,roughness:.46,metalness:.1,emissive:4863238,emissiveIntensity:.16});for(let l=0;l<10;l+=1){const c=new He,u=new Vt(new ps(.085,.105,.34,8),e),h=new Vt(new Li(.105,10,8),n);u.position.y=.2,h.position.y=.42,c.add(u,h);const d=l/10*Math.PI*2,p=.9+Jt(l*31)*1.45;c.position.set(Math.cos(d)*p,.16,Math.sin(d)*p),c.rotation.y=-d,c.userData.phase=Jt(l*19)*Math.PI*2,t.add(c)}const s=new Ie({color:16758861,roughness:.54,metalness:.16,emissive:3808261,emissiveIntensity:.12}),r=new He,a=new Vt(new Pe(.62,.24,.32),s),o=new Vt(new Pe(.3,.3,.32),s);return a.position.set(0,.22,0),o.position.set(.42,.26,0),r.add(a,o),r.position.set(-1.75,.18,1.55),r.userData.phase=0,t.add(r),t}createHazardFx(){const t=new He;t.visible=!1;const e=420,n=new Float32Array(e*3);for(let l=0;l<e;l+=1)ss(n,l,"civic");const s=new ie;s.setAttribute("position",new Le(n,3));const r=new as({color:16747082,size:.075,transparent:!0,opacity:0,depthWrite:!1,blending:Je}),a=new js(s,r);a.frustumCulled=!1,a.renderOrder=6,t.add(a);const o=new Vt(new Va(.7,.96,96),new gn({color:16747082,transparent:!0,opacity:0,depthWrite:!1,blending:Je,side:Qe}));return o.rotation.x=-Math.PI/2,o.position.y=.24,o.renderOrder=7,t.add(o),{fx:{group:t,points:a,material:r,positions:n},shockwave:o}}triggerPolicyFx(t,e){var c;const n=La(t.policyId),s=(n==null?void 0:n.category)??"governance",r=t.targetDistrictId??e.selectedDistrictId,a=((c=this.districtVisuals.get(r))==null?void 0:c.root.position)??new C(0,0,-1.2),o=O0(r,a),l=U0(s);this.activePolicyCategory=s,this.policyFx.group.visible=!0,this.policyFx.group.position.set(o.x,.12,o.z),this.policyFx.group.scale.setScalar((n==null?void 0:n.target)==="city"?1.55:1),this.policyFx.material.color.setHex(l),this.policyScaffold.material.color.setHex(s==="energy"?16773258:16766815),this.policyWorkPad.material.color.setHex(l),this.policyFxStart=this.elapsedSeconds;for(let u=0;u<this.policyFx.positions.length/3;u+=1)is(this.policyFx.positions,u,s);this.policyFx.points.geometry.getAttribute("position").needsUpdate=!0}triggerHazardFx(t){this.activeHazardCue=t,this.hazardFx.group.visible=!0,this.hazardFx.group.position.copy(N0(t)),this.hazardFx.material.color.setHex(da(t).particle),this.hazardFx.material.size=t==="rain"?.055:t==="air"?.085:.075,this.hazardShockwave.material.color.setHex(da(t).particle),this.hazardShockwave.visible=!0,this.hazardShockwave.scale.setScalar(.4),this.hazardFxStart=this.elapsedSeconds;for(let e=0;e<this.hazardFx.positions.length/3;e+=1)ss(this.hazardFx.positions,e,t);this.hazardFx.points.geometry.getAttribute("position").needsUpdate=!0}animatePolicyFx(t){const e=t-this.policyFxStart;if(e<0||e>2.9){this.policyFx.group.visible=!1,this.policyFx.material.opacity=0,this.policyScaffold.material.opacity=0,this.policyWorkers.visible=!1,this.policyWorkPad.material.opacity=0;return}const n=Yt(e/2.9,0,1),s=Math.sin(n*Math.PI),r=this.activePolicyCategory,a=this.policyFx.positions;this.policyFx.material.opacity=.62*s,this.policyScaffold.material.opacity=.86*s,this.policyWorkPad.material.opacity=.26*s,this.policyWorkPad.scale.set(1+Math.sin(t*5.5)*.025,1,1+Math.cos(t*4.5)*.025),this.policyScaffold.rotation.y=Math.sin(t*3.2)*.06,this.policyWorkers.visible=s>.04,this.policyWorkers.children.forEach((o,l)=>{const c=typeof o.userData.phase=="number"?o.userData.phase:0;o.position.y=.16+Math.abs(Math.sin(t*7.5+c))*.08,o.rotation.y+=l===this.policyWorkers.children.length-1?.018:Math.sin(t*4+c)*.012});for(let o=0;o<a.length/3;o+=1){const l=o*3;r==="flood"?(a[l]+=Math.sin(t*3+o)*.007,a[l+1]=.18+Math.sin(t*5+o)*.025,a[l+2]+=.025,a[l+2]>2.7&&is(a,o,r)):r==="energy"?(a[l+1]+=.028+Jt(o*11)*.02,a[l]+=Math.sin(t*6+o)*.012,a[l+1]>4.6&&is(a,o,r)):(a[l+1]+=.018+Jt(o*13)*.014,a[l]+=Math.sin(t*2.5+o)*.008,a[l+2]+=Math.cos(t*2.1+o)*.008,a[l+1]>3.5&&is(a,o,r))}this.policyFx.points.geometry.getAttribute("position").needsUpdate=!0}animateHazardFx(t){const e=t-this.hazardFxStart;if(e<0||e>3.2){this.hazardFx.group.visible=!1,this.hazardFx.material.opacity=0,this.hazardShockwave.visible=!1,this.hazardShockwave.material.opacity=0;return}const n=Yt(e/3.2,0,1),s=Math.sin(n*Math.PI),r=this.activeHazardCue,a=this.hazardFx.positions;this.hazardFx.material.opacity=(r==="air"?.58:.72)*s,this.hazardShockwave.visible=!0,this.hazardShockwave.scale.setScalar(.35+n*(r==="rain"?8.2:6.4)),this.hazardShockwave.material.opacity=Math.max(0,.78*(1-n)),this.hazardShockwave.rotation.z=t*(r==="energy"?1.4:.35);for(let o=0;o<a.length/3;o+=1){const l=o*3;r==="rain"?(a[l]+=Math.sin(t*1.7+o)*.01,a[l+1]-=.095+Jt(o*5)*.05,a[l+2]+=.026,a[l+1]<.1&&ss(a,o,r)):r==="heat"?(a[l+1]+=.035+Jt(o*7)*.026,a[l]+=Math.sin(t*5+o)*.012,a[l+1]>5.8&&ss(a,o,r)):r==="air"?(a[l]+=.034+Jt(o*17)*.02,a[l+1]+=Math.sin(t*1.4+o)*.004,a[l]>7.2&&ss(a,o,r)):r==="energy"?(a[l+1]+=Math.sin(t*8+o)*.02,a[l]+=Math.sin(t*12+o)*.018,a[l+2]+=Math.cos(t*10+o)*.018):(a[l+1]+=.018,a[l]+=Math.sin(t*3+o)*.01)}this.hazardFx.points.geometry.getAttribute("position").needsUpdate=!0}createEventFx(){const t=new b0(16757087,.8,24,1.7);t.position.set(0,7.5,1.2);const e=new Vt(new Li(8.2,48,24),new gn({color:16757087,transparent:!0,opacity:.08,depthWrite:!1,blending:Je,side:Ae}));return e.position.set(0,2.4,-.8),e.scale.y=.46,{light:t,halo:e}}}function ql(i){return i.archetype==="downtown"?5467495:i.archetype==="industrial"?5857625:i.archetype==="residential"?6197097:i.archetype==="upland"?4684356:i.archetype==="river"?5603203:6651759}function Ca(i){return i.archetype==="downtown"?42:i.archetype==="industrial"?14:i.archetype==="residential"?20:i.archetype==="upland"?7:i.archetype==="river"?18:20}function Yl(i,t,e){const n=Ca(i),s=i.archetype==="downtown"?7:i.archetype==="industrial"?4:i.archetype==="upland"?3:5,r=Math.ceil(n/s),a=i.archetype==="industrial"?1.28:i.archetype==="upland"?1.35:.86,o=e%s,l=Math.floor(e/s),c=(Jt(t*41+e*3)-.5)*(i.archetype==="downtown"?.14:.24),u=(Jt(t*61+e*7)-.5)*(i.archetype==="upland"?.38:.18),h=-((s-1)*a)/2+o*a+c,d=-((r-1)*a)/2+l*a+u,p=L0(i,e),_=(Jt(t*70+e)-.5)*(i.archetype==="residential"?.34:.16),v=i.archetype==="upland"?Ra(h,d,t)+.08:.18;return i.archetype==="industrial"?{x:h,z:d,baseY:v,height:p,scaleX:1.12+Jt(t*17+e)*.58,scaleZ:.74+Jt(t*23+e)*.62,rotationY:_}:i.archetype==="residential"?{x:h,z:d,baseY:v,height:p,scaleX:.92+Jt(t*13+e)*.2,scaleZ:.54+Jt(t*29+e)*.22,rotationY:_}:i.archetype==="upland"?{x:h,z:d,baseY:v,height:p,scaleX:.55+Jt(t*19+e)*.18,scaleZ:.5+Jt(t*31+e)*.18,rotationY:_}:{x:h,z:d,baseY:v,height:p,scaleX:i.archetype==="downtown"?.68+Jt(t*13+e)*.2:.72,scaleZ:i.archetype==="downtown"?.68+Jt(t*17+e)*.2:.68,rotationY:_}}function L0(i,t){const e=i.imperviousness,n=Jt((t+1)*17);return i.archetype==="downtown"?Yt(2.3+e*4.1+n*4.4,2.2,9.4):i.archetype==="industrial"?Yt(.7+e*.85+n*.9,.85,2.3):i.archetype==="residential"?Yt(.95+e*1.1+n*1.1,1,3.1):i.archetype==="upland"?Yt(.42+e*.55+n*.45,.45,1.15):i.archetype==="river"?Yt(.9+e*1.7+n*1.4,.9,4):Yt(1+e*1.8+n*1.6,1,4.4)}function Ra(i,t,e=0){const n=Math.max(0,(2.6-t)/5.2),s=Math.sin((i+e)*1.7)*.12+Math.cos((t-e)*1.3)*.1;return .12+n*1.25+s}function Jt(i){const t=Math.sin(i*12.9898)*43758.5453;return t-Math.floor(t)}function D0(i,t,e){const n=Yt(e,0,1),s=new St(i);return s.lerp(new St(t),n),s.getHex()}function da(i){return i==="heat"?{background:4860449,fog:10968888,fogDensity:.024,skyTop:12087107,skyBottom:3692125,skyAccent:16747082,waterGlow:3520980,particle:16747082,street:16760938,windowGlow:16765066}:i==="rain"?{background:1521739,fog:3632518,fogDensity:.032,skyTop:4946064,skyBottom:1521739,skyAccent:6018815,waterGlow:6543615,particle:8119039,street:7526911,windowGlow:13235455}:i==="air"?{background:5065010,fog:10783570,fogDensity:.039,skyTop:10324834,skyBottom:3753787,skyAccent:13938779,waterGlow:5220020,particle:13938779,street:13090936,windowGlow:16768906}:i==="energy"?{background:3815204,fog:9141053,fogDensity:.024,skyTop:9073984,skyBottom:2506564,skyAccent:16769146,waterGlow:6806472,particle:16769146,street:16771480,windowGlow:16773286}:{background:1522501,fog:4094063,fogDensity:.025,skyTop:7316389,skyBottom:1522501,skyAccent:9764816,waterGlow:6018815,particle:9764816,street:9437138,windowGlow:14548969}}function I0(i){return i==="rain"?{size:.033,opacity:.4}:i==="heat"?{size:.052,opacity:.34}:i==="air"?{size:.058,opacity:.27}:i==="energy"?{size:.045,opacity:.42}:{size:.038,opacity:.22}}function U0(i){return i==="cooling"||i==="biodiversity"?8191886:i==="flood"?6871551:i==="energy"?16770689:i==="mobility"?8251391:i==="health"?16752560:i==="industry"?12177872:12429055}function N0(i){return i==="rain"?new C(1.8,.2,3.6):i==="heat"?new C(0,.25,-1.2):i==="air"?new C(-4.2,.45,4):i==="energy"?new C(0,2.2,-1.2):new C(0,.6,-1.2)}function O0(i,t){const e={core:[-2,1.85],harbor:[1.3,1.45],riverbend:[-1.65,-1.35],industry:[1.5,-1.25],garden:[-1.4,1.55],hillside:[-1.25,-.75]},[n,s]=e[i]??[0,0];return new C(t.x+n,t.y,t.z+s)}function F0(i){return i?`${i.year}:${i.turn}:${i.policyId}:${i.targetDistrictId??"city"}`:""}function B0(i){return i.lastResolution?`${i.lastResolution.year}:${i.lastResolution.title}:${i.lastResolution.soundCue}`:""}function is(i,t,e){const n=t*3,s=Math.random()*Math.PI*2,r=Math.sqrt(Math.random())*(e==="governance"?3.6:2.35);i[n]=Math.cos(s)*r,i[n+2]=Math.sin(s)*r,e==="flood"?i[n+1]=.12+Math.random()*.28:e==="energy"?i[n+1]=1.2+Math.random()*1.8:i[n+1]=.18+Math.random()*.7}function ss(i,t,e){const n=t*3;if(e==="rain"){i[n]=(Math.random()-.5)*10,i[n+1]=2.4+Math.random()*5.2,i[n+2]=(Math.random()-.5)*6;return}if(e==="heat"){i[n]=(Math.random()-.5)*6.2,i[n+1]=.25+Math.random()*1.2,i[n+2]=(Math.random()-.5)*4.8;return}if(e==="air"){i[n]=-5.8+Math.random()*1.2,i[n+1]=.9+Math.random()*3.4,i[n+2]=(Math.random()-.5)*5.4;return}if(e==="energy"){const s=Math.random()*Math.PI*2,r=1.2+Math.random()*3.2;i[n]=Math.cos(s)*r,i[n+1]=.8+Math.random()*4.6,i[n+2]=Math.sin(s)*r;return}i[n]=(Math.random()-.5)*7.5,i[n+1]=.5+Math.random()*3,i[n+2]=(Math.random()-.5)*6}function fa(i,t,e,n){const s=t*3;i[s]=(Math.random()-.5)*22,i[s+1]=n??(e==="rain"?3.2+Math.random()*4.2:.45+Math.random()*4.8),i[s+2]=(Math.random()-.5)*18}function z0(){const i=document.createElement("canvas");i.width=512,i.height=512;const t=i.getContext("2d");if(!t)return new Nl(i);const e=t.createLinearGradient(0,0,512,512);e.addColorStop(0,"#173034"),e.addColorStop(.52,"#10282d"),e.addColorStop(1,"#0b1d23"),t.fillStyle=e,t.fillRect(0,0,512,512),t.globalAlpha=.18,t.strokeStyle="#7be2d4",t.lineWidth=3;for(let s=42;s<512;s+=74)t.beginPath(),t.moveTo(s,0),t.lineTo(s+36,512),t.stroke(),t.beginPath(),t.moveTo(0,s),t.lineTo(512,s+18),t.stroke();t.globalAlpha=.12,t.strokeStyle="#f5d57a",t.lineWidth=1;for(let s=18;s<512;s+=38)t.beginPath(),t.moveTo(s,0),t.lineTo(s,512),t.stroke();t.globalAlpha=.08,t.fillStyle="#d7fff2";for(let s=0;s<320;s+=1){const r=Jt(s*23)*512,a=Jt(s*41)*512;t.fillRect(r,a,1.2,1.2)}const n=new Nl(i);return n.colorSpace=$e,n.wrapS=ds,n.wrapT=ds,n.repeat.set(2,2),n.anisotropy=4,n}const Xc={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`};class $i{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const k0=new _r(-1,1,1,-1,0,1);class H0 extends ie{constructor(){super(),this.setAttribute("position",new Xt([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new Xt([0,2,0,0,2,0],2))}}const G0=new H0;class $a{constructor(t){this._mesh=new Vt(G0,t)}dispose(){this._mesh.geometry.dispose()}render(t){t.render(this._mesh,k0)}get material(){return this._mesh.material}set material(t){this._mesh.material=t}}class $c extends $i{constructor(t,e){super(),this.textureID=e!==void 0?e:"tDiffuse",t instanceof Ee?(this.uniforms=t.uniforms,this.material=t):t&&(this.uniforms=fs.clone(t.uniforms),this.material=new Ee({name:t.name!==void 0?t.name:"unspecified",defines:Object.assign({},t.defines),uniforms:this.uniforms,vertexShader:t.vertexShader,fragmentShader:t.fragmentShader})),this.fsQuad=new $a(this.material)}render(t,e,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this.fsQuad.material=this.material,this.renderToScreen?(t.setRenderTarget(null),this.fsQuad.render(t)):(t.setRenderTarget(e),this.clear&&t.clear(t.autoClearColor,t.autoClearDepth,t.autoClearStencil),this.fsQuad.render(t))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class Kl extends $i{constructor(t,e){super(),this.scene=t,this.camera=e,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(t,e,n){const s=t.getContext(),r=t.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(s.REPLACE,s.REPLACE,s.REPLACE),r.buffers.stencil.setFunc(s.ALWAYS,a,4294967295),r.buffers.stencil.setClear(o),r.buffers.stencil.setLocked(!0),t.setRenderTarget(n),this.clear&&t.clear(),t.render(this.scene,this.camera),t.setRenderTarget(e),this.clear&&t.clear(),t.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(s.EQUAL,1,4294967295),r.buffers.stencil.setOp(s.KEEP,s.KEEP,s.KEEP),r.buffers.stencil.setLocked(!0)}}class V0 extends $i{constructor(){super(),this.needsSwap=!1}render(t){t.state.buffers.stencil.setLocked(!1),t.state.buffers.stencil.setTest(!1)}}class W0{constructor(t,e){if(this.renderer=t,this._pixelRatio=t.getPixelRatio(),e===void 0){const n=t.getSize(new it);this._width=n.width,this._height=n.height,e=new en(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:Un}),e.texture.name="EffectComposer.rt1"}else this._width=e.width,this._height=e.height;this.renderTarget1=e,this.renderTarget2=e.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new $c(Xc),this.copyPass.material.blending=yn,this.clock=new Wc}swapBuffers(){const t=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=t}addPass(t){this.passes.push(t),t.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(t,e){this.passes.splice(e,0,t),t.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(t){const e=this.passes.indexOf(t);e!==-1&&this.passes.splice(e,1)}isLastEnabledPass(t){for(let e=t+1;e<this.passes.length;e++)if(this.passes[e].enabled)return!1;return!0}render(t){t===void 0&&(t=this.clock.getDelta());const e=this.renderer.getRenderTarget();let n=!1;for(let s=0,r=this.passes.length;s<r;s++){const a=this.passes[s];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(s),a.render(this.renderer,this.writeBuffer,this.readBuffer,t,n),a.needsSwap){if(n){const o=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,t),l.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}Kl!==void 0&&(a instanceof Kl?n=!0:a instanceof V0&&(n=!1))}}this.renderer.setRenderTarget(e)}reset(t){if(t===void 0){const e=this.renderer.getSize(new it);this._pixelRatio=this.renderer.getPixelRatio(),this._width=e.width,this._height=e.height,t=this.renderTarget1.clone(),t.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=t,this.renderTarget2=t.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(t,e){this._width=t,this._height=e;const n=this._width*this._pixelRatio,s=this._height*this._pixelRatio;this.renderTarget1.setSize(n,s),this.renderTarget2.setSize(n,s);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,s)}setPixelRatio(t){this._pixelRatio=t,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}const X0={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Vi.BlurDirectionX=new it(1,0);Vi.BlurDirectionY=new it(0,1);function K0(i,t,e){const n=new W0(i);n.addPass(new q0(t,e));const s=new Vi(new it(window.innerWidth,window.innerHeight),.52,.72,.68);n.addPass(s);const r=new $c({uniforms:{tDiffuse:{value:null},uContrast:{value:1.08},uSaturation:{value:1.12},uVignette:{value:.24}},vertexShader:`
      varying vec2 vUv;
    ...
    `});return n.addPass(r),n.addPass(new $0),n}function j0(){const i=new _r(-12,12,8,-8,.1,200);return i.position.set(15,16,15),i.lookAt(0,.4,-.8),qc(i,window.innerWidth,window.innerHeight),i}function qc(i,t,e){const n=t/Math.max(1,e),s=t<760?23:t<1100?21:17.4,r=s*n;i.left=-r/2,i.right=r/2,i.top=s/2,i.bottom=-s/2,i.updateProjectionMatrix()}function Z0(i){const t=new e0({canvas:i,antialias:!0,powerPreference:"high-performance"});return t.setPixelRatio(Math.min(window.devicePixelRatio,1.75)),t.setSize(window.innerWidth,window.innerHeight,!1),t.outputColorSpace=$e,t.toneMapping=Oa,t.toneMappingExposure=1.06,t.shadowMap.enabled=!0,t.shadowMap.type=ac,t}function J0(){const i=new n0;i.background=new St(594459),i.fog=new xr(662824,.027);const t=new S0(11459839,2502943,1.35);i.add(t);const e=new ua(16773580,3.55);e.position.set(-7,12,8),e.castShadow=!0,e.shadow.mapSize.set(2048,2048),e.shadow.camera.left=-18,e.shadow.camera.right=18,e.shadow.camera.top=18,e.shadow.camera.bottom=-18,e.shadow.bias=-15e-5,e.shadow.normalBias=.04,i.add(e);const n=new ua(7060991,.8);n.position.set(9,5,-8),i.add(n);const s=new ua(9437138,1.15);return s.position.set(4,9,-12),i.add(s),i}function Q0(i,t,e){const n=Z0(i),s=J0(),r=j0(),a=K0(n,s,r),o=t_(r,i),l=new P0(s,t),c=new A0,u=new it,h=new Wc;let d=0,p=!1;const _=()=>e_(n,a,r);window.addEventListener("resize",_);const v=f=>{var U;const T=i.getBoundingClientRect();u.x=(f.clientX-T.left)/T.width*2-1,u.y=-((f.clientY-T.top)/T.height)*2+1,c.setFromCamera(u,r);const S=c.intersectObjects(l.pickables,!0),b=l.findDistrictId(((U=S[0])==null?void 0:U.object)??null);b&&e.onSelectDistrict(b)};i.addEventListener("pointerdown",v);const m=()=>{if(p)return;const f=h.getElapsedTime();l.tick(f),o.update(),a.render(),d=window.requestAnimationFrame(m)};return{update:f=>l.updateFromState(f),playYearTransition:f=>l.playYearTransition(f),start:()=>{_(),m()},dispose:()=>{p=!0,window.cancelAnimationFrame(d),window.removeEventListener("resize",_),i.removeEventListener("pointerdown",v),o.dispose(),n.dispose()}}}function t_(i,t){const e=new C0(i,t);return e.enableDamping=!0,e.dampingFactor=.08,e.minZoom=.62,e.maxZoom=1.65,e.minPolarAngle=Math.PI*.22,e.maxPolarAngle=Math.PI*.38,e.enableRotate=!0,e.enablePan=!0,e.target.set(0,.4,-1),e}function e_(i,t,e){const n=window.innerWidth,s=window.innerHeight;i.setPixelRatio(Math.min(window.devicePixelRatio,1.75)),i.setSize(n,s,!1),t.setSize(n,s),qc(e,n,s)}const n_=[{name:"Open-Meteo",role:"Weather and climate stressors.",url:"https://open-meteo.com/en/docs",licenseOrAccess:"Free public API, no key for normal use.",productionUse:"Temperature, precipitation, wind, flood expansion, and classroom-friendly live data."},{name:"NASA POWER",role:"Solar radiation and climate-energy signals.",url:"https://power.larc.nasa.gov/docs/services/api/",licenseOrAccess:"Free public API.",productionUse:"Solar potential, precipitation, temperature, and renewable energy missions."},{name:"World Bank Indicators API",role:"Population and development indicators.",url:"https://datahelpdesk.worldbank.org/knowledgebase/articles/889392",licenseOrAccess:"Free public API, no key.",productionUse:"Population, urbanization, energy access, GDP, education, and health context."},{name:"UNSD SDG API",role:"Official SDG metadata.",url:"https://unstats.un.org/SDGAPI/swagger/",licenseOrAccess:"Free public API.",productionUse:"SDG indicator labels, official framing, and report outputs."},{name:"OpenAQ",role:"Air quality observations.",url:"https://docs.openaq.org/about/about",licenseOrAccess:"Free account, API key required.",productionUse:"PM2.5, PM10, and NO2 missions. Keep key out of client code for production."}];function i_(i,t){i.className="hud-root";let e,n,s=!1;i.addEventListener("click",a=>{const o=a.target,l=o.closest("[data-policy]"),c=o.closest("[data-district]"),u=o.closest("[data-open-guide]"),h=o.closest("[data-confirm-policy]");if(o.closest("[data-open-policy-board]")){s=!0,r();return}if(o.closest("[data-close-policy-board]")){s=!1,r();return}if(o.closest("[data-close-policy]")){e=void 0,r();return}if(o.closest("[data-close-guide]")){n=void 0,r();return}if(o.closest("[data-open-data-guide]")){t.onOpenDataTutorial();return}if(o.closest("[data-close-data-guide]")){t.onCloseDataTutorial();return}if(o.closest("[data-reset-mission]")){e=void 0,n=void 0,s=!1,t.onResetMission();return}if(o.closest("[data-start-mission]")){t.onStartMission();return}if(h!=null&&h.dataset.confirmPolicy){e=void 0,t.onApplyPolicy(h.dataset.confirmPolicy);return}if(l!=null&&l.dataset.policy){e=l.dataset.policy,r();return}if(O_(u==null?void 0:u.dataset.openGuide)){n=u.dataset.openGuide,r();return}if(c!=null&&c.dataset.district){t.onSelectDistrict(c.dataset.district);return}if(o.closest("[data-advance]")){t.onAdvanceYear();return}if(o.closest("[data-toggle-audio]")){t.onToggleAudio();return}o.closest("[data-live-data]")&&t.onLoadLiveData()});const r=()=>{const a=t.getState(),o=a.districts.find(_=>_.id===a.selectedDistrictId)??a.districts[0],l=e?Pa.find(_=>_.id===e):void 0,c=t.isYearProcessing(),u=t.getDataLoadStatus(),h=t.getDataLoadError(),d=t.getDataSourceStatuses(),p=t.isDataTutorialOpen();i.innerHTML=`
      <section class="top-hud" aria-label="城市狀態">
        ...
        <div class="metric-strip">
          ...
          ${bi("健康",a.publicHealth,"",Ya(a.publicHealth))}
        </div>
      </section>
      ...
      ${r_(a)}
      ${a_(a,o)}
      ${o_(a,t.isAudioEnabled(),c)}
      ${c?l_(a):""}
      ${a.mission.status==="briefing"?u_(a,u,h):""}
      ${p?h_(a,u,d,h):""}
      ${a.mission.status==="won"||a.mission.status==="lost"?E_(a):""}
      ${s?c_(a):""}
      ${l?b_(a,l):""}
      ${n==="mission"?T_(a):""}
      ${n==="challenge"?A_(a):""}
      ${n==="district"?w_(a,o):""}
      ${n==="resolution"?C_(a.lastResolution):""}
    `};return{render:r}}function s_(i){const t=i.mission,e=mu(i),n=Da(i),s=t.objectives.filter(r=>r.passed).length;return`
    <section class="mission-chip mission-panel-open">
      ...
      <div class="mission-objectives">
        ${t.objectives.map(L_).join("")}
      </div>
    </section>
  `}function r_(i){return`
  ...
  `}function l_(i){return`
    <section class="year-transition-panel" aria-live="polite">
      ...
      <p>正在執行 ${Da(i)} 項政策，接著結算本年度意外事件。</p>
    </section>
  `}function c_(i){return`
    <section class="modal-scrim policy-board-scrim">
      <article class="policy-board-panel">
        ...
        <div class="policy-row">
          ${Pa.map(t=>R_(t,i)).join("")}
        </div>
      </article>
    </section>
  `}function u_(i,t,e){const n=i.mission,s=t==="loading",r=t==="ready",a=t==="error";return`
  ...
  `}function h_(i,t,e,n){const s=y_(i),r=d_(i),a=m_(e);return`
  ...
  `}function d_(i){const t=i.climateSignals;return[{kicker:"熱",title:"近年暑季是否已經有熱浪壓力？",value:`${Ge(t.heatwaveDaysPerSeason)} 熱浪日 / ${Ge(t.tropicalNightsPerSeason)} 熱夜`,question:"這裡看的是近 5 個完整暖季，不是今天。熱浪日越多，代表城市每年需要面對的高溫壓力越常出現。",whyItMatters:"熱夜會讓身體沒有恢復時間，會增加中暑、用電尖峰與戶外工作風險。",policyHint:"等一下優先檢查：樹冠降溫、降溫避難網、弱勢街區可近性。",tone:"heat"},{kicker:"雨",title:"雨季強降雨是否讓街區更容易積水？",value:`${Ge(t.heavyRainDaysPerSeason)} 強降雨日 / ${Ge(t.precipitationAnomalyRatio,2)} 倍`,question:"這裡看近 5 個完整暖季的強降雨日與雨量異常，不是某一天剛好下大雨。",whyItMatters:"同一場雨，低窪河岸和鋪面多的街區會比高地或濕地旁更容易積水。",policyHint:"等一下優先檢查：海綿街廓、濕地緩衝、防洪能力。",tone:"rain"},{kicker:"空氣",title:"空污會不會讓健康分數掉得更快？",value:`${Ge(t.pm25UgM3)} µg/m³ PM2.5`,question:"PM2.5 很小，可以進入呼吸系統；產業排放、交通與風速都會影響暴露。",whyItMatters:"老人、兒童、氣喘族群與戶外工作者，通常不是平均承受風險。",policyHint:"等一下優先檢查：產業空污治理、電動公車、空氣監測網。",tone:"air"},{kicker:"城市",title:"人口集中會不會放大政策後果？",value:`${Kc(t.population)} 人 / 都市人口 ${Yc(t.urbanPopulationRatio)}`,question:"人越集中，交通、排水、能源、綠地和避難設施就越需要精準配置。",whyItMatters:"公共健康與公平性不是抽象分數，而是關係到許多人的日常風險與服務可近性。",policyHint:"等一下優先檢查：公共健康、公平性、SDG 11 永續城市。",tone:"civic"}]}function f_(){return[{title:"暴露",body:"人、建築、道路或學校是否位在高溫、淹水、空污會影響的地方。",example:"例：河岸住宅區遇到豪雨，比高地更容易被水影響。"},{title:"脆弱度",body:"同樣遇到災害，哪些族群或街區比較缺少資源保護自己。",example:"例：老人、兒童、戶外工作者，面對熱浪時健康風險更高。"},{title:"調適",body:"用工程、自然系統與社會服務降低災害造成的傷害。",example:"例：樹蔭、避難點、海綿鋪面和濕地都屬於調適策略。"},{title:"取捨",body:"預算和政策數量有限，不能第一年把全部政策都買完。",example:"例：先救熱風險最高街區，可能暫時犧牲能源或產業治理速度。"}].map(t=>`
        <article class="concept-card">
          <h3>${t.title}</h3>
          <p>${t.body}</p>
          <small>${t.example}</small>
        </article>
      `).join("")}function p_(){return[{title:"先判斷主要威脅",prompt:"熱、雨、空氣三種壓力中，哪一種最可能讓本關失敗？你用哪個數值判斷？"},{title:"再判斷脆弱街區",prompt:"同樣的氣候壓力落到不同街區，哪裡會被放大？是低海拔、少樹蔭、交通弱，還是產業負荷高？"},{title:"最後選政策證據",prompt:"如果只能確認 2 項政策，你要先投資哪兩項？請說出它們分別對準哪個風險與任務目標。"}].map((t,e)=>`
        <article class="student-question-card">
          <span>${e+1}</span>
          <h3>${t.title}</h3>
          <p>${t.prompt}</p>
        </article>
      `).join("")}function m_(i){const t=i.filter(s=>s.status==="loaded").length,e=i.filter(s=>s.status==="failed"||s.status==="skipped").length,n=i.filter(s=>s.status==="fallback").length;return`本次整理到 ${t} 個即時來源，${e} 個來源受網路、API key 或缺測限制影響，${n} 個基準補值來源用來補足欄位。這不是要學生相信每個數字都完美，而是練習判斷資料品質。`}function g_(i){const t=i.reduce((n,s)=>({...n,[s.status]:n[s.status]+1}),{loaded:0,failed:0,skipped:0,fallback:0});return[["loaded","即時載入"],["failed","連線失敗"],["skipped","缺 key 或缺測"],["fallback","基準補值"]].map(([n,s])=>`<span class="source-status-badge ${n}">${s} ${t[n]}</span>`).join("")}function __(i){const t=new Map(i.map(n=>[n.name,n]));return[...n_.map(n=>{const s=x_(n.name),r=t.get(n.name);return{name:n.name,url:n.url,status:r,pulledData:s.pulledData,studentNote:s.studentNote}}),{name:"台北本地基準補值",url:"/data/taipei-climate-baseline.json",status:t.get("台北本地基準補值"),pulledData:"作為教室離線或 API 缺項時的台北基準補值，避免單一資料源失效讓課程中斷。",studentNote:"不是玩家可切換的假資料；它用來補足缺漏欄位，讓同一套任務仍能討論資料不確定性。"}].map(n=>`
        <div class="data-source-row">
          <div>
            <a href="${n.url}" target="_blank" rel="noreferrer">${n.name}</a>
            ${n.status?v_(n.status):""}
          </div>
          <p>${n.pulledData}</p>
          <p>
            ${n.studentNote}
    ...
    <section class="modal-scrim">
      <div class="briefing-card ending ${t?"won":"lost"}">
        ...
        <p>${e.debriefBody??""}</p>
        <div class="briefing-objectives">
          ${e.objectives.map(P_).join("")}
        </div>
        <button class="primary-btn large" type="button" data-reset-mission>重製任務</button>
      </div>
    </section>
  `}function b_(i,t){const e=Ia(i,t.id),n=I_(i,t),s=!n&&(e==null?void 0:e.affordable);return`
  ...
  `}function T_(i){const t=i.mission;return`
    <section class="modal-scrim">
  ...
  `}function A_(i){const t=i.currentChallenge;return`
    <section class="modal-scrim">
      <article class="guide-card">
        ...
        <div class="delta-board">
          ${Object.entries(t.pressure).map(([e,n])=>Me(U_(e),n,N_(e))).join("")}
        </div>
      </article>
    </section>
  `}function w_(i,t){return`
    <section class="modal-scrim">
      <article class="guide-card district-guide-card">
        ...
        <div class="district-tabs expanded">
          ${i.districts.map(e=>D_(e,i.selectedDistrictId)).join("")}
        </div>
      </article>
    </section>
  `}function C_(i){return i?`
    <section class="modal-scrim">
      <article class="guide-card">
  ...
  `}function R_(i,t){const e=Ia(t,i.id),n=!(e!=null&&e.affordable);return`
  ...
  `}function Ti(i,t,e){return`
    <div class="district-stat ${e?Ya(t):us(t)}">
      <span>${i}</span>
      <strong>${Math.round(t)}</strong>
    </div>
  `}function Ai(i,t,e){return`
    <span class="mini-stat ${e?Ya(t):us(t)}">
      ${i}<b>${Math.round(t)}</b>
    </span>
  `}function D_(i,t){return`
    <button
      type="button"
  ...
  `}function qa(i){return`${Number.isInteger(i.current)?String(i.current):i.current.toFixed(1)}${i.unit??""}`}function hr(i){return`${Math.round(i)} 百萬`}function Zc(i){const t={"SDG 3":"健康福祉","SDG 6":"潔淨水","SDG 7":"可負擔能源","SDG 9":"產業創新","SDG 10":"減少不平等","SDG 11":"永續城市","SDG 12":"責任消費","SDG 13":"氣候行動","SDG 15":"陸域生態"};return i.map(e=>`${e} ${t[e]??""}`.trim()).join(" / ")}function Me(i,t,e){const n=Math.round(t*10)/10,s=e?n<0:n>0,r=e?n>0:n<0,a=s?"good":r?"danger":"neutral",o=n>0?"+":"";return`
    <span class="delta-chip ${a}">
      ${i} ${o}${n}
    </span>
  `}function I_(i,t){const e=Ia(i,t.id);if(i.mission.status==="briefing")return"請先開始任務，再確認政策投資。";if(i.phase==="complete")return"任務已結束，請使用重製任務重新開始。";if(!(e!=null&&e.canAffordBudget))return`預算不足：目前剩餘 ${hr(i.budget)}。`;if(((e==null?void 0:e.remainingActions)??0)<=0)return"本回合政策額度已用完，請進入下一年。"}function U_(i){return{emissions:"排放",heatRisk:"熱風險",floodRisk:"洪水風險",airQualityRisk:"空氣風險",publicHealth:"公共健康",equity:"公平性",publicTrust:"公共信任",biodiversity:"生物多樣性",energySecurity:"能源安全",educationScore:"教育分數"}[i]??i}function N_(i){return i==="emissions"||i==="heatRisk"||i==="floodRisk"||i==="airQualityRisk"}function O_(i){return i==="mission"||i==="challenge"||i==="district"||i==="resolution"}function us(i){return i>=72?"danger":i>=54?"warn":"good"}function Ya(i){return i>=68?"good":i>=50?"warn":"danger"}const F_={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1},Jc=document.querySelector("#game-canvas"),Qc=document.querySelector("#hud-root");if(!Jc||!Qc)throw new Error("Missing game canvas or HUD root.");let me=Wi(Zl()),Ue=!1,Ri=!1,Jn="idle",dr,Dn=!1,hs=[];const B_=5e3,ye=ou(),Ka=Q0(Jc,me,{onSelectDistrict:i=>tu(i)}),Ni=i_(Qc,{getState:()=>me,onStartMission:()=>{if(Jn!=="ready"){jl();return}Dn=!1;const i=Wu(me);H_(i.currentChallenge.soundCue),ye.startAmbience(i.currentChallenge.soundCue),ye.playEvent(i.currentChallenge.soundCue),xn(i)},onApplyPolicy:i=>{if(Ri)return;const t=me.appliedPolicies.length,e=Xu(me,i);Ue&&e.appliedPolicies.length>t?ye.playPolicy():Ue&&ye.playSelect(),xn(e)},onAdvanceYear:()=>{if(Ri)return;const i=me,t=$u(i);if(t===i||i.mission.status!=="active"){xn(t);return}Ri=!0,Ka.playYearTransition(i),G_(i),Ni.render(),window.setTimeout(()=>{Ri=!1,Ue&&t.lastResolution&&ye.startAmbience(t.currentChallenge.soundCue),Ue&&i.mission.status!==t.mission.status&&(t.mission.status==="won"&&ye.playSuccess(),t.mission.status==="lost"&&ye.playFailure()),xn(t)},B_)},onSelectDistrict:i=>tu(i),onResetMission:()=>z_(),isAudioEnabled:()=>Ue,isYearProcessing:()=>Ri,onToggleAudio:()=>k_(),onLoadLiveData:()=>{Ue&&ye.playSelect(),jl()},getDataLoadStatus:()=>Jn,getDataLoadError:()=>dr,getDataSourceStatuses:()=>hs,isDataTutorialOpen:()=>Dn,onOpenDataTutorial:()=>{Dn=!0,Ni.render()},onCloseDataTutorial:()=>{Dn=!1,Ni.render()}});Ni.render();Ka.start();async function jl(){if(Jn!=="loading"){Jn="loading",dr=void 0,Dn=!1,hs=[],xn({...me,eventLog:["正在載入 Open-Meteo / NASA POWER / World Bank / OpenAQ 公開資料，並整理成任務起始數據。",...me.eventLog].slice(0,10)});try{const i=await zu(me,{useNetwork:!0,openAqApiKey:V_("VITE_OPENAQ_API_KEY")});hs=i.sources,Jn="ready",Dn=!0,xn({...qu(me,i.signals),eventLog:["資料來源已整理，請先閱讀資料科普與來源狀態再開始任務。",...me.eventLog].slice(0,10)})}catch(i){Jn="error",dr=String(i),Dn=!1,hs=[],xn({...me,eventLog:[`公開資料載入失敗，請稍後重試。原因：${String(i)}`,...me.eventLog].slice(0,10)})}}}function tu(i){var t;Ue&&ye.playSelect(),xn({...me,selectedDistrictId:i,eventLog:[`已選擇 ${((t=me.districts.find(e=>e.id===i))==null?void 0:t.name)??i}。`,...me.eventLog].slice(0,10)})}function z_(){Ri=!1,Jn="idle",dr=void 0,Dn=!1,hs=[];const i=Wi(Zl());Ue&&(ye.startAmbience(i.currentChallenge.soundCue),ye.playEvent("civic")),xn(i)}function k_(){Ue=!Ue,ye.setMuted(!Ue),Ue&&(ye.startAmbience(me.currentChallenge.soundCue),ye.playEvent("civic")),Ni.render()}function H_(i){Ue=!0,ye.setMuted(!1),ye.startAmbience(i)}function xn(i){me=i,Ka.update(me),Ni.render()}function G_(i){if(!Ue)return;const t=i.appliedPolicies.filter(n=>n.turn===i.turn).slice().reverse();t.forEach((n,s)=>{window.setTimeout(()=>ye.playPolicy(),260+s*720)});const e=Math.max(1200,680+t.length*720);window.setTimeout(()=>ye.playEvent(i.currentChallenge.soundCue),e)}function V_(i){return F_[i]}
