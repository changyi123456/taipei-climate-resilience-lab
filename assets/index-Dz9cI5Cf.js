...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:_n,depthTest:!1,depthWrite:!1})}function jo(){return new Ee({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Pa(),fragmentShader:`
		...
		`,blending:_n,depthTest:!1,depthWrite:!1})}function Zo(){return new Ee({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Pa(),fragmentShader:`
	...
	`}function Np(i){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===ha||l===da,u=l===Ui||l===Ni;if(c||u){let h=t.get(o);const d=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return e===null&&(e=new Yo(i)),h=c?e.fromEquirectangular(o,h):e.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,t.set(o,h),h.texture;if(h!==void 0)return h.texture;{const p=o.image;return c&&p&&p.height>0||u&&p&&r(p)?(e===null&&(e=new Yo(i)),h=c?e.fromEquirectangular(o):e.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,t.set(o,h),o.addEventListener("dispose",s),h.texture):null}}}return o}function r(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function Fp(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return t[n]=r,r}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const r=e(n);return r===null&&uc("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function Op(i,t,e,n){const r={},s=new WeakMap;function a(h){const d=h.target;d.index!==null&&t.remove(d.index);for(const _ in d.attributes)t.remove(d.attributes[_]);for(const _ in d.morphAttributes){const v=d.morphAttributes[_];for(let m=0,f=v.length;m<f;m++)t.remove(v[m])}d.removeEventListener("dispose",a),delete r[d.id];const p=s.get(d);p&&(t.remove(p),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function o(h,d){return r[d.id]===!0||(d.addEventListener("dispose",a),r[d.id]=!0,e.memory.geometries++),d}function l(h){const d=h.attributes;for(const _ in d)t.update(d[_],i.ARRAY_BUFFER);const p=h.morphAttributes;for(const _ in p){const v=p[_];for(let m=0,f=v.length;m<f;m++)t.update(v[m],i.ARRAY_BUFFER)}}function c(h){const d=[],p=h.index,_=h.attributes.position;let v=0;if(p!==null){const T=p.array;v=p.version;for(let S=0,b=T.length;S<b;S+=3){const U=T[S+0],R=T[S+1],w=T[S+2];d.push(U,R,R,w,w,U)}}else if(_!==void 0){const T=_.array;v=_.version;for(let S=0,b=T.length/3-1;S<b;S+=3){const U=S+0,R=S+1,w=S+2;d.push(U,R,R,w,w,U)}}else return;const m=new(cc(d)?mc:pc)(d,1);m.version=v;const f=s.get(h);f&&t.remove(f),s.set(h,m)}function u(h){const d=s.get(h);if(d){const p=h.index;p!==null&&d.version<p.version&&c(h)}else c(h);return s.get(h)}return{get:o,update:l,getWireframeAttribute:u}}function Bp(i,t,e){let n;function r(d){n=d}let s,a;function o(d){s=d.type,a=d.bytesPerElement}function l(d,p){i.drawElements(n,p,s,d*a),e.update(p,n,1)}function c(d,p,_){_!==0&&(i.drawElementsInstanced(n,p,s,d*a,_),e.update(p,n,_))}function u(d,p,_){if(_===0)return;const v=t.get("WEBGL_multi_draw");if(v===null)for(let m=0;m<_;m++)this.render(d[m]/a,p[m]);else{v.multiDrawElementsWEBGL(n,p,0,s,d,0,_);let m=0;for(let f=0;f<_;f++)m+=p[f];e.update(m,n,1)}}function h(d,p,_,v){if(_===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<d.length;f++)c(d[f]/a,p[f],v[f]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,s,d,0,v,0,_);let f=0;for(let T=0;T<_;T++)f+=p[T];for(let T=0;T<v.length;T++)e.update(f,n,v[T])}}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function zp(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(e.calls++,a){case i.TRIANGLES:e.triangles+=o*(s/3);break;case i.LINES:e.lines+=o*(s/2);break;case i.LINE_STRIP:e.lines+=o*(s-1);break;case i.LINE_LOOP:e.lines+=o*s;break;case i.POINTS:e.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:n}}function kp(i,t,e){const n=new WeakMap,r=new re;function s(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=u!==void 0?u.length:0;let d=n.get(o);if(d===void 0||d.count!==h){let M=function(){I.dispose(),n.delete(o),o.removeEventListener("dispose",M)};var p=M;d!==void 0&&d.texture.dispose();const _=o.morphAttributes.position!==void 0,v=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,f=o.morphAttributes.position||[],T=o.morphAttributes.normal||[],S=o.morphAttributes.color||[];let b=0;_===!0&&(b=1),v===!0&&(b=2),m===!0&&(b=3);let U=o.attributes.position.count*b,R=1;U>t.maxTextureSize&&(R=Math.ceil(U/t.maxTextureSize),U=t.maxTextureSize);const w=new Float32Array(U*R*4*h),I=new dc(w,U,R,h);I.type=pn,I.needsUpdate=!0;const E=b*4;for(let P=0;P<h;P++){const H=f[P],B=T[P],$=S[P],Y=U*R*4*P;for(let W=0;W<H.count;W++){const K=W*E;_===!0&&(r.fromBufferAttribute(H,W),w[Y+K+0]=r.x,w[Y+K+1]=r.y,w[Y+K+2]=r.z,w[Y+K+3]=0),v===!0&&(r.fromBufferAttribute(B,W),w[Y+K+4]=r.x,w[Y+K+5]=r.y,w[Y+K+6]=r.z,w[Y+K+7]=0),m===!0&&(r.fromBufferAttribute($,W),w[Y+K+8]=r.x,w[Y+K+9]=r.y,w[Y+K+10]=r.z,w[Y+K+11]=$.itemSize===4?r.w:1)}}d={count:h,texture:I,size:new it(U,R)},n.set(o,d),o.addEventListener("dispose",M)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,e);else{let _=0;for(let m=0;m<c.length;m++)_+=c[m];const v=o.morphTargetsRelative?1:1-_;l.getUniforms().setValue(i,"morphTargetBaseInfluence",v),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,e),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:s}}function Hp(i,t,e,n){let r=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,h=t.get(l,u);if(r.get(h)!==c&&(t.update(h),r.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==c&&(e.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;r.get(d)!==c&&(d.update(),r.set(d,c))}return h}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:a}}class yc extends we{constructor(t,e,n,r,s,a,o,l,c,u=Li){if(u!==Li&&u!==Bi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Li&&(n=Fi),n===void 0&&u===Bi&&(n=Oi),super(null,r,s,a,o,l,u,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=o!==void 0?o:Ne,this.minFilter=l!==void 0?l:Ne,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const Mc=new we,Sc=new yc(1,1);Sc.compareFunction=lc;const Ec=new dc,bc=new wh,Tc=new vc,Jo=[],Qo=[],tl=new Float32Array(16),el=new Float32Array(9),nl=new Float32Array(4);function Vi(i,t,e){const n=i[0];if(n<=0||n>0)return i;const r=t*e;let s=Jo[r];if(s===void 0&&(s=new Float32Array(r),Jo[r]=s),t!==0){n.toArray(s,0);for(let a=1,o=0;a!==t;++a)o+=e,i[a].toArray(s,o)}return s}function ge(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function _e(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function ms(i,t){let e=Qo[t];e===void 0&&(e=new Int32Array(t),Qo[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function Gp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function Vp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ge(e,t))return;i.uniform2fv(this.addr,t),_e(e,t)}}function Wp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(ge(e,t))return;i.uniform3fv(this.addr,t),_e(e,t)}}function Xp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ge(e,t))return;i.uniform4fv(this.addr,t),_e(e,t)}}function $p(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ge(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),_e(e,t)}else{if(ge(e,n))return;nl.set(n),i.uniformMatrix2fv(this.addr,!1,nl),_e(e,n)}}function qp(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ge(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),_e(e,t)}else{if(ge(e,n))return;el.set(n),i.uniformMatrix3fv(this.addr,!1,el),_e(e,n)}}function Yp(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ge(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),_e(e,t)}else{if(ge(e,n))return;tl.set(n),i.uniformMatrix4fv(this.addr,!1,tl),_e(e,n)}}function Kp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function jp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ge(e,t))return;i.uniform2iv(this.addr,t),_e(e,t)}}function Zp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ge(e,t))return;i.uniform3iv(this.addr,t),_e(e,t)}}function Jp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ge(e,t))return;i.uniform4iv(this.addr,t),_e(e,t)}}function Qp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function tm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ge(e,t))return;i.uniform2uiv(this.addr,t),_e(e,t)}}function em(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ge(e,t))return;i.uniform3uiv(this.addr,t),_e(e,t)}}function nm(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ge(e,t))return;i.uniform4uiv(this.addr,t),_e(e,t)}}function im(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);const s=this.type===i.SAMPLER_2D_SHADOW?Sc:Mc;e.setTexture2D(t||s,r)}function rm(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture3D(t||bc,r)}function sm(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTextureCube(t||Tc,r)}function am(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture2DArray(t||Ec,r)}function om(i){switch(i){case 5126:return Gp;case 35664:return Vp;case 35665:return Wp;case 35666:return Xp;case 35674:return $p;case 35675:return qp;case 35676:return Yp;case 5124:case 35670:return Kp;case 35667:case 35671:return jp;case 35668:case 35672:return Zp;case 35669:case 35673:return Jp;case 5125:return Qp;case 36294:return tm;case 36295:return em;case 36296:return nm;case 35678:case 36198:case 36298:case 36306:case 35682:return im;case 35679:case 36299:case 36307:return rm;case 35680:case 36300:case 36308:case 36293:return sm;case 36289:case 36303:case 36311:case 36292:return am}}function lm(i,t){i.uniform1fv(this.addr,t)}function cm(i,t){const e=Vi(t,this.size,2);i.uniform2fv(this.addr,e)}function um(i,t){const e=Vi(t,this.size,3);i.uniform3fv(this.addr,e)}function hm(i,t){const e=Vi(t,this.size,4);i.uniform4fv(this.addr,e)}function dm(i,t){const e=Vi(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function fm(i,t){const e=Vi(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function pm(i,t){const e=Vi(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function mm(i,t){i.uniform1iv(this.addr,t)}function gm(i,t){i.uniform2iv(this.addr,t)}function _m(i,t){i.uniform3iv(this.addr,t)}function vm(i,t){i.uniform4iv(this.addr,t)}function xm(i,t){i.uniform1uiv(this.addr,t)}function ym(i,t){i.uniform2uiv(this.addr,t)}function Mm(i,t){i.uniform3uiv(this.addr,t)}function Sm(i,t){i.uniform4uiv(this.addr,t)}function Em(i,t,e){const n=this.cache,r=t.length,s=ms(e,r);ge(n,s)||(i.uniform1iv(this.addr,s),_e(n,s));for(let a=0;a!==r;++a)e.setTexture2D(t[a]||Mc,s[a])}function bm(i,t,e){const n=this.cache,r=t.length,s=ms(e,r);ge(n,s)||(i.uniform1iv(this.addr,s),_e(n,s));for(let a=0;a!==r;++a)e.setTexture3D(t[a]||bc,s[a])}function Tm(i,t,e){const n=this.cache,r=t.length,s=ms(e,r);ge(n,s)||(i.uniform1iv(this.addr,s),_e(n,s));for(let a=0;a!==r;++a)e.setTextureCube(t[a]||Tc,s[a])}function Am(i,t,e){const n=this.cache,r=t.length,s=ms(e,r);ge(n,s)||(i.uniform1iv(this.addr,s),_e(n,s));for(let a=0;a!==r;++a)e.setTexture2DArray(t[a]||Ec,s[a])}function wm(i){switch(i){case 5126:return lm;case 35664:return cm;case 35665:return um;case 35666:return hm;case 35674:return dm;case 35675:return fm;case 35676:return pm;case 5124:case 35670:return mm;case 35667:case 35671:return gm;case 35668:case 35672:return _m;case 35669:case 35673:return vm;case 5125:return xm;case 36294:return ym;case 36295:return Mm;case 36296:return Sm;case 35678:case 36198:case 36298:case 36306:case 35682:return Em;case 35679:case 36299:case 36307:return bm;case 35680:case 36300:case 36308:case 36293:return Tm;case 36289:case 36303:case 36311:case 36292:return Am}}class Cm{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=om(e.type)}}class Rm{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=wm(e.type)}}class Pm{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(t,e[o.id],n)}}}const js=/(\w+)(\])?(\[|\.)?/g;function il(i,t){i.seq.push(t),i.map[t.id]=t}function Lm(i,t,e){const n=i.name,r=n.length;for(js.lastIndex=0;;){const s=js.exec(n),a=js.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){il(e,c===void 0?new Cm(o,i,t):new Rm(o,i,t));break}else{let h=e.map[o];h===void 0&&(h=new Pm(o),il(e,h)),e=h}}}class Zr{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=t.getActiveUniform(e,r),a=t.getUniformLocation(e,s.name);Lm(s,a,this)}}setValue(t,e,n,r){const s=this.map[e];s!==void 0&&s.setValue(t,n,r)}setOptional(t,e,n){const r=e[n];r!==void 0&&this.setValue(t,n,r)}static upload(t,e,n,r){for(let s=0,a=e.length;s!==a;++s){const o=e[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(t,l.value,r)}}static seqWithValue(t,e){const n=[];for(let r=0,s=t.length;r!==s;++r){const a=t[r];a.id in e&&n.push(a)}return n}}function rl(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const Dm=37297;let Im=0;function Um(i,t){const e=i.split(`
`),n=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}function Nm(i){const t=Yt.getPrimaries(Yt.workingColorSpace),e=Yt.getPrimaries(i);let n;switch(t===e?n="":t===is&&e===ns?n="LinearDisplayP3ToLinearSRGB":t===ns&&e===is&&(n="LinearSRGBToLinearDisplayP3"),i){case Nn:case fs:return[n,"LinearTransferOETF"];case We:case wa:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function sl(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),r=i.getShaderInfoLog(t).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return e.toUpperCase()+`

`+r+`

`+Um(i.getShaderSource(t),a)}else return r}function Fm(i,t){const e=Nm(t);return`vec4 ${i}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function Om(i,t){let e;switch(t){case Yl:e="Linear";break;case Kl:e="Reinhard";break;case jl:e="OptimizedCineon";break;case Aa:e="ACESFilmic";break;case Zl:e="AgX";break;case Jl:e="Neutral";break;case Zu:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function Bm(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(rr).join(`
`)}function zm(i){const t=[];for(const e in i){const n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function km(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(t,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),e[a]={type:s.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function rr(i){return i!==""}function al(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function ol(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Hm=/^[ \t]*#include +<([\w\d./]+)>/gm;function ma(i){return i.replace(Hm,Vm)}const Gm=new Map;function Vm(i,t){let e=Dt[t];if(e===void 0){const n=Gm.get(t);if(n!==void 0)e=Dt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return ma(e)}const Wm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ll(i){return i.replace(Wm,Xm)}function Xm(i,t,e,n){let r="";for(let s=parseInt(t);s<parseInt(e);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function cl(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function $m(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Xl?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===$l?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===dn&&(t="SHADOWMAP_TYPE_VSM"),t}function qm(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Ui:case Ni:t="ENVMAP_TYPE_CUBE";break;case ds:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Ym(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ni:t="ENVMAP_MODE_REFRACTION";break}return t}function Km(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case ql:t="ENVMAP_BLENDING_MULTIPLY";break;case Ku:t="ENVMAP_BLENDING_MIX";break;case ju:t="ENVMAP_BLENDING_ADD";break}return t}function jm(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Zm(i,t,e,n){const r=i.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=$m(e),c=qm(e),u=Ym(e),h=Km(e),d=jm(e),p=Bm(e),_=zm(s),v=r.createProgram();let m,f,T=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
      ...
      `}),e=new Vt(new ki(23,8,96,28),t);return e.rotation.x=-Math.PI/2,e.position.set(0,-.08,7.4),e.receiveShadow=!0,this.root.add(e),t}createDistrict(t,e){const[n,r]=n0[t.id]??[e*4,0],s=new He;s.position.set(n,0,r),s.userData.districtId=t.id;const a=new Ie({color:Ul(t),roughness:.78,metalness:.08,emissive:397332,emissiveIntensity:.08}),o=new Vt(new Pe(5.2,.28,5.2),a);if(o.castShadow=!0,o.receiveShadow=!0,o.userData.districtId=t.id,s.add(o),this.pickables.push(o),t.archetype==="upland"){const m=this.createHillsideTerrain(e);m.userData.districtId=t.id,s.add(m)}const l=new Ie({color:6000291,roughness:.53,metalness:.18,emissive:1457224,emissiveIntensity:.08}),c=this.createBuildingCluster(t,l,e);if(c.userData.districtId=t.id,s.add(c),this.pickables.push(c),t.id==="core"){const m=this.createTaipeiLandmark(l);m.userData.districtId=t.id,s.add(m),this.pickables.push(m)}const u=this.createWindowCluster(t,e);u.mesh.userData.districtId=t.id,s.add(u.mesh);const h=this.createStreetGrid(t,e);h.lines.userData.districtId=t.id,s.add(h.lines);const d=this.createCanopyCluster(t,e);d.userData.districtId=t.id,s.add(d);const p=new Vt(new Da(3,48),new fn({color:3653112,transparent:!0,opacity:.2,depthWrite:!1}));p.rotation.x=-Math.PI/2,p.position.y=.17,p.visible=!1,p.userData.districtId=t.id,s.add(p);const _=new Vt(new Ri(3.2,36,18),new fn({color:16743229,transparent:!0,opacity:.08,depthWrite:!1,blending:Ke}));_.scale.y=.28,_.position.y=1.4,_.visible=!1,_.userData.districtId=t.id,s.add(_);const v=new Qi(new ie().setAttribute("position",new Wt([-2.72,.24,-2.72,2.72,.24,-2.72,2.72,.24,-2.72,2.72,.24,2.72,2.72,.24,2.72,-2.72,.24,2.72,-2.72,.24,2.72,-2.72,.24,-2.72],3)),new Ai({color:9437138,transparent:!0,opacity:.92}));return v.visible=!1,s.add(v),{root:s,base:o,buildingMaterial:l,windowMaterial:u.material,streetMaterial:h.material,waterOverlay:p,heatDome:_,selectedOutline:v}}createHillsideTerrain(t){const e=new He,n=18,r=5.2,s=[],a=[];for(let h=0;h<=n;h+=1)for(let d=0;d<=n;d+=1){const p=-r/2+d/n*r,_=-r/2+h/n*r,v=xa(p,_,t);s.push(p,v,_)}for(let h=0;h<n;h+=1)for(let d=0;d<n;d+=1){const p=h*(n+1)+d,_=p+1,v=p+n+1,m=v+1;a.push(p,v,_,_,v,m)}const o=new ie;o.setAttribute("position",new Wt(s,3)),o.setIndex(a),o.computeVertexNormals();const l=new Vt(o,new Ie({color:4164952,roughness:.9,metalness:.02,emissive:729876,emissiveIntensity:.06}));l.receiveShadow=!0,l.castShadow=!0,e.add(l);const c=[];for(let h=0;h<5;h+=1){const d=-2.05+h*.72,p=.4+h*.22;c.push(-2.15,p,d,2.15,p+.05,d+.12)}const u=new Qi(new ie().setAttribute("position",new Wt(c,3)),new Ai({color:12050592,transparent:!0,opacity:.46}));return u.renderOrder=3,e.add(u),e}createTaipeiLandmark(t){const e=new He,n=t.clone();n.color.setHex(7317664),n.emissive.setHex(2052429),n.emissiveIntensity=.16;for(let a=0;a<7;a+=1){const o=.92-a*.055,l=new Vt(new Pe(o,.7,o),n);l.position.set(-.7,2.1+a*.72,-.4),l.castShadow=!0,l.receiveShadow=!0,e.add(l)}const r=new Vt(new Pe(1.1,1.2,1.1),n);r.position.set(-.7,.82,-.4),r.castShadow=!0,r.receiveShadow=!0,e.add(r);const s=new Vt(new lr(.18,1.4,8),new Ie({color:13107187,emissive:7340008,emissiveIntensity:.28,roughness:.36,metalness:.34}));return s.position.set(-.7,7.8,-.4),s.castShadow=!0,e.add(s),e}createBuildingCluster(t,e,n){const r=va(t),s=new Js(new Pe(1,1,1),e,r);s.castShadow=!0,s.receiveShadow=!0;const a=new ue;for(let o=0;o<r;o+=1){const l=Nl(t,n,o);a.position.set(l.x,l.baseY+l.height/2,l.z),a.scale.set(l.scaleX,l.height,l.scaleZ),a.rotation.y=l.rotationY,a.updateMatrix(),s.setMatrixAt(o,a.matrix)}return s.instanceMatrix.needsUpdate=!0,s}createWindowCluster(t,e){const n=va(t),r=t.archetype==="downtown"?12:t.archetype==="industrial"?4:6,s=new fn({color:16770984,transparent:!0,opacity:.42,depthWrite:!1,blending:Ke}),a=new Js(new Pe(.12,.085,.014),s,n*r*2);a.frustumCulled=!1;const o=new ue;let l=0;for(let c=0;c<n;c+=1){const u=Nl(t,e,c),h=Math.max(1,Math.min(r,Math.round(u.height*1.25)));for(let d=0;d<h;d+=1){const p=u.baseY+.2+u.height*(d+1)/(h+1),_=(jt(e*211+c*17+d)-.5)*.22;o.position.set(u.x+_,p,u.z+u.scaleZ*.51),o.rotation.set(0,u.rotationY,0),o.scale.setScalar(t.archetype==="industrial"?1.25:1),o.updateMatrix(),a.setMatrixAt(l,o.matrix),l+=1,o.position.set(u.x+u.scaleX*.51,p,u.z+_),o.rotation.set(0,u.rotationY+Math.PI/2,0),o.scale.setScalar(t.archetype==="industrial"?1.25:1),o.updateMatrix(),a.setMatrixAt(l,o.matrix),l+=1}}return a.count=l,a.instanceMatrix.needsUpdate=!0,{mesh:a,material:s}}createStreetGrid(t,e){const n=[],r=t.archetype==="downtown"?5:t.archetype==="upland"?3:4,s=2.5,a=.205;for(let u=0;u<r;u+=1){const h=u/(r-1),d=-s+h*s*2+(jt(e*81+u)-.5)*.16;n.push(-s,a,d,s,a,d),n.push(d,a,-s,d,a,s)}n.push(-s,a,-s,s,a,-s),n.push(s,a,-s,s,a,s),n.push(s,a,s,-s,a,s),n.push(-s,a,s,-s,a,-s);const o=new ie;o.setAttribute("position",new Wt(n,3));const l=new Ai({color:8775895,transparent:!0,opacity:.42,depthWrite:!1}),c=new Qi(o,l);return c.renderOrder=3,{lines:c,material:l}}createCanopyCluster(t,e){const n=Math.max(4,Math.round(t.canopyCover*46)),r=new Ie({color:5752709,roughness:.72,metalness:.03,emissive:732440,emissiveIntensity:.04}),s=new Js(new lr(.25,.72,7),r,n);s.castShadow=!0,s.receiveShadow=!0;const a=new ue;for(let o=0;o<n;o+=1){const l=jt(e*99+o)*Math.PI*2,c=1.2+jt(e*11+o)*1.5,u=Math.cos(l)*c,h=Math.sin(l)*c,d=t.archetype==="upland"?xa(u,h,e)+.5:.62;a.position.set(u,d,h),a.scale.setScalar(.72+jt(e*42+o)*.5),a.rotation.y=l,a.updateMatrix(),s.setMatrixAt(o,a.matrix)}return s.instanceMatrix.needsUpdate=!0,s}createAtmosphere(){const e=new Float32Array(2700);for(let s=0;s<900;s+=1)e[s*3]=(Math.random()-.5)*24,e[s*3+1]=.8+Math.random()*4.2,e[s*3+2]=(Math.random()-.5)*20;const n=new ie;n.setAttribute("position",new Le(e,3));const r=new sr({color:13934939,size:.035,transparent:!0,opacity:.12,depthWrite:!1,blending:Ke});return{points:new qr(n,r),material:r}}createEventParticles(){const e=new Float32Array(2280);for(let a=0;a<760;a+=1)la(e,a,this.currentCue);const n=new ie;n.setAttribute("position",new Le(e,3));const r=new sr({color:9437138,size:.04,transparent:!0,opacity:.22,depthWrite:!1,blending:Ke}),s=new qr(n,r);return s.frustumCulled=!1,s.renderOrder=4,{points:s,material:r,positions:e}}animateEventParticles(t){const e=this.eventParticlePositions,n=e.length/3,r=this.currentCue;for(let a=0;a<n;a+=1){const o=a*3,l=Math.sin(t*.6+a*.37)*.006;r==="rain"?(e[o]+=l,e[o+1]-=.052+jt(a*19)*.034,e[o+2]+=.01,e[o+1]<.08&&la(e,a,r,6.8)):r==="heat"?(e[o]+=l*.8,e[o+1]+=.012+jt(a*13)*.012,e[o+2]+=Math.sin(t*.9+a)*.003,e[o+1]>5.8&&la(e,a,r,.32)):r==="air"?(e[o]+=.012+jt(a*7)*.012,e[o+1]+=Math.sin(t+a)*.002,e[o+2]+=l,e[o]>12&&(e[o]=-12,e[o+1]=.9+Math.random()*3.6,e[o+2]=(Math.random()-.5)*18)):r==="energy"?(e[o]+=Math.sin(t*2.4+a)*.006,e[o+1]+=Math.sin(t*3.2+a*.25)*.004,e[o+2]+=Math.cos(t*2.1+a)*.006):(e[o]+=l*.55,e[o+1]+=Math.sin(t*.72+a)*.002)}const s=this.eventParticles.geometry.getAttribute("position");s.needsUpdate=!0,this.eventParticles.rotation.y=Math.sin(t*.09)*.045}createPolicyFx(){const t=new He;t.visible=!1;const e=260,n=new Float32Array(e*3);for(let u=0;u<e;u+=1)er(n,u,"governance");const r=new ie;r.setAttribute("position",new Le(n,3));const s=new sr({color:9437138,size:.06,transparent:!0,opacity:0,depthWrite:!1,blending:Ke}),a=new qr(r,s);a.frustumCulled=!1,t.add(a);const o=new Qi(new ie().setAttribute("position",new Wt([-1.9,.25,-1.4,-1.9,2.4,-1.4,-1.9,2.4,-1.4,.9,2.4,-1.4,.9,2.4,-1.4,1.35,1.85,-1.4,-1.9,.95,-1.4,.9,2.4,-1.4,-1.9,1.62,-1.4,-.45,.25,-1.4,1.4,.25,1.35,1.4,1.55,1.35,.6,1.55,1.35,2,1.55,1.35,.6,1.55,1.35,1.4,.25,1.35,2,1.55,1.35,1.4,.25,1.35],3)),new Ai({color:16766815,transparent:!0,opacity:0}));o.renderOrder=5,t.add(o);const l=new Vt(new ki(3,2.15),new fn({color:16766815,transparent:!0,opacity:0,depthWrite:!1,side:je}));l.rotation.x=-Math.PI/2,l.position.y=.08,l.renderOrder=4,t.add(l);const c=this.createPolicyWorkers();return t.add(c),{fx:{group:t,points:a,material:s,positions:n},scaffold:o,workers:c,workPad:l}}createPolicyWorkers(){const t=new He,e=new Ie({color:16766815,roughness:.62,metalness:.08,emissive:3809544,emissiveIntensity:.14}),n=new Ie({color:16773258,roughness:.46,metalness:.1,emissive:4863238,emissiveIntensity:.16});for(let l=0;l<10;l+=1){const c=new He,u=new Vt(new dr(.085,.105,.34,8),e),h=new Vt(new Ri(.105,10,8),n);u.position.y=.2,h.position.y=.42,c.add(u,h);const d=l/10*Math.PI*2,p=.9+jt(l*31)*1.45;c.position.set(Math.cos(d)*p,.16,Math.sin(d)*p),c.rotation.y=-d,c.userData.phase=jt(l*19)*Math.PI*2,t.add(c)}const r=new Ie({color:16758861,roughness:.54,metalness:.16,emissive:3808261,emissiveIntensity:.12}),s=new He,a=new Vt(new Pe(.62,.24,.32),r),o=new Vt(new Pe(.3,.3,.32),r);return a.position.set(0,.22,0),o.position.set(.42,.26,0),s.add(a,o),s.position.set(-1.75,.18,1.55),s.userData.phase=0,t.add(s),t}createHazardFx(){const t=new He;t.visible=!1;const e=420,n=new Float32Array(e*3);for(let l=0;l<e;l+=1)nr(n,l,"civic");const r=new ie;r.setAttribute("position",new Le(n,3));const s=new sr({color:16747082,size:.075,transparent:!0,opacity:0,depthWrite:!1,blending:Ke}),a=new qr(r,s);a.frustumCulled=!1,a.renderOrder=6,t.add(a);const o=new Vt(new Ia(.7,.96,96),new fn({color:16747082,transparent:!0,opacity:0,depthWrite:!1,blending:Ke,side:je}));return o.rotation.x=-Math.PI/2,o.position.y=.24,o.renderOrder=7,t.add(o),{fx:{group:t,points:a,material:s,positions:n},shockwave:o}}triggerPolicyFx(t,e){var c;const n=Ma(t.policyId),r=(n==null?void 0:n.category)??"governance",s=t.targetDistrictId??e.selectedDistrictId,a=((c=this.districtVisuals.get(s))==null?void 0:c.root.position)??new C(0,0,-1.2),o=c0(s,a),l=o0(r);this.activePolicyCategory=r,this.policyFx.group.visible=!0,this.policyFx.group.position.set(o.x,.12,o.z),this.policyFx.group.scale.setScalar((n==null?void 0:n.target)==="city"?1.55:1),this.policyFx.material.color.setHex(l),this.policyScaffold.material.color.setHex(r==="energy"?16773258:16766815),this.policyWorkPad.material.color.setHex(l),this.policyFxStart=this.elapsedSeconds;for(let u=0;u<this.policyFx.positions.length/3;u+=1)er(this.policyFx.positions,u,r);this.policyFx.points.geometry.getAttribute("position").needsUpdate=!0}triggerHazardFx(t){this.activeHazardCue=t,this.hazardFx.group.visible=!0,this.hazardFx.group.position.copy(l0(t)),this.hazardFx.material.color.setHex(oa(t).particle),this.hazardFx.material.size=t==="rain"?.055:t==="air"?.085:.075,this.hazardShockwave.material.color.setHex(oa(t).particle),this.hazardShockwave.visible=!0,this.hazardShockwave.scale.setScalar(.4),this.hazardFxStart=this.elapsedSeconds;for(let e=0;e<this.hazardFx.positions.length/3;e+=1)nr(this.hazardFx.positions,e,t);this.hazardFx.points.geometry.getAttribute("position").needsUpdate=!0}animatePolicyFx(t){const e=t-this.policyFxStart;if(e<0||e>2.9){this.policyFx.group.visible=!1,this.policyFx.material.opacity=0,this.policyScaffold.material.opacity=0,this.policyWorkers.visible=!1,this.policyWorkPad.material.opacity=0;return}const n=te(e/2.9,0,1),r=Math.sin(n*Math.PI),s=this.activePolicyCategory,a=this.policyFx.positions;this.policyFx.material.opacity=.62*r,this.policyScaffold.material.opacity=.86*r,this.policyWorkPad.material.opacity=.26*r,this.policyWorkPad.scale.set(1+Math.sin(t*5.5)*.025,1,1+Math.cos(t*4.5)*.025),this.policyScaffold.rotation.y=Math.sin(t*3.2)*.06,this.policyWorkers.visible=r>.04,this.policyWorkers.children.forEach((o,l)=>{const c=typeof o.userData.phase=="number"?o.userData.phase:0;o.position.y=.16+Math.abs(Math.sin(t*7.5+c))*.08,o.rotation.y+=l===this.policyWorkers.children.length-1?.018:Math.sin(t*4+c)*.012});for(let o=0;o<a.length/3;o+=1){const l=o*3;s==="flood"?(a[l]+=Math.sin(t*3+o)*.007,a[l+1]=.18+Math.sin(t*5+o)*.025,a[l+2]+=.025,a[l+2]>2.7&&er(a,o,s)):s==="energy"?(a[l+1]+=.028+jt(o*11)*.02,a[l]+=Math.sin(t*6+o)*.012,a[l+1]>4.6&&er(a,o,s)):(a[l+1]+=.018+jt(o*13)*.014,a[l]+=Math.sin(t*2.5+o)*.008,a[l+2]+=Math.cos(t*2.1+o)*.008,a[l+1]>3.5&&er(a,o,s))}this.policyFx.points.geometry.getAttribute("position").needsUpdate=!0}animateHazardFx(t){const e=t-this.hazardFxStart;if(e<0||e>3.2){this.hazardFx.group.visible=!1,this.hazardFx.material.opacity=0,this.hazardShockwave.visible=!1,this.hazardShockwave.material.opacity=0;return}const n=te(e/3.2,0,1),r=Math.sin(n*Math.PI),s=this.activeHazardCue,a=this.hazardFx.positions;this.hazardFx.material.opacity=(s==="air"?.58:.72)*r,this.hazardShockwave.visible=!0,this.hazardShockwave.scale.setScalar(.35+n*(s==="rain"?8.2:6.4)),this.hazardShockwave.material.opacity=Math.max(0,.78*(1-n)),this.hazardShockwave.rotation.z=t*(s==="energy"?1.4:.35);for(let o=0;o<a.length/3;o+=1){const l=o*3;s==="rain"?(a[l]+=Math.sin(t*1.7+o)*.01,a[l+1]-=.095+jt(o*5)*.05,a[l+2]+=.026,a[l+1]<.1&&nr(a,o,s)):s==="heat"?(a[l+1]+=.035+jt(o*7)*.026,a[l]+=Math.sin(t*5+o)*.012,a[l+1]>5.8&&nr(a,o,s)):s==="air"?(a[l]+=.034+jt(o*17)*.02,a[l+1]+=Math.sin(t*1.4+o)*.004,a[l]>7.2&&nr(a,o,s)):s==="energy"?(a[l+1]+=Math.sin(t*8+o)*.02,a[l]+=Math.sin(t*12+o)*.018,a[l+2]+=Math.cos(t*10+o)*.018):(a[l+1]+=.018,a[l]+=Math.sin(t*3+o)*.01)}this.hazardFx.points.geometry.getAttribute("position").needsUpdate=!0}createEventFx(){const t=new Zg(16757087,.8,24,1.7);t.position.set(0,7.5,1.2);const e=new Vt(new Ri(8.2,48,24),new fn({color:16757087,transparent:!0,opacity:.08,depthWrite:!1,blending:Ke,side:Ae}));return e.position.set(0,2.4,-.8),e.scale.y=.46,{light:t,halo:e}}}function Ul(i){return i.archetype==="downtown"?5467495:i.archetype==="industrial"?5857625:i.archetype==="residential"?6197097:i.archetype==="upland"?4684356:i.archetype==="river"?5603203:6651759}function va(i){return i.archetype==="downtown"?42:i.archetype==="industrial"?14:i.archetype==="residential"?20:i.archetype==="upland"?7:i.archetype==="river"?18:20}function Nl(i,t,e){const n=va(i),r=i.archetype==="downtown"?7:i.archetype==="industrial"?4:i.archetype==="upland"?3:5,s=Math.ceil(n/r),a=i.archetype==="industrial"?1.28:i.archetype==="upland"?1.35:.86,o=e%r,l=Math.floor(e/r),c=(jt(t*41+e*3)-.5)*(i.archetype==="downtown"?.14:.24),u=(jt(t*61+e*7)-.5)*(i.archetype==="upland"?.38:.18),h=-((r-1)*a)/2+o*a+c,d=-((s-1)*a)/2+l*a+u,p=r0(i,e),_=(jt(t*70+e)-.5)*(i.archetype==="residential"?.34:.16),v=i.archetype==="upland"?xa(h,d,t)+.08:.18;return i.archetype==="industrial"?{x:h,z:d,baseY:v,height:p,scaleX:1.12+jt(t*17+e)*.58,scaleZ:.74+jt(t*23+e)*.62,rotationY:_}:i.archetype==="residential"?{x:h,z:d,baseY:v,height:p,scaleX:.92+jt(t*13+e)*.2,scaleZ:.54+jt(t*29+e)*.22,rotationY:_}:i.archetype==="upland"?{x:h,z:d,baseY:v,height:p,scaleX:.55+jt(t*19+e)*.18,scaleZ:.5+jt(t*31+e)*.18,rotationY:_}:{x:h,z:d,baseY:v,height:p,scaleX:i.archetype==="downtown"?.68+jt(t*13+e)*.2:.72,scaleZ:i.archetype==="downtown"?.68+jt(t*17+e)*.2:.68,rotationY:_}}function r0(i,t){const e=i.imperviousness,n=jt((t+1)*17);return i.archetype==="downtown"?te(2.3+e*4.1+n*4.4,2.2,9.4):i.archetype==="industrial"?te(.7+e*.85+n*.9,.85,2.3):i.archetype==="residential"?te(.95+e*1.1+n*1.1,1,3.1):i.archetype==="upland"?te(.42+e*.55+n*.45,.45,1.15):i.archetype==="river"?te(.9+e*1.7+n*1.4,.9,4):te(1+e*1.8+n*1.6,1,4.4)}function xa(i,t,e=0){const n=Math.max(0,(2.6-t)/5.2),r=Math.sin((i+e)*1.7)*.12+Math.cos((t-e)*1.3)*.1;return .12+n*1.25+r}function jt(i){const t=Math.sin(i*12.9898)*43758.5453;return t-Math.floor(t)}function s0(i,t,e){const n=te(e,0,1),r=new St(i);return r.lerp(new St(t),n),r.getHex()}function oa(i){return i==="heat"?{background:4860449,fog:10968888,fogDensity:.024,skyTop:12087107,skyBottom:3692125,skyAccent:16747082,waterGlow:3520980,particle:16747082,street:16760938,windowGlow:16765066}:i==="rain"?{background:1521739,fog:3632518,fogDensity:.032,skyTop:4946064,skyBottom:1521739,skyAccent:6018815,waterGlow:6543615,particle:8119039,street:7526911,windowGlow:13235455}:i==="air"?{background:5065010,fog:10783570,fogDensity:.039,skyTop:10324834,skyBottom:3753787,skyAccent:13938779,waterGlow:5220020,particle:13938779,street:13090936,windowGlow:16768906}:i==="energy"?{background:3815204,fog:9141053,fogDensity:.024,skyTop:9073984,skyBottom:2506564,skyAccent:16769146,waterGlow:6806472,particle:16769146,street:16771480,windowGlow:16773286}:{background:1522501,fog:4094063,fogDensity:.025,skyTop:7316389,skyBottom:1522501,skyAccent:9764816,waterGlow:6018815,particle:9764816,street:9437138,windowGlow:14548969}}function a0(i){return i==="rain"?{size:.033,opacity:.4}:i==="heat"?{size:.052,opacity:.34}:i==="air"?{size:.058,opacity:.27}:i==="energy"?{size:.045,opacity:.42}:{size:.038,opacity:.22}}function o0(i){return i==="cooling"||i==="biodiversity"?8191886:i==="flood"?6871551:i==="energy"?16770689:i==="mobility"?8251391:i==="health"?16752560:i==="industry"?12177872:12429055}function l0(i){return i==="rain"?new C(1.8,.2,3.6):i==="heat"?new C(0,.25,-1.2):i==="air"?new C(-4.2,.45,4):i==="energy"?new C(0,2.2,-1.2):new C(0,.6,-1.2)}function c0(i,t){const e={core:[-2,1.85],harbor:[1.3,1.45],riverbend:[-1.65,-1.35],industry:[1.5,-1.25],garden:[-1.4,1.55],hillside:[-1.25,-.75]},[n,r]=e[i]??[0,0];return new C(t.x+n,t.y,t.z+r)}function u0(i){return i?`${i.year}:${i.turn}:${i.policyId}:${i.targetDistrictId??"city"}`:""}function h0(i){return i.lastResolution?`${i.lastResolution.year}:${i.lastResolution.title}:${i.lastResolution.soundCue}`:""}function er(i,t,e){const n=t*3,r=Math.random()*Math.PI*2,s=Math.sqrt(Math.random())*(e==="governance"?3.6:2.35);i[n]=Math.cos(r)*s,i[n+2]=Math.sin(r)*s,e==="flood"?i[n+1]=.12+Math.random()*.28:e==="energy"?i[n+1]=1.2+Math.random()*1.8:i[n+1]=.18+Math.random()*.7}function nr(i,t,e){const n=t*3;if(e==="rain"){i[n]=(Math.random()-.5)*10,i[n+1]=2.4+Math.random()*5.2,i[n+2]=(Math.random()-.5)*6;return}if(e==="heat"){i[n]=(Math.random()-.5)*6.2,i[n+1]=.25+Math.random()*1.2,i[n+2]=(Math.random()-.5)*4.8;return}if(e==="air"){i[n]=-5.8+Math.random()*1.2,i[n+1]=.9+Math.random()*3.4,i[n+2]=(Math.random()-.5)*5.4;return}if(e==="energy"){const r=Math.random()*Math.PI*2,s=1.2+Math.random()*3.2;i[n]=Math.cos(r)*s,i[n+1]=.8+Math.random()*4.6,i[n+2]=Math.sin(r)*s;return}i[n]=(Math.random()-.5)*7.5,i[n+1]=.5+Math.random()*3,i[n+2]=(Math.random()-.5)*6}function la(i,t,e,n){const r=t*3;i[r]=(Math.random()-.5)*22,i[r+1]=n??(e==="rain"?3.2+Math.random()*4.2:.45+Math.random()*4.8),i[r+2]=(Math.random()-.5)*18}function d0(){const i=document.createElement("canvas");i.width=512,i.height=512;const t=i.getContext("2d");if(!t)return new Sl(i);const e=t.createLinearGradient(0,0,512,512);e.addColorStop(0,"#173034"),e.addColorStop(.52,"#10282d"),e.addColorStop(1,"#0b1d23"),t.fillStyle=e,t.fillRect(0,0,512,512),t.globalAlpha=.18,t.strokeStyle="#7be2d4",t.lineWidth=3;for(let r=42;r<512;r+=74)t.beginPath(),t.moveTo(r,0),t.lineTo(r+36,512),t.stroke(),t.beginPath(),t.moveTo(0,r),t.lineTo(512,r+18),t.stroke();t.globalAlpha=.12,t.strokeStyle="#f5d57a",t.lineWidth=1;for(let r=18;r<512;r+=38)t.beginPath(),t.moveTo(r,0),t.lineTo(r,512),t.stroke();t.globalAlpha=.08,t.fillStyle="#d7fff2";for(let r=0;r<320;r+=1){const s=jt(r*23)*512,a=jt(r*41)*512;t.fillRect(s,a,1.2,1.2)}const n=new Sl(i);return n.colorSpace=We,n.wrapS=ur,n.wrapT=ur,n.repeat.set(2,2),n.anisotropy=4,n}const Lc={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Hi.BlurDirectionX=new it(1,0);Hi.BlurDirectionY=new it(0,1);function S0(i,t,e){const n=new _0(i);n.addPass(new y0(t,e));const r=new Hi(new it(window.innerWidth,window.innerHeight),.52,.72,.68);n.addPass(r);const s=new Dc({uniforms:{tDiffuse:{value:null},uContrast:{value:1.08},uSaturation:{value:1.12},uVignette:{value:.24}},vertexShader:`
      varying vec2 vUv;
    ...
    `});return n.addPass(s),n.addPass(new x0),n}function E0(){const i=new ps(-12,12,8,-8,.1,200);return i.position.set(15,16,15),i.lookAt(0,.4,-.8),Ic(i,window.innerWidth,window.innerHeight),i}function Ic(i,t,e){const n=t/Math.max(1,e),r=t<760?23:t<1100?21:17.4,s=r*n;i.left=-s/2,i.right=s/2,i.top=r/2,i.bottom=-r/2,i.updateProjectionMatrix()}function b0(i){const t=new Cg({canvas:i,antialias:!0,powerPreference:"high-performance"});return t.setPixelRatio(Math.min(window.devicePixelRatio,1.75)),t.setSize(window.innerWidth,window.innerHeight,!1),t.outputColorSpace=We,t.toneMapping=Aa,t.toneMappingExposure=1.06,t.shadowMap.enabled=!0,t.shadowMap.type=$l,t}function T0(){const i=new Rg;i.background=new St(594459),i.fog=new gs(662824,.027);const t=new Kg(11459839,2502943,1.35);i.add(t);const e=new sa(16773580,3.55);e.position.set(-7,12,8),e.castShadow=!0,e.shadow.mapSize.set(2048,2048),e.shadow.camera.left=-18,e.shadow.camera.right=18,e.shadow.camera.top=18,e.shadow.camera.bottom=-18,e.shadow.bias=-15e-5,e.shadow.normalBias=.04,i.add(e);const n=new sa(7060991,.8);n.position.set(9,5,-8),i.add(n);const r=new sa(9437138,1.15);return r.position.set(4,9,-12),i.add(r),i}function A0(i,t,e){const n=b0(i),r=T0(),s=E0(),a=S0(n,r,s),o=w0(s,i),l=new i0(r,t),c=new Qg,u=new it,h=new Pc;let d=0,p=!1;const _=()=>C0(n,a,s);window.addEventListener("resize",_);const v=f=>{var U;const T=i.getBoundingClientRect();u.x=(f.clientX-T.left)/T.width*2-1,u.y=-((f.clientY-T.top)/T.height)*2+1,c.setFromCamera(u,s);const S=c.intersectObjects(l.pickables,!0),b=l.findDistrictId(((U=S[0])==null?void 0:U.object)??null);b&&e.onSelectDistrict(b)};i.addEventListener("pointerdown",v);const m=()=>{if(p)return;const f=h.getElapsedTime();l.tick(f),o.update(),a.render(),d=window.requestAnimationFrame(m)};return{update:f=>l.updateFromState(f),playYearTransition:f=>l.playYearTransition(f),start:()=>{_(),m()},dispose:()=>{p=!0,window.cancelAnimationFrame(d),window.removeEventListener("resize",_),i.removeEventListener("pointerdown",v),o.dispose(),n.dispose()}}}function w0(i,t){const e=new e0(i,t);return e.enableDamping=!0,e.dampingFactor=.08,e.minZoom=.62,e.maxZoom=1.65,e.minPolarAngle=Math.PI*.22,e.maxPolarAngle=Math.PI*.38,e.enableRotate=!0,e.enablePan=!0,e.target.set(0,.4,-1),e}function C0(i,t,e){const n=window.innerWidth,r=window.innerHeight;i.setPixelRatio(Math.min(window.devicePixelRatio,1.75)),i.setSize(n,r,!1),t.setSize(n,r),Ic(e,n,r)}const R0=[{name:"Open-Meteo",role:"Weather and climate stressors.",url:"https://open-meteo.com/en/docs",licenseOrAccess:"Free public API, no key for normal use.",productionUse:"Temperature, precipitation, wind, flood expansion, and classroom-friendly live data."},{name:"NASA POWER",role:"Solar radiation and climate-energy signals.",url:"https://power.larc.nasa.gov/docs/services/api/",licenseOrAccess:"Free public API.",productionUse:"Solar potential, precipitation, temperature, and renewable energy missions."},{name:"World Bank Indicators API",role:"Population and development indicators.",url:"https://datahelpdesk.worldbank.org/knowledgebase/articles/889392",licenseOrAccess:"Free public API, no key.",productionUse:"Population, urbanization, energy access, GDP, education, and health context."},{name:"UNSD SDG API",role:"Official SDG metadata.",url:"https://unstats.un.org/SDGAPI/swagger/",licenseOrAccess:"Free public API.",productionUse:"SDG indicator labels, official framing, and report outputs."},{name:"OpenAQ",role:"Air quality observations.",url:"https://docs.openaq.org/about/about",licenseOrAccess:"Free account, API key required.",productionUse:"PM2.5, PM10, and NO2 missions. Keep key out of client code for production."}];function P0(i,t){i.className="hud-root";let e,n,r=!1;i.addEventListener("click",a=>{const o=a.target,l=o.closest("[data-policy]"),c=o.closest("[data-district]"),u=o.closest("[data-open-guide]"),h=o.closest("[data-confirm-policy]");if(o.closest("[data-open-policy-board]")){r=!0,s();return}if(o.closest("[data-close-policy-board]")){r=!1,s();return}if(o.closest("[data-close-policy]")){e=void 0,s();return}if(o.closest("[data-close-guide]")){n=void 0,s();return}if(o.closest("[data-open-data-guide]")){t.onOpenDataTutorial();return}if(o.closest("[data-close-data-guide]")){t.onCloseDataTutorial();return}if(o.closest("[data-reset-mission]")){e=void 0,n=void 0,r=!1,t.onResetMission();return}if(o.closest("[data-start-mission]")){t.onStartMission();return}if(h!=null&&h.dataset.confirmPolicy){e=void 0,t.onApplyPolicy(h.dataset.confirmPolicy);return}if(l!=null&&l.dataset.policy){e=l.dataset.policy,s();return}if(a_(u==null?void 0:u.dataset.openGuide)){n=u.dataset.openGuide,s();return}if(c!=null&&c.dataset.district){t.onSelectDistrict(c.dataset.district);return}if(o.closest("[data-advance]")){t.onAdvanceYear();return}if(o.closest("[data-toggle-audio]")){t.onToggleAudio();return}o.closest("[data-live-data]")&&t.onLoadLiveData()});const s=()=>{const a=t.getState(),o=a.districts.find(p=>p.id===a.selectedDistrictId)??a.districts[0],l=e?ya.find(p=>p.id===e):void 0,c=t.isYearProcessing(),u=t.getDataLoadStatus(),h=t.getDataLoadError(),d=t.isDataTutorialOpen();i.innerHTML=`
      <section class="top-hud" aria-label="城市狀態">
        ...
        <div class="metric-strip">
          ...
          ${Si("健康",a.publicHealth,"",Ba(a.publicHealth))}
        </div>
      </section>
      ...
      ${D0(a)}
      ${I0(a,o)}
      ${U0(a,t.isAudioEnabled(),c)}
      ${c?N0(a):""}
      ${a.mission.status==="briefing"?O0(a,u,h):""}
      ${d?B0(a,u,h):""}
      ${a.mission.status==="won"||a.mission.status==="lost"?q0(a):""}
      ${r?F0(a):""}
      ${l?Y0(a,l):""}
      ${n==="mission"?K0(a):""}
      ${n==="challenge"?j0(a):""}
      ${n==="district"?Z0(a,o):""}
      ${n==="resolution"?J0(a.lastResolution):""}
    `};return{render:s}}function L0(i){const t=i.mission,e=Jc(i),n=Sa(i),r=t.objectives.filter(s=>s.passed).length;return`
    <section class="mission-chip mission-panel-open">
      ...
      <div class="mission-objectives">
        ${t.objectives.map(e_).join("")}
      </div>
    </section>
  `}function D0(i){return`
  ...
  `}function U0(i,t,e){const n=i.mission.status==="active"&&i.phase!=="complete"&&!e;return`
    <section class="command-bar" aria-label="主要行動">
      <div>
        <span>政策審議</span>
        <strong>本回合還可確認 ${hs(i)} 項政策</strong>
      </div>
  ...
  `}function F0(i){return`
    <section class="modal-scrim policy-board-scrim">
      <article class="policy-board-panel">
        ...
        <span>政策審議桌</span>
        <h1>先閱讀，再確認投資</h1>
        <p>預算以百萬計算。每回合最多確認 ${i.mission.policyLimitPerTurn} 項政策，目前還可確認 ${hs(i)} 項。</p>
        <div class="policy-row">
          ${ya.map(t=>Q0(t,i)).join("")}
        </div>
      </article>
    </section>
  `}function O0(i,t,e){const n=i.mission,r=t==="loading",s=t==="ready",a=t==="error";return`
  ...
  `}function B0(i,t,e){const n=H0(i);return`
    <section class="modal-scrim data-scrim">
      <article class="guide-card data-briefing-card">
        ...
        ${t==="error"?`<div class="data-status-error">資料載入失敗：${$0(e??"未知錯誤")}</div>`:""}
        ...
        <section class="data-section">
          ...
          <div class="data-signal-grid">
            ${n.map(r=>`
                  <article class="data-signal-card" data-signal="${r.key}">
                    <span>${r.label}</span>
                    <strong>${r.value}</strong>
                    <p>${r.meaning}</p>
                    <small>${r.gameLink}</small>
                  </article>
                `).join("")}
          </div>
        </section>
  ...
  `}function z0(){return[...R0.map(t=>{const e=k0(t.name);return{name:t.name,url:t.url,pulledData:e.pulledData,studentNote:e.studentNote}}),{name:"台北本地基準補值",url:"/data/taipei-climate-baseline.json",pulledData:"作為教室離線或 API 缺項時的台北基準補值，避免單一資料源失效讓課程中斷。",studentNote:"不是玩家可切換的假資料；它用來補足缺漏欄位，讓同一套任務仍能討論資料不確定性。"}].map(t=>`
      ...
      `).join("")}function ir(i,t=1){return Number.isFinite(i)?i.toFixed(t):"資料缺漏"}function V0(i,t=1){return Number.isFinite(i)?`${i>0?"+":""}${i.toFixed(t)}`:"資料缺漏"}function W0(i){return Number.isFinite(i)?`${Math.round(i*100)}%`:"資料缺漏"}function X0(i){return Number.isFinite(i)?Math.round(i).toLocaleString("zh-TW"):"資料缺漏"}function $0(i){return i.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function q0(i){const t=i.mission.status==="won",e=i.mission;return`
    <section class="modal-scrim">
      <div class="briefing-card ending ${t?"won":"lost"}">
        ...
        <p>${e.debriefBody??""}</p>
        <div class="briefing-objectives">
          ${e.objectives.map(t_).join("")}
        </div>
        <button class="primary-btn large" type="button" data-reset-mission>重製任務</button>
      </div>
    </section>
  `}function Y0(i,t){const e=Ea(i,t.id),n=i_(i,t),r=!n&&(e==null?void 0:e.affordable);return`
    <section class="modal-scrim policy-scrim">
      <article class="policy-detail-card ${t.category}">
        ...
        <span class="policy-kicker">${Uc(t.sdgs)}</span>
        <h1>${t.name}</h1>
        <p class="policy-lead">${t.summary}</p>
        <div class="policy-detail-meta">
          <div><span>花費</span><strong>${ls(t.cost)}</strong></div>
        ...
        <div class="policy-confirm-row">
          <p>${n??`確認後會花費 ${ls(t.cost)}，本回合政策額度會減少 1。`}</p>
  ...
  `}function K0(i){const t=i.mission;return`
    <section class="modal-scrim">
  ...
  `}function j0(i){const t=i.currentChallenge;return`
    <section class="modal-scrim">
      <article class="guide-card">
        ...
        <div class="delta-board">
          ${Object.entries(t.pressure).map(([e,n])=>Me(r_(e),n,s_(e))).join("")}
        </div>
      </article>
    </section>
  `}function Z0(i,t){return`
    <section class="modal-scrim">
      <article class="guide-card district-guide-card">
        ...
        <div class="district-tabs expanded">
          ${i.districts.map(e=>n_(e,i.selectedDistrictId)).join("")}
        </div>
      </article>
    </section>
  `}function J0(i){return i?`
    <section class="modal-scrim">
      <article class="guide-card">
  ...
  `}function Q0(i,t){const e=Ea(t,i.id),n=!(e!=null&&e.affordable);return`
    <button class="policy-card ${i.category} ${n?"locked":""}" type="button" data-policy="${i.id}">
      <span class="policy-cost">${ls(i.cost)}</span>
      <strong>${i.name}</strong>
      <small>${Uc(i.sdgs)}</small>
      <p>${i.summary}</p>
  ...
  `}function Ei(i,t,e){return`
    <div class="district-stat ${e?Ba(t):cr(t)}">
      <span>${i}</span>
      <strong>${Math.round(t)}</strong>
    </div>
  `}function bi(i,t,e){return`
    <span class="mini-stat ${e?Ba(t):cr(t)}">
      ${i}<b>${Math.round(t)}</b>
    </span>
  ...
  `}function Oa(i){return`${Number.isInteger(i.current)?String(i.current):i.current.toFixed(1)}${i.unit??""}`}function ls(i){return`${Math.round(i)} 百萬`}function Uc(i){const t={"SDG 3":"健康福祉","SDG 6":"潔淨水","SDG 7":"可負擔能源","SDG 9":"產業創新","SDG 10":"減少不平等","SDG 11":"永續城市","SDG 12":"責任消費","SDG 13":"氣候行動","SDG 15":"陸域生態"};return i.map(e=>`${e} ${t[e]??""}`.trim()).join(" / ")}function Me(i,t,e){const n=Math.round(t*10)/10,r=e?n<0:n>0,s=e?n>0:n<0,a=r?"good":s?"danger":"neutral",o=n>0?"+":"";return`
    <span class="delta-chip ${a}">
      ${i} ${o}${n}
    </span>
  `}function i_(i,t){const e=Ea(i,t.id);if(i.mission.status==="briefing")return"請先開始任務，再確認政策投資。";if(i.phase==="complete")return"任務已結束，請使用重製任務重新開始。";if(!(e!=null&&e.canAffordBudget))return`預算不足：目前剩餘 ${ls(i.budget)}。`;if(((e==null?void 0:e.remainingActions)??0)<=0)return"本回合政策額度已用完，請進入下一年。"}function r_(i){return{emissions:"排放",heatRisk:"熱風險",floodRisk:"洪水風險",airQualityRisk:"空氣風險",publicHealth:"公共健康",equity:"公平性",publicTrust:"公共信任",biodiversity:"生物多樣性",energySecurity:"能源安全",educationScore:"教育分數"}[i]??i}function s_(i){return i==="emissions"||i==="heatRisk"||i==="floodRisk"||i==="airQualityRisk"}function a_(i){return i==="mission"||i==="challenge"||i==="district"||i==="resolution"}function cr(i){return i>=72?"danger":i>=54?"warn":"good"}function Ba(i){return i>=68?"good":i>=50?"warn":"danger"}const o_={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1},Nc=document.querySelector("#game-canvas"),Fc=document.querySelector("#hud-root");if(!Nc||!Fc)throw new Error("Missing game canvas or HUD root.");let me=Gi(Bl()),Ue=!1,wi=!1,jn="idle",cs,Pn=!1;const l_=6500,ye=Wc(),za=A0(Nc,me,{onSelectDistrict:i=>Oc(i)}),Ii=P0(Fc,{getState:()=>me,onStartMission:()=>{if(jn!=="ready"){Ol();return}Pn=!1;const i=_u(me);h_(i.currentChallenge.soundCue),ye.startAmbience(i.currentChallenge.soundCue),ye.playEvent(i.currentChallenge.soundCue),gn(i)},onApplyPolicy:i=>{if(wi)return;const t=me.appliedPolicies.length,e=vu(me,i);Ue&&e.appliedPolicies.length>t?ye.playPolicy():Ue&&ye.playSelect(),gn(e)},onAdvanceYear:()=>{if(wi)return;const i=me,t=xu(i);if(t===i||i.mission.status!=="active"){gn(t);return}wi=!0,za.playYearTransition(i),d_(i),Ii.render(),window.setTimeout(()=>{wi=!1,Ue&&t.lastResolution&&ye.startAmbience(t.currentChallenge.soundCue),Ue&&i.mission.status!==t.mission.status&&(t.mission.status==="won"&&ye.playSuccess(),t.mission.status==="lost"&&ye.playFailure()),gn(t)},l_)},onSelectDistrict:i=>Oc(i),onResetMission:()=>c_(),isAudioEnabled:()=>Ue,isYearProcessing:()=>wi,onToggleAudio:()=>u_(),onLoadLiveData:()=>{Ue&&ye.playSelect(),Ol()},getDataLoadStatus:()=>jn,getDataLoadError:()=>cs,isDataTutorialOpen:()=>Pn,onOpenDataTutorial:()=>{Pn=!0,Ii.render()},onCloseDataTutorial:()=>{Pn=!1,Ii.render()}});Ii.render();za.start();async function Ol(){if(jn!=="loading"){jn="loading",cs=void 0,Pn=!1,gn({...me,eventLog:["正在載入 Open-Meteo / NASA POWER / World Bank / OpenAQ 公開資料，並整理成任務起始數據。",...me.eventLog].slice(0,10)});try{const i=await hu(me,{useNetwork:!0,openAqApiKey:f_("VITE_OPENAQ_API_KEY")});jn="ready",Pn=!0,gn({...yu(me,i),eventLog:["公開資料已載入，請先閱讀資料科普再開始任務。",...me.eventLog].slice(0,10)})}catch(i){jn="error",cs=String(i),Pn=!1,gn({...me,eventLog:[`公開資料載入失敗，請稍後重試。原因：${String(i)}`,...me.eventLog].slice(0,10)})}}}function Oc(i){var t;Ue&&ye.playSelect(),gn({...me,selectedDistrictId:i,eventLog:[`已選擇 ${((t=me.districts.find(e=>e.id===i))==null?void 0:t.name)??i}。`,...me.eventLog].slice(0,10)})}function c_(){wi=!1,jn="idle",cs=void 0,Pn=!1;const i=Gi(Bl());Ue&&(ye.startAmbience(i.currentChallenge.soundCue),ye.playEvent("civic")),gn(i)}function u_(){Ue=!Ue,ye.setMuted(!Ue),Ue&&(ye.startAmbience(me.currentChallenge.soundCue),ye.playEvent("civic")),Ii.render()}function h_(i){Ue=!0,ye.setMuted(!1),ye.startAmbience(i)}function gn(i){me=i,za.update(me),Ii.render()}function d_(i){if(!Ue)return;const t=i.appliedPolicies.filter(n=>n.turn===i.turn).slice().reverse();t.forEach((n,r)=>{window.setTimeout(()=>ye.playPolicy(),260+r*720)});const e=Math.max(1200,680+t.length*720);window.setTimeout(()=>ye.playEvent(i.currentChallenge.soundCue),e)}function f_(i){return o_[i]}
