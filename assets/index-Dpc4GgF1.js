...
void main() {
      ...
      `}),e=new Vt(new dr(23,8,96,28),t);return e.rotation.x=-Math.PI/2,e.position.set(0,-.08,7.4),e.receiveShadow=!0,this.root.add(e),t}createDistrict(t,e){const[n,r]=Yg[t.id]??[e*4,0],s=new He;s.position.set(n,0,r),s.userData.districtId=t.id;const a=new Ie({color:wl(t),roughness:.78,metalness:.08,emissive:397332,emissiveIntensity:.08}),o=new Vt(new Pe(5.2,.28,5.2),a);if(o.castShadow=!0,o.receiveShadow=!0,o.userData.districtId=t.id,s.add(o),this.pickables.push(o),t.archetype==="upland"){const m=this.createHillsideTerrain(e);m.userData.districtId=t.id,s.add(m)}const l=new Ie({color:6000291,roughness:.53,metalness:.18,emissive:1457224,emissiveIntensity:.08}),c=this.createBuildingCluster(t,l,e);if(c.userData.districtId=t.id,s.add(c),this.pickables.push(c),t.id==="core"){const m=this.createTaipeiLandmark(l);m.userData.districtId=t.id,s.add(m),this.pickables.push(m)}const u=this.createWindowCluster(t,e);u.mesh.userData.districtId=t.id,s.add(u.mesh);const h=this.createStreetGrid(t,e);h.lines.userData.districtId=t.id,s.add(h.lines);const d=this.createCanopyCluster(t,e);d.userData.districtId=t.id,s.add(d);const p=new Vt(new Aa(3,48),new Yn({color:3653112,transparent:!0,opacity:.2,depthWrite:!1}));p.rotation.x=-Math.PI/2,p.position.y=.17,p.visible=!1,p.userData.districtId=t.id,s.add(p);const _=new Vt(new wi(3.2,36,18),new Yn({color:16743229,transparent:!0,opacity:.08,depthWrite:!1,blending:Je}));_.scale.y=.28,_.position.y=1.4,_.visible=!1,_.userData.districtId=t.id,s.add(_);const v=new Ki(new ie().setAttribute("position",new Zt([-2.72,.24,-2.72,2.72,.24,-2.72,2.72,.24,-2.72,2.72,.24,2.72,2.72,.24,2.72,-2.72,.24,2.72,-2.72,.24,2.72,-2.72,.24,-2.72],3)),new bi({color:9437138,transparent:!0,opacity:.92}));return v.visible=!1,s.add(v),{root:s,base:o,buildingMaterial:l,windowMaterial:u.material,streetMaterial:h.material,waterOverlay:p,heatDome:_,selectedOutline:v}}createHillsideTerrain(t){const e=new He,n=18,r=5.2,s=[],a=[];for(let h=0;h<=n;h+=1)for(let d=0;d<=n;d+=1){const p=-r/2+d/n*r,_=-r/2+h/n*r,v=fa(p,_,t);s.push(p,v,_)}for(let h=0;h<n;h+=1)for(let d=0;d<n;d+=1){const p=h*(n+1)+d,_=p+1,v=p+n+1,m=v+1;a.push(p,v,_,_,v,m)}const o=new ie;o.setAttribute("position",new Zt(s,3)),o.setIndex(a),o.computeVertexNormals();const l=new Vt(o,new Ie({color:4164952,roughness:.9,metalness:.02,emissive:729876,emissiveIntensity:.06}));l.receiveShadow=!0,l.castShadow=!0,e.add(l);const c=[];for(let h=0;h<5;h+=1){const d=-2.05+h*.72,p=.4+h*.22;c.push(-2.15,p,d,2.15,p+.05,d+.12)}const u=new Ki(new ie().setAttribute("position",new Zt(c,3)),new bi({color:12050592,transparent:!0,opacity:.46}));return u.renderOrder=3,e.add(u),e}createTaipeiLandmark(t){const e=new He,n=t.clone();n.color.setHex(7317664),n.emissive.setHex(2052429),n.emissiveIntensity=.16;for(let a=0;a<7;a+=1){const o=.92-a*.055,l=new Vt(new Pe(o,.7,o),n);l.position.set(-.7,2.1+a*.72,-.4),l.castShadow=!0,l.receiveShadow=!0,e.add(l)}const r=new Vt(new Pe(1.1,1.2,1.1),n);r.position.set(-.7,.82,-.4),r.castShadow=!0,r.receiveShadow=!0,e.add(r);const s=new Vt(new ir(.18,1.4,8),new Ie({color:13107187,emissive:7340008,emissiveIntensity:.28,roughness:.36,metalness:.34}));return s.position.set(-.7,7.8,-.4),s.castShadow=!0,e.add(s),e}createBuildingCluster(t,e,n){const r=da(t),s=new $s(new Pe(1,1,1),e,r);s.castShadow=!0,s.receiveShadow=!0;const a=new ue;for(let o=0;o<r;o+=1){const l=Cl(t,n,o);a.position.set(l.x,l.baseY+l.height/2,l.z),a.scale.set(l.scaleX,l.height,l.scaleZ),a.rotation.y=l.rotationY,a.updateMatrix(),s.setMatrixAt(o,a.matrix)}return s.instanceMatrix.needsUpdate=!0,s}createWindowCluster(t,e){const n=da(t),r=t.archetype==="downtown"?12:t.archetype==="industrial"?4:6,s=new Yn({color:16770984,transparent:!0,opacity:.42,depthWrite:!1,blending:Je}),a=new $s(new Pe(.12,.085,.014),s,n*r*2);a.frustumCulled=!1;const o=new ue;let l=0;for(let c=0;c<n;c+=1){const u=Cl(t,e,c),h=Math.max(1,Math.min(r,Math.round(u.height*1.25)));for(let d=0;d<h;d+=1){const p=u.baseY+.2+u.height*(d+1)/(h+1),_=(Kt(e*211+c*17+d)-.5)*.22;o.position.set(u.x+_,p,u.z+u.scaleZ*.51),o.rotation.set(0,u.rotationY,0),o.scale.setScalar(t.archetype==="industrial"?1.25:1),o.updateMatrix(),a.setMatrixAt(l,o.matrix),l+=1,o.position.set(u.x+u.scaleX*.51,p,u.z+_),o.rotation.set(0,u.rotationY+Math.PI/2,0),o.scale.setScalar(t.archetype==="industrial"?1.25:1),o.updateMatrix(),a.setMatrixAt(l,o.matrix),l+=1}}return a.count=l,a.instanceMatrix.needsUpdate=!0,{mesh:a,material:s}}createStreetGrid(t,e){const n=[],r=t.archetype==="downtown"?5:t.archetype==="upland"?3:4,s=2.5,a=.205;for(let u=0;u<r;u+=1){const h=u/(r-1),d=-s+h*s*2+(Kt(e*81+u)-.5)*.16;n.push(-s,a,d,s,a,d),n.push(d,a,-s,d,a,s)}n.push(-s,a,-s,s,a,-s),n.push(s,a,-s,s,a,s),n.push(s,a,s,-s,a,s),n.push(-s,a,s,-s,a,-s);const o=new ie;o.setAttribute("position",new Zt(n,3));const l=new bi({color:8775895,transparent:!0,opacity:.42,depthWrite:!1}),c=new Ki(o,l);return c.renderOrder=3,{lines:c,material:l}}createCanopyCluster(t,e){const n=Math.max(4,Math.round(t.canopyCover*46)),r=new Ie({color:5752709,roughness:.72,metalness:.03,emissive:732440,emissiveIntensity:.04}),s=new $s(new ir(.25,.72,7),r,n);s.castShadow=!0,s.receiveShadow=!0;const a=new ue;for(let o=0;o<n;o+=1){const l=Kt(e*99+o)*Math.PI*2,c=1.2+Kt(e*11+o)*1.5,u=Math.cos(l)*c,h=Math.sin(l)*c,d=t.archetype==="upland"?fa(u,h,e)+.5:.62;a.position.set(u,d,h),a.scale.setScalar(.72+Kt(e*42+o)*.5),a.rotation.y=l,a.updateMatrix(),s.setMatrixAt(o,a.matrix)}return s.instanceMatrix.needsUpdate=!0,s}createAtmosphere(){const e=new Float32Array(2700);for(let s=0;s<900;s+=1)e[s*3]=(Math.random()-.5)*24,e[s*3+1]=.8+Math.random()*4.2,e[s*3+2]=(Math.random()-.5)*20;const n=new ie;n.setAttribute("position",new Le(e,3));const r=new tr({color:13934939,size:.035,transparent:!0,opacity:.12,depthWrite:!1,blending:Je});return{points:new Vr(n,r),material:r}}createEventParticles(){const e=new Float32Array(2280);for(let a=0;a<760;a+=1)na(e,a,this.currentCue);const n=new ie;n.setAttribute("position",new Le(e,3));const r=new tr({color:9437138,size:.04,transparent:!0,opacity:.22,depthWrite:!1,blending:Je}),s=new Vr(n,r);return s.frustumCulled=!1,s.renderOrder=4,{points:s,material:r,positions:e}}animateEventParticles(t){const e=this.eventParticlePositions,n=e.length/3,r=this.currentCue;for(let a=0;a<n;a+=1){const o=a*3,l=Math.sin(t*.6+a*.37)*.006;r==="rain"?(e[o]+=l,e[o+1]-=.052+Kt(a*19)*.034,e[o+2]+=.01,e[o+1]<.08&&na(e,a,r,6.8)):r==="heat"?(e[o]+=l*.8,e[o+1]+=.012+Kt(a*13)*.012,e[o+2]+=Math.sin(t*.9+a)*.003,e[o+1]>5.8&&na(e,a,r,.32)):r==="air"?(e[o]+=.012+Kt(a*7)*.012,e[o+1]+=Math.sin(t+a)*.002,e[o+2]+=l,e[o]>12&&(e[o]=-12,e[o+1]=.9+Math.random()*3.6,e[o+2]=(Math.random()-.5)*18)):r==="energy"?(e[o]+=Math.sin(t*2.4+a)*.006,e[o+1]+=Math.sin(t*3.2+a*.25)*.004,e[o+2]+=Math.cos(t*2.1+a)*.006):(e[o]+=l*.55,e[o+1]+=Math.sin(t*.72+a)*.002)}const s=this.eventParticles.geometry.getAttribute("position");s.needsUpdate=!0,this.eventParticles.rotation.y=Math.sin(t*.09)*.045}createPolicyFx(){const t=new He;t.visible=!1;const e=260,n=new Float32Array(e*3);for(let c=0;c<e;c+=1)Zi(n,c,"governance");const r=new ie;r.setAttribute("position",new Le(n,3));const s=new tr({color:9437138,size:.06,transparent:!0,opacity:0,depthWrite:!1,blending:Je}),a=new Vr(r,s);a.frustumCulled=!1,t.add(a);const o=new Ki(new ie().setAttribute("position",new Zt([-1.9,.25,-1.4,-1.9,2.4,-1.4,-1.9,2.4,-1.4,.9,2.4,-1.4,.9,2.4,-1.4,1.35,1.85,-1.4,-1.9,.95,-1.4,.9,2.4,-1.4,-1.9,1.62,-1.4,-.45,.25,-1.4,1.4,.25,1.35,1.4,1.55,1.35,.6,1.55,1.35,2,1.55,1.35,.6,1.55,1.35,1.4,.25,1.35,2,1.55,1.35,1.4,.25,1.35],3)),new bi({color:16766815,transparent:!0,opacity:0}));o.renderOrder=5,t.add(o);const l=this.createPolicyWorkers();return t.add(l),{fx:{group:t,points:a,material:s,positions:n},scaffold:o,workers:l}}createPolicyWorkers(){const t=new He,e=new Ie({color:16766815,roughness:.62,metalness:.08,emissive:3809544,emissiveIntensity:.14}),n=new Ie({color:16773258,roughness:.46,metalness:.1,emissive:4863238,emissiveIntensity:.16});for(let l=0;l<10;l+=1){const c=new He,u=new Vt(new or(.055,.07,.22,8),e),h=new Vt(new wi(.07,10,8),n);u.position.y=.13,h.position.y=.3,c.add(u,h);const d=l/10*Math.PI*2,p=.9+Kt(l*31)*1.45;c.position.set(Math.cos(d)*p,.16,Math.sin(d)*p),c.rotation.y=-d,c.userData.phase=Kt(l*19)*Math.PI*2,t.add(c)}const r=new Ie({color:16758861,roughness:.54,metalness:.16,emissive:3808261,emissiveIntensity:.12}),s=new He,a=new Vt(new Pe(.42,.18,.22),r),o=new Vt(new Pe(.2,.22,.22),r);return a.position.set(0,.16,0),o.position.set(.29,.19,0),s.add(a,o),s.position.set(-1.75,.18,1.55),s.userData.phase=0,t.add(s),t}createHazardFx(){const t=new He;t.visible=!1;const e=420,n=new Float32Array(e*3);for(let o=0;o<e;o+=1)Ji(n,o,"civic");const r=new ie;r.setAttribute("position",new Le(n,3));const s=new tr({color:16747082,size:.075,transparent:!0,opacity:0,depthWrite:!1,blending:Je}),a=new Vr(r,s);return a.frustumCulled=!1,a.renderOrder=6,t.add(a),{group:t,points:a,material:s,positions:n}}triggerPolicyFx(t,e){var l;const n=ma(t.policyId),r=(n==null?void 0:n.category)??"governance",s=t.targetDistrictId??e.selectedDistrictId,a=((l=this.districtVisuals.get(s))==null?void 0:l.root.position)??new C(0,0,-1.2),o=Qg(r);this.activePolicyCategory=r,this.policyFx.group.visible=!0,this.policyFx.group.position.set(a.x,.12,a.z),this.policyFx.group.scale.setScalar((n==null?void 0:n.target)==="city"?1.55:1),this.policyFx.material.color.setHex(o),this.policyScaffold.material.color.setHex(r==="energy"?16773258:16766815),this.policyFxStart=this.elapsedSeconds;for(let c=0;c<this.policyFx.positions.length/3;c+=1)Zi(this.policyFx.positions,c,r);this.policyFx.points.geometry.getAttribute("position").needsUpdate=!0}triggerHazardFx(t){this.activeHazardCue=t,this.hazardFx.group.visible=!0,this.hazardFx.group.position.copy(t0(t)),this.hazardFx.material.color.setHex(Rl(t).particle),this.hazardFx.material.size=t==="rain"?.055:t==="air"?.085:.075,this.hazardFxStart=this.elapsedSeconds;for(let e=0;e<this.hazardFx.positions.length/3;e+=1)Ji(this.hazardFx.positions,e,t);this.hazardFx.points.geometry.getAttribute("position").needsUpdate=!0}animatePolicyFx(t){const e=t-this.policyFxStart;if(e<0||e>2.9){this.policyFx.group.visible=!1,this.policyFx.material.opacity=0,this.policyScaffold.material.opacity=0,this.policyWorkers.visible=!1;return}const n=te(e/2.9,0,1),r=Math.sin(n*Math.PI),s=this.activePolicyCategory,a=this.policyFx.positions;this.policyFx.material.opacity=.62*r,this.policyScaffold.material.opacity=.86*r,this.policyScaffold.rotation.y=Math.sin(t*3.2)*.06,this.policyWorkers.visible=r>.04,this.policyWorkers.children.forEach((o,l)=>{const c=typeof o.userData.phase=="number"?o.userData.phase:0;o.position.y=.16+Math.abs(Math.sin(t*7.5+c))*.08,o.rotation.y+=l===this.policyWorkers.children.length-1?.018:Math.sin(t*4+c)*.012});for(let o=0;o<a.length/3;o+=1){const l=o*3;s==="flood"?(a[l]+=Math.sin(t*3+o)*.007,a[l+1]=.18+Math.sin(t*5+o)*.025,a[l+2]+=.025,a[l+2]>2.7&&Zi(a,o,s)):s==="energy"?(a[l+1]+=.028+Kt(o*11)*.02,a[l]+=Math.sin(t*6+o)*.012,a[l+1]>4.6&&Zi(a,o,s)):(a[l+1]+=.018+Kt(o*13)*.014,a[l]+=Math.sin(t*2.5+o)*.008,a[l+2]+=Math.cos(t*2.1+o)*.008,a[l+1]>3.5&&Zi(a,o,s))}this.policyFx.points.geometry.getAttribute("position").needsUpdate=!0}animateHazardFx(t){const e=t-this.hazardFxStart;if(e<0||e>3.2){this.hazardFx.group.visible=!1,this.hazardFx.material.opacity=0;return}const n=te(e/3.2,0,1),r=Math.sin(n*Math.PI),s=this.activeHazardCue,a=this.hazardFx.positions;this.hazardFx.material.opacity=(s==="air"?.58:.72)*r;for(let o=0;o<a.length/3;o+=1){const l=o*3;s==="rain"?(a[l]+=Math.sin(t*1.7+o)*.01,a[l+1]-=.095+Kt(o*5)*.05,a[l+2]+=.026,a[l+1]<.1&&Ji(a,o,s)):s==="heat"?(a[l+1]+=.035+Kt(o*7)*.026,a[l]+=Math.sin(t*5+o)*.012,a[l+1]>5.8&&Ji(a,o,s)):s==="air"?(a[l]+=.034+Kt(o*17)*.02,a[l+1]+=Math.sin(t*1.4+o)*.004,a[l]>7.2&&Ji(a,o,s)):s==="energy"?(a[l+1]+=Math.sin(t*8+o)*.02,a[l]+=Math.sin(t*12+o)*.018,a[l+2]+=Math.cos(t*10+o)*.018):(a[l+1]+=.018,a[l]+=Math.sin(t*3+o)*.01)}this.hazardFx.points.geometry.getAttribute("position").needsUpdate=!0}createEventFx(){const t=new Vg(16757087,.8,24,1.7);t.position.set(0,7.5,1.2);const e=new Vt(new wi(8.2,48,24),new Yn({color:16757087,transparent:!0,opacity:.08,depthWrite:!1,blending:Je,side:Ae}));return e.position.set(0,2.4,-.8),e.scale.y=.46,{light:t,halo:e}}}function wl(i){return i.archetype==="downtown"?5467495:i.archetype==="industrial"?5857625:i.archetype==="residential"?6197097:i.archetype==="upland"?4684356:i.archetype==="river"?5603203:6651759}function da(i){return i.archetype==="downtown"?42:i.archetype==="industrial"?14:i.archetype==="residential"?20:i.archetype==="upland"?7:i.archetype==="river"?18:20}function Cl(i,t,e){const n=da(i),r=i.archetype==="downtown"?7:i.archetype==="industrial"?4:i.archetype==="upland"?3:5,s=Math.ceil(n/r),a=i.archetype==="industrial"?1.28:i.archetype==="upland"?1.35:.86,o=e%r,l=Math.floor(e/r),c=(Kt(t*41+e*3)-.5)*(i.archetype==="downtown"?.14:.24),u=(Kt(t*61+e*7)-.5)*(i.archetype==="upland"?.38:.18),h=-((r-1)*a)/2+o*a+c,d=-((s-1)*a)/2+l*a+u,p=jg(i,e),_=(Kt(t*70+e)-.5)*(i.archetype==="residential"?.34:.16),v=i.archetype==="upland"?fa(h,d,t)+.08:.18;return i.archetype==="industrial"?{x:h,z:d,baseY:v,height:p,scaleX:1.12+Kt(t*17+e)*.58,scaleZ:.74+Kt(t*23+e)*.62,rotationY:_}:i.archetype==="residential"?{x:h,z:d,baseY:v,height:p,scaleX:.92+Kt(t*13+e)*.2,scaleZ:.54+Kt(t*29+e)*.22,rotationY:_}:i.archetype==="upland"?{x:h,z:d,baseY:v,height:p,scaleX:.55+Kt(t*19+e)*.18,scaleZ:.5+Kt(t*31+e)*.18,rotationY:_}:{x:h,z:d,baseY:v,height:p,scaleX:i.archetype==="downtown"?.68+Kt(t*13+e)*.2:.72,scaleZ:i.archetype==="downtown"?.68+Kt(t*17+e)*.2:.68,rotationY:_}}function jg(i,t){const e=i.imperviousness,n=Kt((t+1)*17);return i.archetype==="downtown"?te(2.3+e*4.1+n*4.4,2.2,9.4):i.archetype==="industrial"?te(.7+e*.85+n*.9,.85,2.3):i.archetype==="residential"?te(.95+e*1.1+n*1.1,1,3.1):i.archetype==="upland"?te(.42+e*.55+n*.45,.45,1.15):i.archetype==="river"?te(.9+e*1.7+n*1.4,.9,4):te(1+e*1.8+n*1.6,1,4.4)}function fa(i,t,e=0){const n=Math.max(0,(t+2.6)/5.2),r=Math.sin((i+e)*1.7)*.12+Math.cos((t-e)*1.3)*.1;return .12+n*1.25+r}function Kt(i){const t=Math.sin(i*12.9898)*43758.5453;return t-Math.floor(t)}function Zg(i,t,e){const n=te(e,0,1),r=new St(i);return r.lerp(new St(t),n),r.getHex()}function Rl(i){return i==="heat"?{background:4860449,fog:10968888,fogDensity:.024,skyTop:12087107,skyBottom:3692125,skyAccent:16747082,waterGlow:3520980,particle:16747082,street:16760938,windowGlow:16765066}:i==="rain"?{background:1521739,fog:3632518,fogDensity:.032,skyTop:4946064,skyBottom:1521739,skyAccent:6018815,waterGlow:6543615,particle:8119039,street:7526911,windowGlow:13235455}:i==="air"?{background:5065010,fog:10783570,fogDensity:.039,skyTop:10324834,skyBottom:3753787,skyAccent:13938779,waterGlow:5220020,particle:13938779,street:13090936,windowGlow:16768906}:i==="energy"?{background:3815204,fog:9141053,fogDensity:.024,skyTop:9073984,skyBottom:2506564,skyAccent:16769146,waterGlow:6806472,particle:16769146,street:16771480,windowGlow:16773286}:{background:1522501,fog:4094063,fogDensity:.025,skyTop:7316389,skyBottom:1522501,skyAccent:9764816,waterGlow:6018815,particle:9764816,street:9437138,windowGlow:14548969}}function Jg(i){return i==="rain"?{size:.033,opacity:.4}:i==="heat"?{size:.052,opacity:.34}:i==="air"?{size:.058,opacity:.27}:i==="energy"?{size:.045,opacity:.42}:{size:.038,opacity:.22}}function Qg(i){return i==="cooling"||i==="biodiversity"?8191886:i==="flood"?6871551:i==="energy"?16770689:i==="mobility"?8251391:i==="health"?16752560:i==="industry"?12177872:12429055}function t0(i){return i==="rain"?new C(1.8,.2,3.6):i==="heat"?new C(0,.25,-1.2):i==="air"?new C(-4.2,.45,4):i==="energy"?new C(0,2.2,-1.2):new C(0,.6,-1.2)}function e0(i){return i?`${i.year}:${i.turn}:${i.policyId}:${i.targetDistrictId??"city"}`:""}function n0(i){return i.lastResolution?`${i.lastResolution.year}:${i.lastResolution.title}:${i.lastResolution.soundCue}`:""}function Zi(i,t,e){const n=t*3,r=Math.random()*Math.PI*2,s=Math.sqrt(Math.random())*(e==="governance"?3.6:2.35);i[n]=Math.cos(r)*s,i[n+2]=Math.sin(r)*s,e==="flood"?i[n+1]=.12+Math.random()*.28:e==="energy"?i[n+1]=1.2+Math.random()*1.8:i[n+1]=.18+Math.random()*.7}function Ji(i,t,e){const n=t*3;if(e==="rain"){i[n]=(Math.random()-.5)*10,i[n+1]=2.4+Math.random()*5.2,i[n+2]=(Math.random()-.5)*6;return}if(e==="heat"){i[n]=(Math.random()-.5)*6.2,i[n+1]=.25+Math.random()*1.2,i[n+2]=(Math.random()-.5)*4.8;return}if(e==="air"){i[n]=-5.8+Math.random()*1.2,i[n+1]=.9+Math.random()*3.4,i[n+2]=(Math.random()-.5)*5.4;return}if(e==="energy"){const r=Math.random()*Math.PI*2,s=1.2+Math.random()*3.2;i[n]=Math.cos(r)*s,i[n+1]=.8+Math.random()*4.6,i[n+2]=Math.sin(r)*s;return}i[n]=(Math.random()-.5)*7.5,i[n+1]=.5+Math.random()*3,i[n+2]=(Math.random()-.5)*6}function na(i,t,e,n){const r=t*3;i[r]=(Math.random()-.5)*22,i[r+1]=n??(e==="rain"?3.2+Math.random()*4.2:.45+Math.random()*4.8),i[r+2]=(Math.random()-.5)*18}function i0(){const i=document.createElement("canvas");i.width=512,i.height=512;const t=i.getContext("2d");if(!t)return new ml(i);const e=t.createLinearGradient(0,0,512,512);e.addColorStop(0,"#173034"),e.addColorStop(.52,"#10282d"),e.addColorStop(1,"#0b1d23"),t.fillStyle=e,t.fillRect(0,0,512,512),t.globalAlpha=.18,t.strokeStyle="#7be2d4",t.lineWidth=3;for(let r=42;r<512;r+=74)t.beginPath(),t.moveTo(r,0),t.lineTo(r+36,512),t.stroke(),t.beginPath(),t.moveTo(0,r),t.lineTo(512,r+18),t.stroke();t.globalAlpha=.12,t.strokeStyle="#f5d57a",t.lineWidth=1;for(let r=18;r<512;r+=38)t.beginPath(),t.moveTo(r,0),t.lineTo(r,512),t.stroke();t.globalAlpha=.08,t.fillStyle="#d7fff2";for(let r=0;r<320;r+=1){const s=Kt(r*23)*512,a=Kt(r*41)*512;t.fillRect(s,a,1.2,1.2)}const n=new ml(i);return n.colorSpace=We,n.wrapS=sr,n.wrapT=sr,n.repeat.set(2,2),n.anisotropy=4,n}const bc={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Oi.BlurDirectionX=new it(1,0);Oi.BlurDirectionY=new it(0,1);function f0(i,t,e){const n=new l0(i);n.addPass(new h0(t,e));const r=new Oi(new it(window.innerWidth,window.innerHeight),.52,.72,.68);n.addPass(r);const s=new Tc({uniforms:{tDiffuse:{value:null},uContrast:{value:1.08},uSaturation:{value:1.12},uVignette:{value:.24}},vertexShader:`
      varying vec2 vUv;
    ...
    `});return n.addPass(s),n.addPass(new u0),n}function p0(){const i=new ls(-12,12,8,-8,.1,200);return i.position.set(15,16,15),i.lookAt(0,.4,-.8),Ac(i,window.innerWidth,window.innerHeight),i}function Ac(i,t,e){const n=t/Math.max(1,e),r=t<760?23:t<1100?21:17.4,s=r*n;i.left=-s/2,i.right=s/2,i.top=r/2,i.bottom=-r/2,i.updateProjectionMatrix()}function m0(i){const t=new Mg({canvas:i,antialias:!0,powerPreference:"high-performance"});return t.setPixelRatio(Math.min(window.devicePixelRatio,1.75)),t.setSize(window.innerWidth,window.innerHeight,!1),t.outputColorSpace=We,t.toneMapping=Ma,t.toneMappingExposure=1.06,t.shadowMap.enabled=!0,t.shadowMap.type=zl,t}function g0(){const i=new yg;i.background=new St(594459),i.fog=new us(662824,.027);const t=new Hg(11459839,2502943,1.35);i.add(t);const e=new ta(16773580,3.55);e.position.set(-7,12,8),e.castShadow=!0,e.shadow.mapSize.set(2048,2048),e.shadow.camera.left=-18,e.shadow.camera.right=18,e.shadow.camera.top=18,e.shadow.camera.bottom=-18,e.shadow.bias=-15e-5,e.shadow.normalBias=.04,i.add(e);const n=new ta(7060991,.8);n.position.set(9,5,-8),i.add(n);const r=new ta(9437138,1.15);return r.position.set(4,9,-12),i.add(r),i}function _0(i,t,e){const n=m0(i),r=g0(),s=p0(),a=f0(n,r,s),o=v0(s,i),l=new Kg(r,t),c=new Xg,u=new it,h=new Ec;let d=0,p=!1;const _=()=>x0(n,a,s);window.addEventListener("resize",_);const v=f=>{var U;const T=i.getBoundingClientRect();u.x=(f.clientX-T.left)/T.width*2-1,u.y=-((f.clientY-T.top)/T.height)*2+1,c.setFromCamera(u,s);const S=c.intersectObjects(l.pickables,!0),b=l.findDistrictId(((U=S[0])==null?void 0:U.object)??null);b&&e.onSelectDistrict(b)};i.addEventListener("pointerdown",v);const m=()=>{if(p)return;const f=h.getElapsedTime();l.tick(f),o.update(),a.render(),d=window.requestAnimationFrame(m)};return{update:f=>l.updateFromState(f),playYearTransition:f=>l.playYearTransition(f),start:()=>{_(),m()},dispose:()=>{p=!0,window.cancelAnimationFrame(d),window.removeEventListener("resize",_),i.removeEventListener("pointerdown",v),o.dispose(),n.dispose()}}}function v0(i,t){const e=new $g(i,t);return e.enableDamping=!0,e.dampingFactor=.08,e.minZoom=.62,e.maxZoom=1.65,e.minPolarAngle=Math.PI*.22,e.maxPolarAngle=Math.PI*.38,e.enableRotate=!0,e.enablePan=!0,e.target.set(0,.4,-1),e}function x0(i,t,e){const n=window.innerWidth,r=window.innerHeight;i.setPixelRatio(Math.min(window.devicePixelRatio,1.75)),i.setSize(n,r,!1),t.setSize(n,r),Ac(e,n,r)}function M0(i,t){i.className="hud-root";let e,n,r=!1;i.addEventListener("click",a=>{const o=a.target,l=o.closest("[data-policy]"),c=o.closest("[data-district]"),u=o.closest("[data-open-guide]"),h=o.closest("[data-confirm-policy]");if(o.closest("[data-open-policy-board]")){r=!0,s();return}if(o.closest("[data-close-policy-board]")){r=!1,s();return}if(o.closest("[data-close-policy]")){e=void 0,s();return}if(o.closest("[data-close-guide]")){n=void 0,s();return}if(o.closest("[data-reset-mission]")){e=void 0,n=void 0,r=!1,t.onResetMission();return}if(o.closest("[data-start-mission]")){t.onStartMission();return}if(h!=null&&h.dataset.confirmPolicy){e=void 0,t.onApplyPolicy(h.dataset.confirmPolicy);return}if(l!=null&&l.dataset.policy){e=l.dataset.policy,s();return}if(H0(u==null?void 0:u.dataset.openGuide)){n=u.dataset.openGuide,s();return}if(c!=null&&c.dataset.district){t.onSelectDistrict(c.dataset.district);return}if(o.closest("[data-advance]")){t.onAdvanceYear();return}if(o.closest("[data-toggle-audio]")){t.onToggleAudio();return}o.closest("[data-live-data]")&&t.onLoadLiveData()});const s=()=>{const a=t.getState(),o=a.districts.find(u=>u.id===a.selectedDistrictId)??a.districts[0],l=e?pa.find(u=>u.id===e):void 0,c=t.isYearProcessing();i.innerHTML=`
      <section class="top-hud" aria-label="城市狀態">
        ...
        <div class="metric-strip">
          ...
          ${Mi("熱風險",a.heatRisk,"",rr(a.heatRisk))}
          ${Mi("洪水",a.floodRisk,"",rr(a.floodRisk))}
          ${Mi("空氣",a.airQualityRisk,"",rr(a.airQualityRisk))}
      ...
      ${S0(a)}
      ${E0(a,o)}
      ${b0(a,t.isAudioEnabled(),c)}
      ${c?T0(a):""}
      ${a.mission.status==="briefing"?w0(a):""}
      ${a.mission.status==="won"||a.mission.status==="lost"?C0(a):""}
      ${r?A0(a):""}
      ${l?R0(a,l):""}
      ${n==="mission"?P0(a):""}
      ${n==="challenge"?L0(a):""}
      ${n==="district"?D0(a,o):""}
      ${n==="resolution"?I0(a.lastResolution):""}
    `};return{render:s}}function y0(i){const t=i.mission,e=Xc(i),n=ga(i),r=t.objectives.filter(s=>s.passed).length;return`
    <section class="mission-chip mission-panel-open">
      ...
      <div class="mission-objectives">
        ${t.objectives.map(F0).join("")}
      </div>
    </section>
  `}function S0(i){return`
  ...
  `}function b0(i,t,e){const n=i.mission.status==="active"&&i.phase!=="complete"&&!e;return`
    ...
    <section class="modal-scrim policy-board-scrim">
      <article class="policy-board-panel">
        ...
        <div class="policy-row">
          ${pa.map(t=>U0(t,i)).join("")}
        </div>
      </article>
    </section>
  `}function w0(i){const t=i.mission;return`
  ...
  `}function C0(i){const t=i.mission.status==="won",e=i.mission;return`
    <section class="modal-scrim">
      <div class="briefing-card ending ${t?"won":"lost"}">
        ...
        <p>${e.debriefBody??""}</p>
        <div class="briefing-objectives">
          ${e.objectives.map(N0).join("")}
        </div>
        <button class="primary-btn large" type="button" data-reset-mission>重製任務</button>
      </div>
    </section>
  `}function R0(i,t){const e=_a(i,t.id),n=B0(i,t),r=!n&&(e==null?void 0:e.affordable);return`
  ...
  `}function P0(i){const t=i.mission;return`
    <section class="modal-scrim">
  ...
  `}function L0(i){const t=i.currentChallenge;return`
    <section class="modal-scrim">
      <article class="guide-card">
        ...
        <div class="delta-board">
          ${Object.entries(t.pressure).map(([e,n])=>ye(z0(e),n,k0(e))).join("")}
        </div>
      </article>
    </section>
  `}function D0(i,t){return`
    <section class="modal-scrim">
      <article class="guide-card district-guide-card">
        ...
        <div class="district-tabs expanded">
          ${i.districts.map(e=>O0(e,i.selectedDistrictId)).join("")}
        </div>
      </article>
    </section>
  `}function I0(i){return i?`
    <section class="modal-scrim">
      <article class="guide-card">
  ...
  `}function U0(i,t){const e=_a(t,i.id),n=!(e!=null&&e.affordable);return`
  ...
  `}function yi(i,t,e){return`
    <div class="district-stat ${e?La(t):rr(t)}">
      <span>${i}</span>
      <strong>${Math.round(t)}</strong>
    </div>
  `}function Si(i,t,e){return`
    <span class="mini-stat ${e?La(t):rr(t)}">
      ${i}<b>${Math.round(t)}</b>
    </span>
  `}function O0(i,t){return`
    <button
      type="button"
  ...
  `}function B0(i,t){const e=_a(i,t.id);if(i.mission.status==="briefing")return"請先開始任務，再確認政策投資。";if(i.phase==="complete")return"任務已結束，請使用重製任務重新開始。";if(!(e!=null&&e.canAffordBudget))return`預算不足：目前剩餘 ${rs(i.budget)}。`;if(((e==null?void 0:e.remainingActions)??0)<=0)return"本回合政策額度已用完，請進入下一年。"}function z0(i){return{emissions:"排放",heatRisk:"熱風險",floodRisk:"洪水風險",airQualityRisk:"空氣風險",publicHealth:"公共健康",equity:"公平性",publicTrust:"公共信任",biodiversity:"生物多樣性",energySecurity:"能源安全",educationScore:"教育分數"}[i]??i}function k0(i){return i==="emissions"||i==="heatRisk"||i==="floodRisk"||i==="airQualityRisk"}function H0(i){return i==="mission"||i==="challenge"||i==="district"||i==="resolution"}function rr(i){return i>=72?"danger":i>=54?"warn":"good"}function La(i){return i>=68?"good":i>=50?"warn":"danger"}const G0={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1},Cc=document.querySelector("#game-canvas"),Rc=document.querySelector("#hud-root");if(!Cc||!Rc)throw new Error("Missing game canvas or HUD root.");let Me=Bi(Ll()),Ue=!1,Ti=!1;const V0=3600,xe=Oc(),Da=_0(Cc,Me,{onSelectDistrict:i=>Pc(i)}),hs=M0(Rc,{getState:()=>Me,onStartMission:()=>{const i=cu(Me);$0(i.currentChallenge.soundCue),xe.startAmbience(i.currentChallenge.soundCue),xe.playEvent(i.currentChallenge.soundCue),mn(i)},onApplyPolicy:i=>{if(Ti)return;const t=Me.appliedPolicies.length,e=uu(Me,i);Ue&&e.appliedPolicies.length>t?xe.playPolicy():Ue&&xe.playSelect(),mn(e)},onAdvanceYear:()=>{if(Ti)return;const i=Me,t=hu(i);if(t===i||i.mission.status!=="active"){mn(t);return}Ti=!0,Da.playYearTransition(i),Y0(i),hs.render(),window.setTimeout(()=>{Ti=!1,Ue&&t.lastResolution&&xe.startAmbience(t.currentChallenge.soundCue),Ue&&i.mission.status!==t.mission.status&&(t.mission.status==="won"&&xe.playSuccess(),t.mission.status==="lost"&&xe.playFailure()),mn(t)},V0)},onSelectDistrict:i=>Pc(i),onResetMission:()=>X0(),isAudioEnabled:()=>Ue,isYearProcessing:()=>Ti,onToggleAudio:()=>q0(),onLoadLiveData:()=>{Ue&&xe.playSelect(),W0()}});hs.render();Da.start();async function W0(){mn({...Me,eventLog:["正在載入 Open-Meteo / NASA POWER / World Bank / OpenAQ 真實資料。",...Me.eventLog].slice(0,10)});try{const i=await iu(Me,{useNetwork:!0,openAqApiKey:K0("VITE_OPENAQ_API_KEY")});mn(du(Me,i))}catch(i){mn({...Me,eventLog:[`真實資料載入失敗，暫時使用內建基準資料。原因：${String(i)}`,...Me.eventLog].slice(0,10)})}}function Pc(i){var t;Ue&&xe.playSelect(),mn({...Me,selectedDistrictId:i,eventLog:[`已選擇 ${((t=Me.districts.find(e=>e.id===i))==null?void 0:t.name)??i}。`,...Me.eventLog].slice(0,10)})}function X0(){Ti=!1;const i=Bi(Ll());Ue&&(xe.startAmbience(i.currentChallenge.soundCue),xe.playEvent("civic")),mn(i)}function q0(){Ue=!Ue,xe.setMuted(!Ue),Ue&&(xe.startAmbience(Me.currentChallenge.soundCue),xe.playEvent("civic")),hs.render()}function $0(i){Ue=!0,xe.setMuted(!1),xe.startAmbience(i)}function mn(i){Me=i,Da.update(Me),hs.render()}function Y0(i){if(!Ue)return;const t=i.appliedPolicies.filter(n=>n.turn===i.turn).slice().reverse();t.forEach((n,r)=>{window.setTimeout(()=>xe.playPolicy(),260+r*720)});const e=Math.max(1200,680+t.length*720);window.setTimeout(()=>xe.playEvent(i.currentChallenge.soundCue),e)}function K0(i){return G0[i]}
