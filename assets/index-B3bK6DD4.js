...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:_n,depthTest:!1,depthWrite:!1})}function Xo(){return new Ee({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ta(),fragmentShader:`
		...
		`,blending:_n,depthTest:!1,depthWrite:!1})}function qo(){return new Ee({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ta(),fragmentShader:`
	...
	`}function Cp(i){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===aa||l===oa,u=l===Li||l===Di;if(c||u){let h=t.get(o);const d=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return e===null&&(e=new Vo(i)),h=c?e.fromEquirectangular(o,h):e.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,t.set(o,h),h.texture;if(h!==void 0)return h.texture;{const p=o.image;return c&&p&&p.height>0||u&&p&&r(p)?(e===null&&(e=new Vo(i)),h=c?e.fromEquirectangular(o):e.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,t.set(o,h),o.addEventListener("dispose",s),h.texture):null}}}return o}function r(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function Rp(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return t[n]=r,r}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const r=e(n);return r===null&&rc("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function Pp(i,t,e,n){const r={},s=new WeakMap;function a(h){const d=h.target;d.index!==null&&t.remove(d.index);for(const _ in d.attributes)t.remove(d.attributes[_]);for(const _ in d.morphAttributes){const v=d.morphAttributes[_];for(let m=0,f=v.length;m<f;m++)t.remove(v[m])}d.removeEventListener("dispose",a),delete r[d.id];const p=s.get(d);p&&(t.remove(p),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function o(h,d){return r[d.id]===!0||(d.addEventListener("dispose",a),r[d.id]=!0,e.memory.geometries++),d}function l(h){const d=h.attributes;for(const _ in d)t.update(d[_],i.ARRAY_BUFFER);const p=h.morphAttributes;for(const _ in p){const v=p[_];for(let m=0,f=v.length;m<f;m++)t.update(v[m],i.ARRAY_BUFFER)}}function c(h){const d=[],p=h.index,_=h.attributes.position;let v=0;if(p!==null){const T=p.array;v=p.version;for(let S=0,b=T.length;S<b;S+=3){const U=T[S+0],R=T[S+1],w=T[S+2];d.push(U,R,R,w,w,U)}}else if(_!==void 0){const T=_.array;v=_.version;for(let S=0,b=T.length/3-1;S<b;S+=3){const U=S+0,R=S+1,w=S+2;d.push(U,R,R,w,w,U)}}else return;const m=new(ic(d)?cc:lc)(d,1);m.version=v;const f=s.get(h);f&&t.remove(f),s.set(h,m)}function u(h){const d=s.get(h);if(d){const p=h.index;p!==null&&d.version<p.version&&c(h)}else c(h);return s.get(h)}return{get:o,update:l,getWireframeAttribute:u}}function Lp(i,t,e){let n;function r(d){n=d}let s,a;function o(d){s=d.type,a=d.bytesPerElement}function l(d,p){i.drawElements(n,p,s,d*a),e.update(p,n,1)}function c(d,p,_){_!==0&&(i.drawElementsInstanced(n,p,s,d*a,_),e.update(p,n,_))}function u(d,p,_){if(_===0)return;const v=t.get("WEBGL_multi_draw");if(v===null)for(let m=0;m<_;m++)this.render(d[m]/a,p[m]);else{v.multiDrawElementsWEBGL(n,p,0,s,d,0,_);let m=0;for(let f=0;f<_;f++)m+=p[f];e.update(m,n,1)}}function h(d,p,_,v){if(_===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<d.length;f++)c(d[f]/a,p[f],v[f]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,s,d,0,v,0,_);let f=0;for(let T=0;T<_;T++)f+=p[T];for(let T=0;T<v.length;T++)e.update(f,n,v[T])}}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function Dp(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(e.calls++,a){case i.TRIANGLES:e.triangles+=o*(s/3);break;case i.LINES:e.lines+=o*(s/2);break;case i.LINE_STRIP:e.lines+=o*(s-1);break;case i.LINE_LOOP:e.lines+=o*s;break;case i.POINTS:e.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:n}}function Ip(i,t,e){const n=new WeakMap,r=new re;function s(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=u!==void 0?u.length:0;let d=n.get(o);if(d===void 0||d.count!==h){let y=function(){I.dispose(),n.delete(o),o.removeEventListener("dispose",y)};var p=y;d!==void 0&&d.texture.dispose();const _=o.morphAttributes.position!==void 0,v=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,f=o.morphAttributes.position||[],T=o.morphAttributes.normal||[],S=o.morphAttributes.color||[];let b=0;_===!0&&(b=1),v===!0&&(b=2),m===!0&&(b=3);let U=o.attributes.position.count*b,R=1;U>t.maxTextureSize&&(R=Math.ceil(U/t.maxTextureSize),U=t.maxTextureSize);const w=new Float32Array(U*R*4*h),I=new ac(w,U,R,h);I.type=pn,I.needsUpdate=!0;const E=b*4;for(let P=0;P<h;P++){const H=f[P],B=T[P],q=S[P],Y=U*R*4*P;for(let W=0;W<H.count;W++){const K=W*E;_===!0&&(r.fromBufferAttribute(H,W),w[Y+K+0]=r.x,w[Y+K+1]=r.y,w[Y+K+2]=r.z,w[Y+K+3]=0),v===!0&&(r.fromBufferAttribute(B,W),w[Y+K+4]=r.x,w[Y+K+5]=r.y,w[Y+K+6]=r.z,w[Y+K+7]=0),m===!0&&(r.fromBufferAttribute(q,W),w[Y+K+8]=r.x,w[Y+K+9]=r.y,w[Y+K+10]=r.z,w[Y+K+11]=q.itemSize===4?r.w:1)}}d={count:h,texture:I,size:new it(U,R)},n.set(o,d),o.addEventListener("dispose",y)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,e);else{let _=0;for(let m=0;m<c.length;m++)_+=c[m];const v=o.morphTargetsRelative?1:1-_;l.getUniforms().setValue(i,"morphTargetBaseInfluence",v),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,e),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:s}}function Up(i,t,e,n){let r=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,h=t.get(l,u);if(r.get(h)!==c&&(t.update(h),r.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),r.get(l)!==c&&(e.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;r.get(d)!==c&&(d.update(),r.set(d,c))}return h}function a(){r=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:a}}class pc extends we{constructor(t,e,n,r,s,a,o,l,c,u=Ri){if(u!==Ri&&u!==Ni)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Ri&&(n=Ii),n===void 0&&u===Ni&&(n=Ui),super(null,r,s,a,o,l,u,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=o!==void 0?o:Ne,this.minFilter=l!==void 0?l:Ne,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const mc=new we,gc=new pc(1,1);gc.compareFunction=nc;const _c=new ac,vc=new Mh,xc=new dc,$o=[],Yo=[],Ko=new Float32Array(16),jo=new Float32Array(9),Zo=new Float32Array(4);function ki(i,t,e){const n=i[0];if(n<=0||n>0)return i;const r=t*e;let s=$o[r];if(s===void 0&&(s=new Float32Array(r),$o[r]=s),t!==0){n.toArray(s,0);for(let a=1,o=0;a!==t;++a)o+=e,i[a].toArray(s,o)}return s}function me(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function ge(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function cs(i,t){let e=Yo[t];e===void 0&&(e=new Int32Array(t),Yo[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function Np(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function Fp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(me(e,t))return;i.uniform2fv(this.addr,t),ge(e,t)}}function Op(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(me(e,t))return;i.uniform3fv(this.addr,t),ge(e,t)}}function Bp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(me(e,t))return;i.uniform4fv(this.addr,t),ge(e,t)}}function zp(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(me(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),ge(e,t)}else{if(me(e,n))return;Zo.set(n),i.uniformMatrix2fv(this.addr,!1,Zo),ge(e,n)}}function kp(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(me(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),ge(e,t)}else{if(me(e,n))return;jo.set(n),i.uniformMatrix3fv(this.addr,!1,jo),ge(e,n)}}function Hp(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(me(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),ge(e,t)}else{if(me(e,n))return;Ko.set(n),i.uniformMatrix4fv(this.addr,!1,Ko),ge(e,n)}}function Gp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function Vp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(me(e,t))return;i.uniform2iv(this.addr,t),ge(e,t)}}function Wp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(me(e,t))return;i.uniform3iv(this.addr,t),ge(e,t)}}function Xp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(me(e,t))return;i.uniform4iv(this.addr,t),ge(e,t)}}function qp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function $p(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(me(e,t))return;i.uniform2uiv(this.addr,t),ge(e,t)}}function Yp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(me(e,t))return;i.uniform3uiv(this.addr,t),ge(e,t)}}function Kp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(me(e,t))return;i.uniform4uiv(this.addr,t),ge(e,t)}}function jp(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);const s=this.type===i.SAMPLER_2D_SHADOW?gc:mc;e.setTexture2D(t||s,r)}function Zp(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture3D(t||vc,r)}function Jp(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTextureCube(t||xc,r)}function Qp(i,t,e){const n=this.cache,r=e.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),e.setTexture2DArray(t||_c,r)}function tm(i){switch(i){case 5126:return Np;case 35664:return Fp;case 35665:return Op;case 35666:return Bp;case 35674:return zp;case 35675:return kp;case 35676:return Hp;case 5124:case 35670:return Gp;case 35667:case 35671:return Vp;case 35668:case 35672:return Wp;case 35669:case 35673:return Xp;case 5125:return qp;case 36294:return $p;case 36295:return Yp;case 36296:return Kp;case 35678:case 36198:case 36298:case 36306:case 35682:return jp;case 35679:case 36299:case 36307:return Zp;case 35680:case 36300:case 36308:case 36293:return Jp;case 36289:case 36303:case 36311:case 36292:return Qp}}function em(i,t){i.uniform1fv(this.addr,t)}function nm(i,t){const e=ki(t,this.size,2);i.uniform2fv(this.addr,e)}function im(i,t){const e=ki(t,this.size,3);i.uniform3fv(this.addr,e)}function rm(i,t){const e=ki(t,this.size,4);i.uniform4fv(this.addr,e)}function sm(i,t){const e=ki(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function am(i,t){const e=ki(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function om(i,t){const e=ki(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function lm(i,t){i.uniform1iv(this.addr,t)}function cm(i,t){i.uniform2iv(this.addr,t)}function um(i,t){i.uniform3iv(this.addr,t)}function hm(i,t){i.uniform4iv(this.addr,t)}function dm(i,t){i.uniform1uiv(this.addr,t)}function fm(i,t){i.uniform2uiv(this.addr,t)}function pm(i,t){i.uniform3uiv(this.addr,t)}function mm(i,t){i.uniform4uiv(this.addr,t)}function gm(i,t,e){const n=this.cache,r=t.length,s=cs(e,r);me(n,s)||(i.uniform1iv(this.addr,s),ge(n,s));for(let a=0;a!==r;++a)e.setTexture2D(t[a]||mc,s[a])}function _m(i,t,e){const n=this.cache,r=t.length,s=cs(e,r);me(n,s)||(i.uniform1iv(this.addr,s),ge(n,s));for(let a=0;a!==r;++a)e.setTexture3D(t[a]||vc,s[a])}function vm(i,t,e){const n=this.cache,r=t.length,s=cs(e,r);me(n,s)||(i.uniform1iv(this.addr,s),ge(n,s));for(let a=0;a!==r;++a)e.setTextureCube(t[a]||xc,s[a])}function xm(i,t,e){const n=this.cache,r=t.length,s=cs(e,r);me(n,s)||(i.uniform1iv(this.addr,s),ge(n,s));for(let a=0;a!==r;++a)e.setTexture2DArray(t[a]||_c,s[a])}function Mm(i){switch(i){case 5126:return em;case 35664:return nm;case 35665:return im;case 35666:return rm;case 35674:return sm;case 35675:return am;case 35676:return om;case 5124:case 35670:return lm;case 35667:case 35671:return cm;case 35668:case 35672:return um;case 35669:case 35673:return hm;case 5125:return dm;case 36294:return fm;case 36295:return pm;case 36296:return mm;case 35678:case 36198:case 36298:case 36306:case 35682:return gm;case 35679:case 36299:case 36307:return _m;case 35680:case 36300:case 36308:case 36293:return vm;case 36289:case 36303:case 36311:case 36292:return xm}}class ym{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=tm(e.type)}}class Sm{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=Mm(e.type)}}class Em{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(t,e[o.id],n)}}}const Xs=/(\w+)(\])?(\[|\.)?/g;function Jo(i,t){i.seq.push(t),i.map[t.id]=t}function bm(i,t,e){const n=i.name,r=n.length;for(Xs.lastIndex=0;;){const s=Xs.exec(n),a=Xs.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){Jo(e,c===void 0?new ym(o,i,t):new Sm(o,i,t));break}else{let h=e.map[o];h===void 0&&(h=new Em(o),Jo(e,h)),e=h}}}class $r{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=t.getActiveUniform(e,r),a=t.getUniformLocation(e,s.name);bm(s,a,this)}}setValue(t,e,n,r){const s=this.map[e];s!==void 0&&s.setValue(t,n,r)}setOptional(t,e,n){const r=e[n];r!==void 0&&this.setValue(t,n,r)}static upload(t,e,n,r){for(let s=0,a=e.length;s!==a;++s){const o=e[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(t,l.value,r)}}static seqWithValue(t,e){const n=[];for(let r=0,s=t.length;r!==s;++r){const a=t[r];a.id in e&&n.push(a)}return n}}function Qo(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const Tm=37297;let Am=0;function wm(i,t){const e=i.split(`
`),n=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}function Cm(i){const t=Yt.getPrimaries(Yt.workingColorSpace),e=Yt.getPrimaries(i);let n;switch(t===e?n="":t===Qr&&e===Jr?n="LinearDisplayP3ToLinearSRGB":t===Jr&&e===Qr&&(n="LinearSRGBToLinearDisplayP3"),i){case Un:case os:return[n,"LinearTransferOETF"];case We:case Sa:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function tl(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),r=i.getShaderInfoLog(t).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return e.toUpperCase()+`

`+r+`

`+wm(i.getShaderSource(t),a)}else return r}function Rm(i,t){const e=Cm(t);return`vec4 ${i}( vec4 value ) { return ${e[0]}( ${e[1]}( value ) ); }`}function Pm(i,t){let e;switch(t){case Gl:e="Linear";break;case Vl:e="Reinhard";break;case Wl:e="OptimizedCineon";break;case ya:e="ACESFilmic";break;case Xl:e="AgX";break;case ql:e="Neutral";break;case Wu:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function Lm(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(tr).join(`
`)}function Dm(i){const t=[];for(const e in i){const n=i[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function Im(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(t,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),e[a]={type:s.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function tr(i){return i!==""}function el(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function nl(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Um=/^[ \t]*#include +<([\w\d./]+)>/gm;function ua(i){return i.replace(Um,Fm)}const Nm=new Map;function Fm(i,t){let e=Dt[t];if(e===void 0){const n=Nm.get(t);if(n!==void 0)e=Dt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return ua(e)}const Om=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function il(i){return i.replace(Om,Bm)}function Bm(i,t,e,n){let r="";for(let s=parseInt(t);s<parseInt(e);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function rl(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function zm(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===zl?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===kl?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===dn&&(t="SHADOWMAP_TYPE_VSM"),t}function km(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Li:case Di:t="ENVMAP_TYPE_CUBE";break;case as:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Hm(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Di:t="ENVMAP_MODE_REFRACTION";break}return t}function Gm(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Hl:t="ENVMAP_BLENDING_MULTIPLY";break;case Gu:t="ENVMAP_BLENDING_MIX";break;case Vu:t="ENVMAP_BLENDING_ADD";break}return t}function Vm(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Wm(i,t,e,n){const r=i.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=zm(e),c=km(e),u=Hm(e),h=Gm(e),d=Vm(e),p=Lm(e),_=Dm(s),v=r.createProgram();let m,f,T=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}),e=new Vt(new Oi(23,8,96,28),t);return e.rotation.x=-Math.PI/2,e.position.set(0,-.08,7.4),e.receiveShadow=!0,this.root.add(e),t}createDistrict(t,e){const[n,r]=Kg[t.id]??[e*4,0],s=new He;s.position.set(n,0,r),s.userData.districtId=t.id;const a=new Ie({color:Rl(t),roughness:.78,metalness:.08,emissive:397332,emissiveIntensity:.08}),o=new Vt(new Pe(5.2,.28,5.2),a);if(o.castShadow=!0,o.receiveShadow=!0,o.userData.districtId=t.id,s.add(o),this.pickables.push(o),t.archetype==="upland"){const m=this.createHillsideTerrain(e);m.userData.districtId=t.id,s.add(m)}const l=new Ie({color:6000291,roughness:.53,metalness:.18,emissive:1457224,emissiveIntensity:.08}),c=this.createBuildingCluster(t,l,e);if(c.userData.districtId=t.id,s.add(c),this.pickables.push(c),t.id==="core"){const m=this.createTaipeiLandmark(l);m.userData.districtId=t.id,s.add(m),this.pickables.push(m)}const u=this.createWindowCluster(t,e);u.mesh.userData.districtId=t.id,s.add(u.mesh);const h=this.createStreetGrid(t,e);h.lines.userData.districtId=t.id,s.add(h.lines);const d=this.createCanopyCluster(t,e);d.userData.districtId=t.id,s.add(d);const p=new Vt(new wa(3,48),new fn({color:3653112,transparent:!0,opacity:.2,depthWrite:!1}));p.rotation.x=-Math.PI/2,p.position.y=.17,p.visible=!1,p.userData.districtId=t.id,s.add(p);const _=new Vt(new wi(3.2,36,18),new fn({color:16743229,transparent:!0,opacity:.08,depthWrite:!1,blending:Ke}));_.scale.y=.28,_.position.y=1.4,_.visible=!1,_.userData.districtId=t.id,s.add(_);const v=new ji(new ie().setAttribute("position",new Wt([-2.72,.24,-2.72,2.72,.24,-2.72,2.72,.24,-2.72,2.72,.24,2.72,2.72,.24,2.72,-2.72,.24,2.72,-2.72,.24,2.72,-2.72,.24,-2.72],3)),new bi({color:9437138,transparent:!0,opacity:.92}));return v.visible=!1,s.add(v),{root:s,base:o,buildingMaterial:l,windowMaterial:u.material,streetMaterial:h.material,waterOverlay:p,heatDome:_,selectedOutline:v}}createHillsideTerrain(t){const e=new He,n=18,r=5.2,s=[],a=[];for(let h=0;h<=n;h+=1)for(let d=0;d<=n;d+=1){const p=-r/2+d/n*r,_=-r/2+h/n*r,v=pa(p,_,t);s.push(p,v,_)}for(let h=0;h<n;h+=1)for(let d=0;d<n;d+=1){const p=h*(n+1)+d,_=p+1,v=p+n+1,m=v+1;a.push(p,v,_,_,v,m)}const o=new ie;o.setAttribute("position",new Wt(s,3)),o.setIndex(a),o.computeVertexNormals();const l=new Vt(o,new Ie({color:4164952,roughness:.9,metalness:.02,emissive:729876,emissiveIntensity:.06}));l.receiveShadow=!0,l.castShadow=!0,e.add(l);const c=[];for(let h=0;h<5;h+=1){const d=-2.05+h*.72,p=.4+h*.22;c.push(-2.15,p,d,2.15,p+.05,d+.12)}const u=new ji(new ie().setAttribute("position",new Wt(c,3)),new bi({color:12050592,transparent:!0,opacity:.46}));return u.renderOrder=3,e.add(u),e}createTaipeiLandmark(t){const e=new He,n=t.clone();n.color.setHex(7317664),n.emissive.setHex(2052429),n.emissiveIntensity=.16;for(let a=0;a<7;a+=1){const o=.92-a*.055,l=new Vt(new Pe(o,.7,o),n);l.position.set(-.7,2.1+a*.72,-.4),l.castShadow=!0,l.receiveShadow=!0,e.add(l)}const r=new Vt(new Pe(1.1,1.2,1.1),n);r.position.set(-.7,.82,-.4),r.castShadow=!0,r.receiveShadow=!0,e.add(r);const s=new Vt(new rr(.18,1.4,8),new Ie({color:13107187,emissive:7340008,emissiveIntensity:.28,roughness:.36,metalness:.34}));return s.position.set(-.7,7.8,-.4),s.castShadow=!0,e.add(s),e}createBuildingCluster(t,e,n){const r=fa(t),s=new $s(new Pe(1,1,1),e,r);s.castShadow=!0,s.receiveShadow=!0;const a=new ue;for(let o=0;o<r;o+=1){const l=Pl(t,n,o);a.position.set(l.x,l.baseY+l.height/2,l.z),a.scale.set(l.scaleX,l.height,l.scaleZ),a.rotation.y=l.rotationY,a.updateMatrix(),s.setMatrixAt(o,a.matrix)}return s.instanceMatrix.needsUpdate=!0,s}createWindowCluster(t,e){const n=fa(t),r=t.archetype==="downtown"?12:t.archetype==="industrial"?4:6,s=new fn({color:16770984,transparent:!0,opacity:.42,depthWrite:!1,blending:Ke}),a=new $s(new Pe(.12,.085,.014),s,n*r*2);a.frustumCulled=!1;const o=new ue;let l=0;for(let c=0;c<n;c+=1){const u=Pl(t,e,c),h=Math.max(1,Math.min(r,Math.round(u.height*1.25)));for(let d=0;d<h;d+=1){const p=u.baseY+.2+u.height*(d+1)/(h+1),_=(jt(e*211+c*17+d)-.5)*.22;o.position.set(u.x+_,p,u.z+u.scaleZ*.51),o.rotation.set(0,u.rotationY,0),o.scale.setScalar(t.archetype==="industrial"?1.25:1),o.updateMatrix(),a.setMatrixAt(l,o.matrix),l+=1,o.position.set(u.x+u.scaleX*.51,p,u.z+_),o.rotation.set(0,u.rotationY+Math.PI/2,0),o.scale.setScalar(t.archetype==="industrial"?1.25:1),o.updateMatrix(),a.setMatrixAt(l,o.matrix),l+=1}}return a.count=l,a.instanceMatrix.needsUpdate=!0,{mesh:a,material:s}}createStreetGrid(t,e){const n=[],r=t.archetype==="downtown"?5:t.archetype==="upland"?3:4,s=2.5,a=.205;for(let u=0;u<r;u+=1){const h=u/(r-1),d=-s+h*s*2+(jt(e*81+u)-.5)*.16;n.push(-s,a,d,s,a,d),n.push(d,a,-s,d,a,s)}n.push(-s,a,-s,s,a,-s),n.push(s,a,-s,s,a,s),n.push(s,a,s,-s,a,s),n.push(-s,a,s,-s,a,-s);const o=new ie;o.setAttribute("position",new Wt(n,3));const l=new bi({color:8775895,transparent:!0,opacity:.42,depthWrite:!1}),c=new ji(o,l);return c.renderOrder=3,{lines:c,material:l}}createCanopyCluster(t,e){const n=Math.max(4,Math.round(t.canopyCover*46)),r=new Ie({color:5752709,roughness:.72,metalness:.03,emissive:732440,emissiveIntensity:.04}),s=new $s(new rr(.25,.72,7),r,n);s.castShadow=!0,s.receiveShadow=!0;const a=new ue;for(let o=0;o<n;o+=1){const l=jt(e*99+o)*Math.PI*2,c=1.2+jt(e*11+o)*1.5,u=Math.cos(l)*c,h=Math.sin(l)*c,d=t.archetype==="upland"?pa(u,h,e)+.5:.62;a.position.set(u,d,h),a.scale.setScalar(.72+jt(e*42+o)*.5),a.rotation.y=l,a.updateMatrix(),s.setMatrixAt(o,a.matrix)}return s.instanceMatrix.needsUpdate=!0,s}createAtmosphere(){const e=new Float32Array(2700);for(let s=0;s<900;s+=1)e[s*3]=(Math.random()-.5)*24,e[s*3+1]=.8+Math.random()*4.2,e[s*3+2]=(Math.random()-.5)*20;const n=new ie;n.setAttribute("position",new Le(e,3));const r=new er({color:13934939,size:.035,transparent:!0,opacity:.12,depthWrite:!1,blending:Ke});return{points:new Vr(n,r),material:r}}createEventParticles(){const e=new Float32Array(2280);for(let a=0;a<760;a+=1)ia(e,a,this.currentCue);const n=new ie;n.setAttribute("position",new Le(e,3));const r=new er({color:9437138,size:.04,transparent:!0,opacity:.22,depthWrite:!1,blending:Ke}),s=new Vr(n,r);return s.frustumCulled=!1,s.renderOrder=4,{points:s,material:r,positions:e}}animateEventParticles(t){const e=this.eventParticlePositions,n=e.length/3,r=this.currentCue;for(let a=0;a<n;a+=1){const o=a*3,l=Math.sin(t*.6+a*.37)*.006;r==="rain"?(e[o]+=l,e[o+1]-=.052+jt(a*19)*.034,e[o+2]+=.01,e[o+1]<.08&&ia(e,a,r,6.8)):r==="heat"?(e[o]+=l*.8,e[o+1]+=.012+jt(a*13)*.012,e[o+2]+=Math.sin(t*.9+a)*.003,e[o+1]>5.8&&ia(e,a,r,.32)):r==="air"?(e[o]+=.012+jt(a*7)*.012,e[o+1]+=Math.sin(t+a)*.002,e[o+2]+=l,e[o]>12&&(e[o]=-12,e[o+1]=.9+Math.random()*3.6,e[o+2]=(Math.random()-.5)*18)):r==="energy"?(e[o]+=Math.sin(t*2.4+a)*.006,e[o+1]+=Math.sin(t*3.2+a*.25)*.004,e[o+2]+=Math.cos(t*2.1+a)*.006):(e[o]+=l*.55,e[o+1]+=Math.sin(t*.72+a)*.002)}const s=this.eventParticles.geometry.getAttribute("position");s.needsUpdate=!0,this.eventParticles.rotation.y=Math.sin(t*.09)*.045}createPolicyFx(){const t=new He;t.visible=!1;const e=260,n=new Float32Array(e*3);for(let u=0;u<e;u+=1)Ji(n,u,"governance");const r=new ie;r.setAttribute("position",new Le(n,3));const s=new er({color:9437138,size:.06,transparent:!0,opacity:0,depthWrite:!1,blending:Ke}),a=new Vr(r,s);a.frustumCulled=!1,t.add(a);const o=new ji(new ie().setAttribute("position",new Wt([-1.9,.25,-1.4,-1.9,2.4,-1.4,-1.9,2.4,-1.4,.9,2.4,-1.4,.9,2.4,-1.4,1.35,1.85,-1.4,-1.9,.95,-1.4,.9,2.4,-1.4,-1.9,1.62,-1.4,-.45,.25,-1.4,1.4,.25,1.35,1.4,1.55,1.35,.6,1.55,1.35,2,1.55,1.35,.6,1.55,1.35,1.4,.25,1.35,2,1.55,1.35,1.4,.25,1.35],3)),new bi({color:16766815,transparent:!0,opacity:0}));o.renderOrder=5,t.add(o);const l=new Vt(new Oi(3,2.15),new fn({color:16766815,transparent:!0,opacity:0,depthWrite:!1,side:je}));l.rotation.x=-Math.PI/2,l.position.y=.08,l.renderOrder=4,t.add(l);const c=this.createPolicyWorkers();return t.add(c),{fx:{group:t,points:a,material:s,positions:n},scaffold:o,workers:c,workPad:l}}createPolicyWorkers(){const t=new He,e=new Ie({color:16766815,roughness:.62,metalness:.08,emissive:3809544,emissiveIntensity:.14}),n=new Ie({color:16773258,roughness:.46,metalness:.1,emissive:4863238,emissiveIntensity:.16});for(let l=0;l<10;l+=1){const c=new He,u=new Vt(new lr(.085,.105,.34,8),e),h=new Vt(new wi(.105,10,8),n);u.position.y=.2,h.position.y=.42,c.add(u,h);const d=l/10*Math.PI*2,p=.9+jt(l*31)*1.45;c.position.set(Math.cos(d)*p,.16,Math.sin(d)*p),c.rotation.y=-d,c.userData.phase=jt(l*19)*Math.PI*2,t.add(c)}const r=new Ie({color:16758861,roughness:.54,metalness:.16,emissive:3808261,emissiveIntensity:.12}),s=new He,a=new Vt(new Pe(.62,.24,.32),r),o=new Vt(new Pe(.3,.3,.32),r);return a.position.set(0,.22,0),o.position.set(.42,.26,0),s.add(a,o),s.position.set(-1.75,.18,1.55),s.userData.phase=0,t.add(s),t}createHazardFx(){const t=new He;t.visible=!1;const e=420,n=new Float32Array(e*3);for(let l=0;l<e;l+=1)Qi(n,l,"civic");const r=new ie;r.setAttribute("position",new Le(n,3));const s=new er({color:16747082,size:.075,transparent:!0,opacity:0,depthWrite:!1,blending:Ke}),a=new Vr(r,s);a.frustumCulled=!1,a.renderOrder=6,t.add(a);const o=new Vt(new Ca(.7,.96,96),new fn({color:16747082,transparent:!0,opacity:0,depthWrite:!1,blending:Ke,side:je}));return o.rotation.x=-Math.PI/2,o.position.y=.24,o.renderOrder=7,t.add(o),{fx:{group:t,points:a,material:s,positions:n},shockwave:o}}triggerPolicyFx(t,e){var c;const n=ga(t.policyId),r=(n==null?void 0:n.category)??"governance",s=t.targetDistrictId??e.selectedDistrictId,a=((c=this.districtVisuals.get(s))==null?void 0:c.root.position)??new C(0,0,-1.2),o=n0(s,a),l=t0(r);this.activePolicyCategory=r,this.policyFx.group.visible=!0,this.policyFx.group.position.set(o.x,.12,o.z),this.policyFx.group.scale.setScalar((n==null?void 0:n.target)==="city"?1.55:1),this.policyFx.material.color.setHex(l),this.policyScaffold.material.color.setHex(r==="energy"?16773258:16766815),this.policyWorkPad.material.color.setHex(l),this.policyFxStart=this.elapsedSeconds;for(let u=0;u<this.policyFx.positions.length/3;u+=1)Ji(this.policyFx.positions,u,r);this.policyFx.points.geometry.getAttribute("position").needsUpdate=!0}triggerHazardFx(t){this.activeHazardCue=t,this.hazardFx.group.visible=!0,this.hazardFx.group.position.copy(e0(t)),this.hazardFx.material.color.setHex(na(t).particle),this.hazardFx.material.size=t==="rain"?.055:t==="air"?.085:.075,this.hazardShockwave.material.color.setHex(na(t).particle),this.hazardShockwave.visible=!0,this.hazardShockwave.scale.setScalar(.4),this.hazardFxStart=this.elapsedSeconds;for(let e=0;e<this.hazardFx.positions.length/3;e+=1)Qi(this.hazardFx.positions,e,t);this.hazardFx.points.geometry.getAttribute("position").needsUpdate=!0}animatePolicyFx(t){const e=t-this.policyFxStart;if(e<0||e>2.9){this.policyFx.group.visible=!1,this.policyFx.material.opacity=0,this.policyScaffold.material.opacity=0,this.policyWorkers.visible=!1,this.policyWorkPad.material.opacity=0;return}const n=te(e/2.9,0,1),r=Math.sin(n*Math.PI),s=this.activePolicyCategory,a=this.policyFx.positions;this.policyFx.material.opacity=.62*r,this.policyScaffold.material.opacity=.86*r,this.policyWorkPad.material.opacity=.26*r,this.policyWorkPad.scale.set(1+Math.sin(t*5.5)*.025,1,1+Math.cos(t*4.5)*.025),this.policyScaffold.rotation.y=Math.sin(t*3.2)*.06,this.policyWorkers.visible=r>.04,this.policyWorkers.children.forEach((o,l)=>{const c=typeof o.userData.phase=="number"?o.userData.phase:0;o.position.y=.16+Math.abs(Math.sin(t*7.5+c))*.08,o.rotation.y+=l===this.policyWorkers.children.length-1?.018:Math.sin(t*4+c)*.012});for(let o=0;o<a.length/3;o+=1){const l=o*3;s==="flood"?(a[l]+=Math.sin(t*3+o)*.007,a[l+1]=.18+Math.sin(t*5+o)*.025,a[l+2]+=.025,a[l+2]>2.7&&Ji(a,o,s)):s==="energy"?(a[l+1]+=.028+jt(o*11)*.02,a[l]+=Math.sin(t*6+o)*.012,a[l+1]>4.6&&Ji(a,o,s)):(a[l+1]+=.018+jt(o*13)*.014,a[l]+=Math.sin(t*2.5+o)*.008,a[l+2]+=Math.cos(t*2.1+o)*.008,a[l+1]>3.5&&Ji(a,o,s))}this.policyFx.points.geometry.getAttribute("position").needsUpdate=!0}animateHazardFx(t){const e=t-this.hazardFxStart;if(e<0||e>3.2){this.hazardFx.group.visible=!1,this.hazardFx.material.opacity=0,this.hazardShockwave.visible=!1,this.hazardShockwave.material.opacity=0;return}const n=te(e/3.2,0,1),r=Math.sin(n*Math.PI),s=this.activeHazardCue,a=this.hazardFx.positions;this.hazardFx.material.opacity=(s==="air"?.58:.72)*r,this.hazardShockwave.visible=!0,this.hazardShockwave.scale.setScalar(.35+n*(s==="rain"?8.2:6.4)),this.hazardShockwave.material.opacity=Math.max(0,.78*(1-n)),this.hazardShockwave.rotation.z=t*(s==="energy"?1.4:.35);for(let o=0;o<a.length/3;o+=1){const l=o*3;s==="rain"?(a[l]+=Math.sin(t*1.7+o)*.01,a[l+1]-=.095+jt(o*5)*.05,a[l+2]+=.026,a[l+1]<.1&&Qi(a,o,s)):s==="heat"?(a[l+1]+=.035+jt(o*7)*.026,a[l]+=Math.sin(t*5+o)*.012,a[l+1]>5.8&&Qi(a,o,s)):s==="air"?(a[l]+=.034+jt(o*17)*.02,a[l+1]+=Math.sin(t*1.4+o)*.004,a[l]>7.2&&Qi(a,o,s)):s==="energy"?(a[l+1]+=Math.sin(t*8+o)*.02,a[l]+=Math.sin(t*12+o)*.018,a[l+2]+=Math.cos(t*10+o)*.018):(a[l+1]+=.018,a[l]+=Math.sin(t*3+o)*.01)}this.hazardFx.points.geometry.getAttribute("position").needsUpdate=!0}createEventFx(){const t=new Wg(16757087,.8,24,1.7);t.position.set(0,7.5,1.2);const e=new Vt(new wi(8.2,48,24),new fn({color:16757087,transparent:!0,opacity:.08,depthWrite:!1,blending:Ke,side:Ae}));return e.position.set(0,2.4,-.8),e.scale.y=.46,{light:t,halo:e}}}function Rl(i){return i.archetype==="downtown"?5467495:i.archetype==="industrial"?5857625:i.archetype==="residential"?6197097:i.archetype==="upland"?4684356:i.archetype==="river"?5603203:6651759}function fa(i){return i.archetype==="downtown"?42:i.archetype==="industrial"?14:i.archetype==="residential"?20:i.archetype==="upland"?7:i.archetype==="river"?18:20}function Pl(i,t,e){const n=fa(i),r=i.archetype==="downtown"?7:i.archetype==="industrial"?4:i.archetype==="upland"?3:5,s=Math.ceil(n/r),a=i.archetype==="industrial"?1.28:i.archetype==="upland"?1.35:.86,o=e%r,l=Math.floor(e/r),c=(jt(t*41+e*3)-.5)*(i.archetype==="downtown"?.14:.24),u=(jt(t*61+e*7)-.5)*(i.archetype==="upland"?.38:.18),h=-((r-1)*a)/2+o*a+c,d=-((s-1)*a)/2+l*a+u,p=Zg(i,e),_=(jt(t*70+e)-.5)*(i.archetype==="residential"?.34:.16),v=i.archetype==="upland"?pa(h,d,t)+.08:.18;return i.archetype==="industrial"?{x:h,z:d,baseY:v,height:p,scaleX:1.12+jt(t*17+e)*.58,scaleZ:.74+jt(t*23+e)*.62,rotationY:_}:i.archetype==="residential"?{x:h,z:d,baseY:v,height:p,scaleX:.92+jt(t*13+e)*.2,scaleZ:.54+jt(t*29+e)*.22,rotationY:_}:i.archetype==="upland"?{x:h,z:d,baseY:v,height:p,scaleX:.55+jt(t*19+e)*.18,scaleZ:.5+jt(t*31+e)*.18,rotationY:_}:{x:h,z:d,baseY:v,height:p,scaleX:i.archetype==="downtown"?.68+jt(t*13+e)*.2:.72,scaleZ:i.archetype==="downtown"?.68+jt(t*17+e)*.2:.68,rotationY:_}}function Zg(i,t){const e=i.imperviousness,n=jt((t+1)*17);return i.archetype==="downtown"?te(2.3+e*4.1+n*4.4,2.2,9.4):i.archetype==="industrial"?te(.7+e*.85+n*.9,.85,2.3):i.archetype==="residential"?te(.95+e*1.1+n*1.1,1,3.1):i.archetype==="upland"?te(.42+e*.55+n*.45,.45,1.15):i.archetype==="river"?te(.9+e*1.7+n*1.4,.9,4):te(1+e*1.8+n*1.6,1,4.4)}function pa(i,t,e=0){const n=Math.max(0,(2.6-t)/5.2),r=Math.sin((i+e)*1.7)*.12+Math.cos((t-e)*1.3)*.1;return .12+n*1.25+r}function jt(i){const t=Math.sin(i*12.9898)*43758.5453;return t-Math.floor(t)}function Jg(i,t,e){const n=te(e,0,1),r=new St(i);return r.lerp(new St(t),n),r.getHex()}function na(i){return i==="heat"?{background:4860449,fog:10968888,fogDensity:.024,skyTop:12087107,skyBottom:3692125,skyAccent:16747082,waterGlow:3520980,particle:16747082,street:16760938,windowGlow:16765066}:i==="rain"?{background:1521739,fog:3632518,fogDensity:.032,skyTop:4946064,skyBottom:1521739,skyAccent:6018815,waterGlow:6543615,particle:8119039,street:7526911,windowGlow:13235455}:i==="air"?{background:5065010,fog:10783570,fogDensity:.039,skyTop:10324834,skyBottom:3753787,skyAccent:13938779,waterGlow:5220020,particle:13938779,street:13090936,windowGlow:16768906}:i==="energy"?{background:3815204,fog:9141053,fogDensity:.024,skyTop:9073984,skyBottom:2506564,skyAccent:16769146,waterGlow:6806472,particle:16769146,street:16771480,windowGlow:16773286}:{background:1522501,fog:4094063,fogDensity:.025,skyTop:7316389,skyBottom:1522501,skyAccent:9764816,waterGlow:6018815,particle:9764816,street:9437138,windowGlow:14548969}}function Qg(i){return i==="rain"?{size:.033,opacity:.4}:i==="heat"?{size:.052,opacity:.34}:i==="air"?{size:.058,opacity:.27}:i==="energy"?{size:.045,opacity:.42}:{size:.038,opacity:.22}}function t0(i){return i==="cooling"||i==="biodiversity"?8191886:i==="flood"?6871551:i==="energy"?16770689:i==="mobility"?8251391:i==="health"?16752560:i==="industry"?12177872:12429055}function e0(i){return i==="rain"?new C(1.8,.2,3.6):i==="heat"?new C(0,.25,-1.2):i==="air"?new C(-4.2,.45,4):i==="energy"?new C(0,2.2,-1.2):new C(0,.6,-1.2)}function n0(i,t){const e={core:[-2,1.85],harbor:[1.3,1.45],riverbend:[-1.65,-1.35],industry:[1.5,-1.25],garden:[-1.4,1.55],hillside:[-1.25,-.75]},[n,r]=e[i]??[0,0];return new C(t.x+n,t.y,t.z+r)}function i0(i){return i?`${i.year}:${i.turn}:${i.policyId}:${i.targetDistrictId??"city"}`:""}function r0(i){return i.lastResolution?`${i.lastResolution.year}:${i.lastResolution.title}:${i.lastResolution.soundCue}`:""}function Ji(i,t,e){const n=t*3,r=Math.random()*Math.PI*2,s=Math.sqrt(Math.random())*(e==="governance"?3.6:2.35);i[n]=Math.cos(r)*s,i[n+2]=Math.sin(r)*s,e==="flood"?i[n+1]=.12+Math.random()*.28:e==="energy"?i[n+1]=1.2+Math.random()*1.8:i[n+1]=.18+Math.random()*.7}function Qi(i,t,e){const n=t*3;if(e==="rain"){i[n]=(Math.random()-.5)*10,i[n+1]=2.4+Math.random()*5.2,i[n+2]=(Math.random()-.5)*6;return}if(e==="heat"){i[n]=(Math.random()-.5)*6.2,i[n+1]=.25+Math.random()*1.2,i[n+2]=(Math.random()-.5)*4.8;return}if(e==="air"){i[n]=-5.8+Math.random()*1.2,i[n+1]=.9+Math.random()*3.4,i[n+2]=(Math.random()-.5)*5.4;return}if(e==="energy"){const r=Math.random()*Math.PI*2,s=1.2+Math.random()*3.2;i[n]=Math.cos(r)*s,i[n+1]=.8+Math.random()*4.6,i[n+2]=Math.sin(r)*s;return}i[n]=(Math.random()-.5)*7.5,i[n+1]=.5+Math.random()*3,i[n+2]=(Math.random()-.5)*6}function ia(i,t,e,n){const r=t*3;i[r]=(Math.random()-.5)*22,i[r+1]=n??(e==="rain"?3.2+Math.random()*4.2:.45+Math.random()*4.8),i[r+2]=(Math.random()-.5)*18}function s0(){const i=document.createElement("canvas");i.width=512,i.height=512;const t=i.getContext("2d");if(!t)return new _l(i);const e=t.createLinearGradient(0,0,512,512);e.addColorStop(0,"#173034"),e.addColorStop(.52,"#10282d"),e.addColorStop(1,"#0b1d23"),t.fillStyle=e,t.fillRect(0,0,512,512),t.globalAlpha=.18,t.strokeStyle="#7be2d4",t.lineWidth=3;for(let r=42;r<512;r+=74)t.beginPath(),t.moveTo(r,0),t.lineTo(r+36,512),t.stroke(),t.beginPath(),t.moveTo(0,r),t.lineTo(512,r+18),t.stroke();t.globalAlpha=.12,t.strokeStyle="#f5d57a",t.lineWidth=1;for(let r=18;r<512;r+=38)t.beginPath(),t.moveTo(r,0),t.lineTo(r,512),t.stroke();t.globalAlpha=.08,t.fillStyle="#d7fff2";for(let r=0;r<320;r+=1){const s=jt(r*23)*512,a=jt(r*41)*512;t.fillRect(s,a,1.2,1.2)}const n=new _l(i);return n.colorSpace=We,n.wrapS=ar,n.wrapT=ar,n.repeat.set(2,2),n.anisotropy=4,n}const Tc={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`};class Hi{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const a0=new ls(-1,1,1,-1,0,1);class o0 extends ie{constructor(){super(),this.setAttribute("position",new Wt([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new Wt([0,2,0,0,2,0],2))}}const l0=new o0;class La{constructor(t){this._mesh=new Vt(l0,t)}dispose(){this._mesh.geometry.dispose()}render(t){t.render(this._mesh,a0)}get material(){return this._mesh.material}set material(t){this._mesh.material=t}}class Ac extends Hi{constructor(t,e){super(),this.textureID=e!==void 0?e:"tDiffuse",t instanceof Ee?(this.uniforms=t.uniforms,this.material=t):t&&(this.uniforms=or.clone(t.uniforms),this.material=new Ee({name:t.name!==void 0?t.name:"unspecified",defines:Object.assign({},t.defines),uniforms:this.uniforms,vertexShader:t.vertexShader,fragmentShader:t.fragmentShader})),this.fsQuad=new La(this.material)}render(t,e,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this.fsQuad.material=this.material,this.renderToScreen?(t.setRenderTarget(null),this.fsQuad.render(t)):(t.setRenderTarget(e),this.clear&&t.clear(t.autoClearColor,t.autoClearDepth,t.autoClearStencil),this.fsQuad.render(t))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class Ll extends Hi{constructor(t,e){super(),this.scene=t,this.camera=e,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(t,e,n){const r=t.getContext(),s=t.state;s.buffers.color.setMask(!1),s.buffers.depth.setMask(!1),s.buffers.color.setLocked(!0),s.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),s.buffers.stencil.setTest(!0),s.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),s.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),s.buffers.stencil.setClear(o),s.buffers.stencil.setLocked(!0),t.setRenderTarget(n),this.clear&&t.clear(),t.render(this.scene,this.camera),t.setRenderTarget(e),this.clear&&t.clear(),t.render(this.scene,this.camera),s.buffers.color.setLocked(!1),s.buffers.depth.setLocked(!1),s.buffers.color.setMask(!0),s.buffers.depth.setMask(!0),s.buffers.stencil.setLocked(!1),s.buffers.stencil.setFunc(r.EQUAL,1,4294967295),s.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),s.buffers.stencil.setLocked(!0)}}class c0 extends Hi{constructor(){super(),this.needsSwap=!1}render(t){t.state.buffers.stencil.setLocked(!1),t.state.buffers.stencil.setTest(!1)}}class u0{constructor(t,e){if(this.renderer=t,this._pixelRatio=t.getPixelRatio(),e===void 0){const n=t.getSize(new it);this._width=n.width,this._height=n.height,e=new Je(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:Ln}),e.texture.name="EffectComposer.rt1"}else this._width=e.width,this._height=e.height;this.renderTarget1=e,this.renderTarget2=e.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Ac(Tc),this.copyPass.material.blending=_n,this.clock=new bc}swapBuffers(){const t=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=t}addPass(t){this.passes.push(t),t.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(t,e){this.passes.splice(e,0,t),t.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(t){const e=this.passes.indexOf(t);e!==-1&&this.passes.splice(e,1)}isLastEnabledPass(t){for(let e=t+1;e<this.passes.length;e++)if(this.passes[e].enabled)return!1;return!0}render(t){t===void 0&&(t=this.clock.getDelta());const e=this.renderer.getRenderTarget();let n=!1;for(let r=0,s=this.passes.length;r<s;r++){const a=this.passes[r];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(r),a.render(this.renderer,this.writeBuffer,this.readBuffer,t,n),a.needsSwap){if(n){const o=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,t),l.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}Ll!==void 0&&(a instanceof Ll?n=!0:a instanceof c0&&(n=!1))}}this.renderer.setRenderTarget(e)}reset(t){if(t===void 0){const e=this.renderer.getSize(new it);this._pixelRatio=this.renderer.getPixelRatio(),this._width=e.width,this._height=e.height,t=this.renderTarget1.clone(),t.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=t,this.renderTarget2=t.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(t,e){this._width=t,this._height=e;const n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let s=0;s<this.passes.length;s++)this.passes[s].setSize(n,r)}setPixelRatio(t){this._pixelRatio=t,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}const h0={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Bi.BlurDirectionX=new it(1,0);Bi.BlurDirectionY=new it(0,1);function m0(i,t,e){const n=new u0(i);n.addPass(new f0(t,e));const r=new Bi(new it(window.innerWidth,window.innerHeight),.52,.72,.68);n.addPass(r);const s=new Ac({uniforms:{tDiffuse:{value:null},uContrast:{value:1.08},uSaturation:{value:1.12},uVignette:{value:.24}},vertexShader:`
      varying vec2 vUv;
    ...
    `});return n.addPass(s),n.addPass(new d0),n}function g0(){const i=new ls(-12,12,8,-8,.1,200);return i.position.set(15,16,15),i.lookAt(0,.4,-.8),wc(i,window.innerWidth,window.innerHeight),i}function wc(i,t,e){const n=t/Math.max(1,e),r=t<760?23:t<1100?21:17.4,s=r*n;i.left=-s/2,i.right=s/2,i.top=r/2,i.bottom=-r/2,i.updateProjectionMatrix()}function _0(i){const t=new yg({canvas:i,antialias:!0,powerPreference:"high-performance"});return t.setPixelRatio(Math.min(window.devicePixelRatio,1.75)),t.setSize(window.innerWidth,window.innerHeight,!1),t.outputColorSpace=We,t.toneMapping=ya,t.toneMappingExposure=1.06,t.shadowMap.enabled=!0,t.shadowMap.type=kl,t}function v0(){const i=new Sg;i.background=new St(594459),i.fog=new us(662824,.027);const t=new Gg(11459839,2502943,1.35);i.add(t);const e=new ta(16773580,3.55);e.position.set(-7,12,8),e.castShadow=!0,e.shadow.mapSize.set(2048,2048),e.shadow.camera.left=-18,e.shadow.camera.right=18,e.shadow.camera.top=18,e.shadow.camera.bottom=-18,e.shadow.bias=-15e-5,e.shadow.normalBias=.04,i.add(e);const n=new ta(7060991,.8);n.position.set(9,5,-8),i.add(n);const r=new ta(9437138,1.15);return r.position.set(4,9,-12),i.add(r),i}function x0(i,t,e){const n=_0(i),r=v0(),s=g0(),a=m0(n,r,s),o=M0(s,i),l=new jg(r,t),c=new qg,u=new it,h=new bc;let d=0,p=!1;const _=()=>y0(n,a,s);window.addEventListener("resize",_);const v=f=>{var U;const T=i.getBoundingClientRect();u.x=(f.clientX-T.left)/T.width*2-1,u.y=-((f.clientY-T.top)/T.height)*2+1,c.setFromCamera(u,s);const S=c.intersectObjects(l.pickables,!0),b=l.findDistrictId(((U=S[0])==null?void 0:U.object)??null);b&&e.onSelectDistrict(b)};i.addEventListener("pointerdown",v);const m=()=>{if(p)return;const f=h.getElapsedTime();l.tick(f),o.update(),a.render(),d=window.requestAnimationFrame(m)};return{update:f=>l.updateFromState(f),playYearTransition:f=>l.playYearTransition(f),start:()=>{_(),m()},dispose:()=>{p=!0,window.cancelAnimationFrame(d),window.removeEventListener("resize",_),i.removeEventListener("pointerdown",v),o.dispose(),n.dispose()}}}function M0(i,t){const e=new Yg(i,t);return e.enableDamping=!0,e.dampingFactor=.08,e.minZoom=.62,e.maxZoom=1.65,e.minPolarAngle=Math.PI*.22,e.maxPolarAngle=Math.PI*.38,e.enableRotate=!0,e.enablePan=!0,e.target.set(0,.4,-1),e}function y0(i,t,e){const n=window.innerWidth,r=window.innerHeight;i.setPixelRatio(Math.min(window.devicePixelRatio,1.75)),i.setSize(n,r,!1),t.setSize(n,r),wc(e,n,r)}function S0(i,t){i.className="hud-root";let e,n,r=!1;i.addEventListener("click",a=>{const o=a.target,l=o.closest("[data-policy]"),c=o.closest("[data-district]"),u=o.closest("[data-open-guide]"),h=o.closest("[data-confirm-policy]");if(o.closest("[data-open-policy-board]")){r=!0,s();return}if(o.closest("[data-close-policy-board]")){r=!1,s();return}if(o.closest("[data-close-policy]")){e=void 0,s();return}if(o.closest("[data-close-guide]")){n=void 0,s();return}if(o.closest("[data-reset-mission]")){e=void 0,n=void 0,r=!1,t.onResetMission();return}if(o.closest("[data-start-mission]")){t.onStartMission();return}if(h!=null&&h.dataset.confirmPolicy){e=void 0,t.onApplyPolicy(h.dataset.confirmPolicy);return}if(l!=null&&l.dataset.policy){e=l.dataset.policy,s();return}if(V0(u==null?void 0:u.dataset.openGuide)){n=u.dataset.openGuide,s();return}if(c!=null&&c.dataset.district){t.onSelectDistrict(c.dataset.district);return}if(o.closest("[data-advance]")){t.onAdvanceYear();return}if(o.closest("[data-toggle-audio]")){t.onToggleAudio();return}o.closest("[data-live-data]")&&t.onLoadLiveData()});const s=()=>{const a=t.getState(),o=a.districts.find(u=>u.id===a.selectedDistrictId)??a.districts[0],l=e?ma.find(u=>u.id===e):void 0,c=t.isYearProcessing();i.innerHTML=`
      <section class="top-hud" aria-label="城市狀態">
        ...
        <div class="metric-strip">
          ...
          ${Mi("健康",a.publicHealth,"",Ia(a.publicHealth))}
        </div>
      </section>
      ...
      ${b0(a)}
      ${T0(a,o)}
      ${A0(a,t.isAudioEnabled(),c)}
      ${c?w0(a):""}
      ${a.mission.status==="briefing"?R0(a):""}
      ${a.mission.status==="won"||a.mission.status==="lost"?P0(a):""}
      ${r?C0(a):""}
      ${l?L0(a,l):""}
      ${n==="mission"?D0(a):""}
      ${n==="challenge"?I0(a):""}
      ${n==="district"?U0(a,o):""}
      ${n==="resolution"?N0(a.lastResolution):""}
    `};return{render:s}}function E0(i){const t=i.mission,e=qc(i),n=_a(i),r=t.objectives.filter(s=>s.passed).length;return`
  ...
  `}function A0(i,t,e){const n=i.mission.status==="active"&&i.phase!=="complete"&&!e;return`
  ...
  `}function w0(i){return`
    <section class="year-transition-panel" aria-live="polite">
      ...
      <p>正在執行 ${_a(i)} 項政策，接著結算本年度意外事件。</p>
    </section>
  `}function C0(i){return`
    <section class="modal-scrim policy-board-scrim">
      <article class="policy-board-panel">
        ...
        <div class="policy-row">
          ${ma.map(t=>F0(t,i)).join("")}
        </div>
      </article>
    </section>
  `}function R0(i){const t=i.mission;return`
  ...
  `}function P0(i){const t=i.mission.status==="won",e=i.mission;return`
    <section class="modal-scrim">
      <div class="briefing-card ending ${t?"won":"lost"}">
        ...
        <p>${e.debriefBody??""}</p>
        <div class="briefing-objectives">
          ${e.objectives.map(O0).join("")}
        </div>
        <button class="primary-btn large" type="button" data-reset-mission>重製任務</button>
      </div>
    </section>
  `}function L0(i,t){const e=va(i,t.id),n=k0(i,t),r=!n&&(e==null?void 0:e.affordable);return`
    <section class="modal-scrim policy-scrim">
      <article class="policy-detail-card ${t.category}">
        ...
        <span class="policy-kicker">${Cc(t.sdgs)}</span>
        <h1>${t.name}</h1>
  ...
  `}function D0(i){const t=i.mission;return`
    <section class="modal-scrim">
  ...
  `}function I0(i){const t=i.currentChallenge;return`
    <section class="modal-scrim">
      <article class="guide-card">
        ...
        <div class="delta-board">
          ${Object.entries(t.pressure).map(([e,n])=>ye(H0(e),n,G0(e))).join("")}
        </div>
      </article>
    </section>
  `}function U0(i,t){return`
    <section class="modal-scrim">
      <article class="guide-card district-guide-card">
        ...
        <div class="district-tabs expanded">
          ${i.districts.map(e=>z0(e,i.selectedDistrictId)).join("")}
        </div>
      </article>
    </section>
  ...
  `}function yi(i,t,e){return`
    <div class="district-stat ${e?Ia(t):sr(t)}">
      <span>${i}</span>
      <strong>${Math.round(t)}</strong>
    </div>
  `}function Si(i,t,e){return`
    <span class="mini-stat ${e?Ia(t):sr(t)}">
      ${i}<b>${Math.round(t)}</b>
    </span>
  ...
  `}function Da(i){return`${Number.isInteger(i.current)?String(i.current):i.current.toFixed(1)}${i.unit??""}`}function rs(i){return`${Math.round(i)} 百萬`}function Cc(i){const t={"SDG 3":"健康福祉","SDG 6":"潔淨水","SDG 7":"可負擔能源","SDG 9":"產業創新","SDG 10":"減少不平等","SDG 11":"永續城市","SDG 12":"責任消費","SDG 13":"氣候行動","SDG 15":"陸域生態"};return i.map(e=>`${e} ${t[e]??""}`.trim()).join(" / ")}function ye(i,t,e){const n=Math.round(t*10)/10,r=e?n<0:n>0,s=e?n>0:n<0,a=r?"good":s?"danger":"neutral",o=n>0?"+":"";return`
    <span class="delta-chip ${a}">
      ${i} ${o}${n}
    </span>
  `}function k0(i,t){const e=va(i,t.id);if(i.mission.status==="briefing")return"請先開始任務，再確認政策投資。";if(i.phase==="complete")return"任務已結束，請使用重製任務重新開始。";if(!(e!=null&&e.canAffordBudget))return`預算不足：目前剩餘 ${rs(i.budget)}。`;if(((e==null?void 0:e.remainingActions)??0)<=0)return"本回合政策額度已用完，請進入下一年。"}function H0(i){return{emissions:"排放",heatRisk:"熱風險",floodRisk:"洪水風險",airQualityRisk:"空氣風險",publicHealth:"公共健康",equity:"公平性",publicTrust:"公共信任",biodiversity:"生物多樣性",energySecurity:"能源安全",educationScore:"教育分數"}[i]??i}function G0(i){return i==="emissions"||i==="heatRisk"||i==="floodRisk"||i==="airQualityRisk"}function V0(i){return i==="mission"||i==="challenge"||i==="district"||i==="resolution"}function sr(i){return i>=72?"danger":i>=54?"warn":"good"}function Ia(i){return i>=68?"good":i>=50?"warn":"danger"}const W0={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1},Rc=document.querySelector("#game-canvas"),Pc=document.querySelector("#hud-root");if(!Rc||!Pc)throw new Error("Missing game canvas or HUD root.");let Me=zi(Dl()),Ue=!1,Ti=!1;const X0=6500,xe=Bc(),Ua=x0(Rc,Me,{onSelectDistrict:i=>Lc(i)}),hs=S0(Pc,{getState:()=>Me,onStartMission:()=>{const i=uu(Me);K0(i.currentChallenge.soundCue),xe.startAmbience(i.currentChallenge.soundCue),xe.playEvent(i.currentChallenge.soundCue),gn(i)},onApplyPolicy:i=>{if(Ti)return;const t=Me.appliedPolicies.length,e=hu(Me,i);Ue&&e.appliedPolicies.length>t?xe.playPolicy():Ue&&xe.playSelect(),gn(e)},onAdvanceYear:()=>{if(Ti)return;const i=Me,t=du(i);if(t===i||i.mission.status!=="active"){gn(t);return}Ti=!0,Ua.playYearTransition(i),j0(i),hs.render(),window.setTimeout(()=>{Ti=!1,Ue&&t.lastResolution&&xe.startAmbience(t.currentChallenge.soundCue),Ue&&i.mission.status!==t.mission.status&&(t.mission.status==="won"&&xe.playSuccess(),t.mission.status==="lost"&&xe.playFailure()),gn(t)},X0)},onSelectDistrict:i=>Lc(i),onResetMission:()=>$0(),isAudioEnabled:()=>Ue,isYearProcessing:()=>Ti,onToggleAudio:()=>Y0(),onLoadLiveData:()=>{Ue&&xe.playSelect(),q0()}});hs.render();Ua.start();async function q0(){gn({...Me,eventLog:["正在載入 Open-Meteo / NASA POWER / World Bank / OpenAQ 真實資料。",...Me.eventLog].slice(0,10)});try{const i=await ru(Me,{useNetwork:!0,openAqApiKey:Z0("VITE_OPENAQ_API_KEY")});gn(fu(Me,i))}catch(i){gn({...Me,eventLog:[`真實資料載入失敗，暫時使用內建基準資料。原因：${String(i)}`,...Me.eventLog].slice(0,10)})}}function Lc(i){var t;Ue&&xe.playSelect(),gn({...Me,selectedDistrictId:i,eventLog:[`已選擇 ${((t=Me.districts.find(e=>e.id===i))==null?void 0:t.name)??i}。`,...Me.eventLog].slice(0,10)})}function $0(){Ti=!1;const i=zi(Dl());Ue&&(xe.startAmbience(i.currentChallenge.soundCue),xe.playEvent("civic")),gn(i)}function Y0(){Ue=!Ue,xe.setMuted(!Ue),Ue&&(xe.startAmbience(Me.currentChallenge.soundCue),xe.playEvent("civic")),hs.render()}function K0(i){Ue=!0,xe.setMuted(!1),xe.startAmbience(i)}function gn(i){Me=i,Ua.update(Me),hs.render()}function j0(i){if(!Ue)return;const t=i.appliedPolicies.filter(n=>n.turn===i.turn).slice().reverse();t.forEach((n,r)=>{window.setTimeout(()=>xe.playPolicy(),260+r*720)});const e=Math.max(1200,680+t.length*720);window.setTimeout(()=>xe.playEvent(i.currentChallenge.soundCue),e)}function Z0(i){return W0[i]}
